...
@Component(immediate = true, property = { "javax.portlet.name=" + OmsbOctMasterWebPortletKeys.OMSBOCTMASTERWEB,
		"mvc.command.name=" + MVCCommandNames.DELETE_OCT_EXAM_TITLE_DETAILS }, service = MVCResourceCommand.class)

public class DeleteExamTitleDetailMVCResourceCommand extends BaseMVCResourceCommand {

	private static final Log logger = LogFactoryUtil.getLog(DeleteExamTitleDetailMVCResourceCommand.class);
