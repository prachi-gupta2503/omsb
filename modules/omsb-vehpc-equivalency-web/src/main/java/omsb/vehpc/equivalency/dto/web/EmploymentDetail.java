...
public class EmploymentDetail {
	...
	public String toString() {
		...
		builder.append("EmploymentDetail [issuingAuthorityId=");
		...
		builder.append(feeCategory);
		builder.append(", applicantPaysDirectlyToIA=");
		builder.append(applicantPaysDirectlyToIA);
		builder.append(", issuingAuthorityCountry=");
		builder.append(issuingAuthorityCountry);
		builder.append(", issuingAuthorityCountryId=");
		builder.append(issuingAuthorityCountryId);
		builder.append(", lastProfile=");
		builder.append(lastProfile);
		builder.append(", natureOfEmployment=");
		builder.append(natureOfEmployment);
		builder.append(", employementPeriodFrom=");
		builder.append(employementPeriodFrom);
		builder.append(", employementPeriodTo=");
		builder.append(employementPeriodTo);
		...
		builder.append(", id=");
		builder.append(id);
		builder.append(", workSectorType=");
		builder.append(workSectorType);
		builder.append(", workSectorId=");
		builder.append(workSectorId);
		builder.append(", workSectorOther=");
		builder.append(workSectorOther);
		builder.append(", workSectorLocation=");
		builder.append(workSectorLocation);
		builder.append(", designationId=");
		builder.append(designationId);
		builder.append(", designationOther=");
		builder.append(designationOther);
		builder.append(", staffIdCard=");
		builder.append(staffIdCard);
		...
		builder.append(lRUserId);
		builder.append(", primaryWorkDetail=");
		builder.append(primaryWorkDetail);
		builder.append(", workSectorTypeOther=");
		builder.append(workSectorTypeOther);
		builder.append(", workSector2=");
		builder.append(workSector2);
		builder.append(", workSectorId2=");
		builder.append(workSectorId2);
		builder.append(", workSectorOther2=");
		builder.append(workSectorOther2);
		builder.append(", workSector3=");
		builder.append(workSector3);
		builder.append(", workSectorId3=");
		builder.append(workSectorId3);
		builder.append(", workSectorOther3=");
		builder.append(workSectorOther3);
		builder.append(", workSectorItems=");
		builder.append(workSectorItems);
		builder.append(", workSubSectorItems=");
		builder.append(workSubSectorItems);
		builder.append("]");
