...
@Component(immediate = true, property = { "javax.portlet.name=" + OmsbMasterPortletKeys.OMSBMASTER,
		"mvc.command.name="
				+ MVCCommandNames.INSTITUTION_DELETE_RESOURCE_COMMAND }, service = MVCResourceCommand.class)
public class DeleteInstitutionMVCResourcesCommand extends BaseMVCResourceCommand {
	...
	protected void doServeResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
		...
		String url = themeDisplay.getPortalURL()+ MVCCommandNames.INSTITUTION_UNIVERSITY_MAPPING_URL + id;
