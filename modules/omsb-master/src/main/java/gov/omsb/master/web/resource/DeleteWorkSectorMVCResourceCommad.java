...
@Component(immediate = true, property = { "javax.portlet.name=" + OmsbMasterPortletKeys.OMSBMASTER,
		"mvc.command.name="
				+ MVCCommandNames.WORK_SECTOR_DELETE_RESOURCE_COMMAND }, service = MVCResourceCommand.class)

public class DeleteWorkSectorMVCResourceCommad extends BaseMVCResourceCommand {
	...
	protected void doServeResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
		...
		String url = themeDisplay.getPortalURL()+ MVCCommandNames.WORK_SECTOR_TYPE_URL + id;
	...
	private static final Log logger = LogFactoryUtil.getLog(DeleteWorkSectorMVCResourceCommad.class);
