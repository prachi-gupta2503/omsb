...
@Component(immediate = true, property = { "javax.portlet.name=" + OmsbMasterPortletKeys.OMSBMASTER,
		"mvc.command.name="
				+ MVCCommandNames.DELETE_OMSB_EXAM_SPECIALITY_MASTER_DETAILS }, service = MVCResourceCommand.class)

public class DeleteSpecialityMasterDetailMVCResourceCommand extends BaseMVCResourceCommand {

	private static final Log logger = LogFactoryUtil.getLog(DeleteSpecialityMasterDetailMVCResourceCommand.class);
