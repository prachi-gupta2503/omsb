...
public class OMSBExamCertificationMasterMVCRenderCommand implements MVCRenderCommand {
	private static final Log logger = LogFactoryUtil.getLog(OMSBExamCertificationMasterMVCRenderCommand.class);
	...
	public String render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
		...
		return OmsbMasterPortletKeys.OMSB_CERTIFICATION_MASTER_JSP;
	}
