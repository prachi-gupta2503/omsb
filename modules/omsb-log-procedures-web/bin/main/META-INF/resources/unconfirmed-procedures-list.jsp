...
<div class="tab-pane fade" id="pills-unconfirmed"
	...
	<aui:form action="${filterLogProcedures}"
		name="pills-unconfirmed-tab_form">
		<aui:input name="tab" type="hidden" value="pills-unconfirmed-tab" />
		<aui:input name="status" type="hidden"
			value="<%=OmsbViewProceduresSupervisorWebPortletKeys.STATUS_UNCONFIRMED%>" />
		<div class="row m-0">
	...
	<div class="omsb-list-view table-responsive">
		<table id="unconfirmedProceduresTable" class="display omsb-datatables">
			...
			<tbody>
				<c:forEach items="${unconfirmedLoggedProcedures}"
					var="loggedProcedure">
					<portlet:renderURL var="editProcedureURL">
						...
						<portlet:param name="tab" value="pills-unconfirmed-tab" />
					</portlet:renderURL>
					<portlet:actionURL
								...
								<ul class="dropdown-menu">
									...
									<c:if test="${permissionChecker.hasPermission(scopeGroupId, portletDisplay.rootPortletId, portletDisplay.resourcePK, DELETE_LOG_PROCEDURE)}">
										<li><a href="javascript:void(0)"
											...
											data-target="#deleteModal" data-toggle="modal" data-tab="pills-unconfirmed-tab"><i
