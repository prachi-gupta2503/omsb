...
public class FormDataResponse implements Serializable {
	...
	public static FormDataResponse toDTO(String json) {
		return ObjectMapperUtil.readValue(FormDataResponse.class, json);
	}

	public static FormDataResponse unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(FormDataResponse.class, json);
	}

	@Schema(description = "The Json response.")
	@Valid
	...
	@GraphQLField(description = "The Json response.")
	...
	@Schema(
		...
		defaultValue = "gov.omsb.form.builder.headless.dto.v1_0.FormDataResponse",
		name = "x-class-name"
	)
