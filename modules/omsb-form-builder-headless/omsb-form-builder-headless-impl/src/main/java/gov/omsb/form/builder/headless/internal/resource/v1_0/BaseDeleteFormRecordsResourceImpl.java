...
public abstract class BaseDeleteFormRecordsResourceImpl
	implements DeleteFormRecordsResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/omsb-form-api/v1.0/delete-form-records' -d $'{"formDefinitionId": ___, "recordIds": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(name = "DeleteFormRecords")
		}
	)
	@javax.ws.rs.Consumes({"application/json", "application/xml"})
	@javax.ws.rs.Path("/delete-form-records")
	@javax.ws.rs.POST
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseDeleteFormRecordsResourceImpl.class);
