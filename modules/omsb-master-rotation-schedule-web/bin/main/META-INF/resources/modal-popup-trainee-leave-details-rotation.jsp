...
<div class="modal fade omsb-modal omsb-masterrotation-modal" id="traineeleavedetailsrotations" tabindex="-1" role="dialog" aria-labelledby="traineeleavedetailsTitle" aria-hidden="true">
							...
							<table class="table">
								<thead>
									<tr>
										...
										<th scope="col"><liferay-ui:message key="block" /></th>
