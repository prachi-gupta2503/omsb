...
<div class="modal fade" id="myModal" role="dialog">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<aui:form action="${deleteEligiblilityDegree}" name="passfm" method="post">
				<div class="modal-body">
					<div class="row">
							<div class="col-md-12">
								<aui:input id="eligibilityDegreeMasterId" name="eligibilityDegreeMasterId" value="" type="hidden" /> 
								<div>
