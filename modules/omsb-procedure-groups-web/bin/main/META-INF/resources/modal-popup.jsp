...
<portlet:actionURL name="<%=OmsbProcedureGroupsConstants.DELETE_PROCEDURE_GROUPS_MVC_COMMAND_NAME%>" var="deleteProcedureGroup" />
...
<div class="modal fade" id="myModal" role="dialog">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<aui:form action="${deleteProcedureGroup}" name="passfm">
				<div class="modal-body">
					<div class="row">
						<div class="col-md-12">
							<aui:input id="procedureGroupMasterId" name="procedureGroupMasterId" value="" type="hidden" /> 
							<div>
