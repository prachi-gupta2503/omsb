...
<portlet:actionURL name="<%= OmsbRotationTypeWebPortletKeys.DELETE_ROTATION_TYPE_MVC_ACTION_COMMAND %>" var="deleteRotationTypeURL" />
...
<div class="modal fade" id="confirmationModel" role="dialog">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<aui:form action="${deleteRotationTypeURL}" name="passfm">
				<div class="modal-body">
					<div class="row">
							<div class="col-md-12">
								<aui:input id="rotationTypeMasterId" name="rotationTypeMasterId" value="" type="hidden" /> 
								<div>
