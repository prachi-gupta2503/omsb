...
@Component(immediate = true, property = { "javax.portlet.name=" + OmsbProceduresWebPortletKeys.OMSBPROCEDURESWEB,
		"mvc.command.name="
				+ OmsbProceduresConstants.ADD_PROCEDURE_MASTER_MVC_COMMAND_NAME }, service = MVCActionCommand.class)
public class OmsbAddProcedureMVCActionCommand extends BaseMVCActionCommand {

	@Override
	protected void doProcessAction(ActionRequest actionRequest, ActionResponse actionResponse) throws Exception {
		ThemeDisplay themeDisplay = (ThemeDisplay) actionRequest.getAttribute(WebKeys.THEME_DISPLAY);
		procedureMasterLocalService.createProcedureMaster(actionRequest, themeDisplay);
