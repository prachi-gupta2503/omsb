...
<portlet:renderURL var="cancellationBackURL">
...
<portlet:actionURL var="WorkflowAssignURL" name="oct/exam/workflow_action">
	...
	<portlet:param name="cancellationId" value="${id}" />
</portlet:actionURL>
<portlet:actionURL var="applicantCancellationURL" name="<%=MVCCommandNames.SAVE_CANCELLATION_ACTION%>"></portlet:actionURL>
<form action="${applicantCancellationURL }" method="post" name="admin_cancellation_fm">
	<input type="hidden" value="${id}" name="<portlet:namespace/>cancellationId">
				...
				<div class="container">
					<div class="omsb-card">
						<div class="omsb-page-top-info">
							<div class="pagetitle"><liferay-ui:message key="admin-cancellation-form"/></div>							
						</div>
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-12">
								<div class="form-group-dtls">
									<h4><label>${examTitle }</label></h4> 
								</div>
							</div>
						</div>
							 <script>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<label><liferay-ui:message key="reason-for-cancellation"/> (${status.name})<span></span></label>
						...
						<div class="bottom-backbtn-wrap">
							...
							<a class="btn omsb-btn btn-back" href="${cancellationBackURL }"><i class="fi fi-sr-arrow-left"></i><liferay-ui:message key="back"/></a>
						</div>
