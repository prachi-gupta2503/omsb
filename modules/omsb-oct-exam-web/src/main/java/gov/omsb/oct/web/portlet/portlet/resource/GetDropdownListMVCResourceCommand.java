...
@Component(immediate = true, property = { "javax.portlet.name=" + OmsbOctExamWebPortletKeys.OMSBOCTEXAMWEB,
		"mvc.command.name=" + MVCCommandNames.GET_DROPDOWN_LIST_MVC_RESOURCE }, service = MVCResourceCommand.class)
public class GetDropdownListMVCResourceCommand implements MVCResourceCommand {
...
//
//					String trainingSiteIdString = ParamUtil.getString(resourceRequest, "trainingSiteId");
//
...
//					}
//
//					List<OCTMapTrainingSite> octMapTrainingSiteList = octExamUtil.getOCTMapTrainingSite(portalUrl,
...
//						for (OCTMapTrainingSite examSlot : octMapTrainingSiteList) {
//							JSONObject object = JSONFactoryUtil.createJSONObject();
//
//							object.put("name", examSlot.getExamDuration());
//							object.put("value", examSlot.getExamDuration());
...
//		}
	...
	private static final Log logger = LogFactoryUtil.getLog(SectionDepartmentMVCResourceCommand.class);
}
