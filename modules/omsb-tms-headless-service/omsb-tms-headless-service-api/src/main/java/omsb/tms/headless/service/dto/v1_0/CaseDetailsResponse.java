...
@Generated("")
@GraphQLName(
	description = "To give the response.", value = "CaseDetailsResponse"
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "CaseDetailsResponse")
public class CaseDetailsResponse implements Serializable {

	public static CaseDetailsResponse toDTO(String json) {
		return ObjectMapperUtil.readValue(CaseDetailsResponse.class, json);
	}

	public static CaseDetailsResponse unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			CaseDetailsResponse.class, json);
	}
	...
	@GraphQLField(description = "The crn .")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@Schema(
		...
		defaultValue = "omsb.tms.headless.service.dto.v1_0.CaseDetailsResponse",
		name = "x-class-name"
	)
