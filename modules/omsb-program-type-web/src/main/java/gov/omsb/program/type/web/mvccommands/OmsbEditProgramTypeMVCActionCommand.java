...
@Component(property = { "javax.portlet.name=" + OmsbProgramTypeWebPortletKeys.OMSBPROGRAMTYPEWEB, "mvc.command.name="
		+ OmsbProgramTypeConstants.UPDATE_PROGRAM_TYPE_MVC_COMMAND_NAME }, service = MVCActionCommand.class)
public class OmsbEditProgramTypeMVCActionCommand extends BaseMVCActionCommand {

	@Override
	protected void doProcessAction(ActionRequest actionRequest, ActionResponse actionResponse) throws Exception {
		_logger.debug("doProcessAction Invoked ::: ");
		ThemeDisplay themeDisplay = (ThemeDisplay) actionRequest.getAttribute(WebKeys.THEME_DISPLAY);
		long programTypeMasterId = ParamUtil.getLong(actionRequest,OmsbProgramTypeConstants.PROGRAM_TYPE_ID);
		programTypeMasterLocalService.updateProgramTypeMaster(actionRequest, programTypeMasterId, themeDisplay);
	...
	private static final Log _logger = LogFactoryUtil.getLog(OmsbEditProgramTypeMVCActionCommand.class.getName());
}
