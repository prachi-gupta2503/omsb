			...
			<div class="container">
				<div class="omsb-card">
					<div class="omsb-page-top-info mb-4">
						<div class="pagetitle"><liferay-ui:message key="ec-member-request-add-edit-member-details"></liferay-ui:message></div>
					</div>
					<aui:form action="${addMemberDetailsActionURL}" method="post"
						...
						<div class="row">
							<div class="col-md-4 col-sm-6 col-xs-6">
								<div class="form-group">
									<aui:input type="text" name="bankName" class="form-control" label="ec-member-request-bank-name">
							...
							<div class="col-md-4 col-sm-6 col-xs-6">
								<div class="form-group">
									<aui:input type="text" name="bankBranch" class="form-control" label="ec-member-request-branch-name">
										<aui:validator name="required" />
									</aui:input>
								</div>
							</div>
						</div>
						<h4 class="omsb-card-title pt-3"><liferay-ui:message key="ec-member-request-potential-member-id-details"></liferay-ui:message></h4>
									...
									<div class="form-group">
										<div class="custom-file required-asterisk mb-3">
											<aui:input type="file" class="custom-file-input"
												id="passportId" label="ec-member-request-passport" name="passportId"
												onChange="validateFile(this,'passportdetailsId')">
											</aui:input>
											<label class="custom-file-label"
												for="<portlet:namespace/>passportId"></label>
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<div class="form-group">
										<div class="custom-file required-asterisk mb-3">
											...
											<label class="custom-file-label"
												for="<portlet:namespace/>nationalId"> </label>
						...
						<div class="omsb-card-graybg omsb-card omsb-BorderRadius-4">
							<h4 class="omsb-card-title pt-3">
								<liferay-ui:message key="ec-member-request-potential-member-education-details"></liferay-ui:message>
								<button class="btn omsb-bc-red-button" data-toggle="modal"
									data-target="#addmem_edu_detail" type="button"><liferay-ui:message key="ec-member-request-add-education-details" />
								</button>
							</h4>
								...
								<table id="educationDetailTable" class="display omsb-datatables">
									<thead>
										<tr>
											...
											<th><liferay-ui:message key="ec-member-request-country-of-institution" /></th>
											<th><liferay-ui:message key="ec-member-request-gpa" /></th>
											<th><liferay-ui:message key="ec-member-request-year-of-graduation" /></th>
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalLongTitle"><liferay-ui:message key="ec-member-request-add-education-details" />
				</h5>
			...
			<aui:form action="#" name="ec_member_education_details" method="post"
							...
							<div class="form-group">
								<div class="custom-file required-asterisk mb-3">
									...
									<label class="custom-file-label"
										...
										for="<portlet:namespace/>qualificationDocument"> </label>
									<small id="qualificationdetailsId" style="color: #dc3545;"></small>	
								</div>
							</div>
						</div>
					</div>
				...
				<div class="modal-footer">
					<aui:button class="btn omsb-bc-red-button" type="button"
						value="label-submit-button" onClick="addMemberEducationDetails()"></aui:button>
		 ...
		 let columns = [
			  ...
			  $('#educationDetailTable').on('click', '.edit-button', function() {	
			    ...
			    $.ajax({
			          ...
			          success: function(response) {
			            if (response) {
			            	var fileName = response.qualificationDocument;
			                ...
			                $("#qualificationDocumentLabel").text(fileName);
			            }
			          },
			          error: function() {
			        	  console.log("If fetching fails, resolve with an empty string"); // If fetching fails, resolve with an empty string
