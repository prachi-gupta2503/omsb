			...
			<div class="row">
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="form-group">
						<aui:input type="text" name="name" label="name" id="name"
							class="form-control">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="form-group">
						<aui:input type="text" name="email" label="email" id="email"
							class="form-control">
							<aui:validator name="required"></aui:validator>
						</aui:input>
					</div>
			...
			<div class="omsb-card omsb-card-graybg omsb-BorderRadius-4">
				<p class="m-0 d-flex justify-content-between align-items-center">
					...
					<button class="btn omsb-bg-red-button m-0" type="button"
						id="<portlet:namespace/>invitePersonBtn">Invite</button>
				</p>
			</div>
		</div>
	</div>
		...
		<table class="display omsb-datatables" id="personsDatatable">
			<thead>
				<tr>
					...
					<th class="no_sorting"><liferay-ui:message key="action" /></th>
				</tr>
			</thead>
			...
			<div class="row">
				<div class="col-md-6 col-sm-12">
					<div class="omsb-list-view table-responsive"
						id="personsAffiliationDatatableDiv">
						<h4 class="omsb-card-title pt-3">Existing Affiliations</h4>
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						<aui:select name="programName" id="programName"
							class="form-control" label="program-name">
							<aui:validator name="required"></aui:validator>
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						<aui:select name="membershipRole" id="membershipRole"
							class="form-control" label="membership-role">
							<aui:validator name="required"></aui:validator>
							<option value="">select</option>
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						<div class="custom-file ec-request-file">
							<aui:input id="coveringLetter" label="covering-letter"
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="form-group">
						<div class="custom-file ec-request-file mb-3">
							<aui:input id="curriculamVitae" label="curriculam-vitae"
	...
	<div class="modal-dialog modal-dialog-centered" role="document"
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<p class="m-0">This person is invited to register in the portal
					successfully.</p>
			</div>
