...
<div class="omsb-card">
	<div class="omsb-page-top-info mb-4">
		<div class="pagetitle">Edit EC membership Request</div>
	</div>
	<div class="row">
		<div class="col-lg-4 col-md-6 col-sm-12 label-box">
			<label class="label-name">Potential member name</label> <label
				class="label-content">${editData.givenNameAsPassport}</label>
		</div>
	</div>
	<div class="row">
		<div class="col-lg-4 col-md-6 col-sm-12 label-box">
			<label class="label-name">Civil ID</label> <label
				class="label-content">${editData.civilId}</label>
		</div>
		<div class="col-lg-4 col-md-6 col-sm-12 label-box">
			<label class="label-name">Passport No</label> <label
				class="label-content">${editData.passportNumber}</label>
		</div>
		<div class="col-lg-4 col-md-6 col-sm-12 label-box">
			<label class="label-name">Date of Birth</label> <label
	...
	<aui:form action="${updateEcMembershipRequestActionURL}" method="post" name="addNewEcMemberRequest" 
		...
		<div class="row">
			<div class="col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
					<div class="custom-file ec-request-file mb-3">
						<aui:input id="coveringLetter" label="covering-letter" name="coveringLetter" type="file" value="${editData.coveringLetterUrl}">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				<div class="form-group">
					<div class="custom-file ec-request-file mb-3">
						<aui:input id="curriculamVitae" label="curriculam-vitae" name="curriculamVitae" type="file" value="${editData.cvUrl}">
							<aui:validator name="acceptFiles">'pdf,docx,doc'</aui:validator>
						</aui:input>
		...
		<c:when test="${not empty workflowTaskDetail.actionList }">
			<button class="btn omsb-bc-red-button" type="submit" title="Resend Request" id="submitBtn"
					onClick="saveAndSubmit(`${workflowTaskDetail.taskId }`,
						...
						<liferay-ui:message key="resend-request" />
				</button>
		</c:when>
		<c:otherwise>
			<button class="btn omsb-bc-red-button" type="submit" title="Resend Request" id="submitBtn">
			...
			<a class="btn omsb-btn btn-back" href="${backURL}"><i
				class="fi fi-sr-arrow-left"></i>Cancel</a>
		</div>
	</aui:form>
</div>
