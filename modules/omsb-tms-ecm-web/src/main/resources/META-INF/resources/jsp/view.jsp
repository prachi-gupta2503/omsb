		...
		<div id="wrapper">
			<div class="container">
				<div class="omsb-card">
					...
					<input type="hidden" value="true" name="<portlet:namespace/>isSearch"/>
						<div class="omsb-list-filter ">
							<div class="row">
								<div class="col-lg-4 col-md-6 col-sm-12">
									<div class="form-group">
										<label><liferay-ui:message key="ec-member-request-program" /></label> <select
											name="<portlet:namespace />programId" class="form-control searchableProgram"
											id="dropdown">
						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="form-group">
								...
								<textarea name="<portlet:namespace />qarar_comment"
									style="width:600px;" class="form-control comment" id="<portlet:namespace />qarar_comment"></textarea>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="form-group">
								...
								<textarea name="<portlet:namespace />member_request_comment"
									style="width:600px;" class="form-control comments" id="<portlet:namespace />member_request_comment"></textarea>
							</div>
						</div>
					</div>
				</div>
...
function viewDistributionReport(requestId){
	let facultyURL = '${themeDisplay.getPortalURL()}/group<%=siteFriendlyURL%><%=OmsbEcMembershipConstants.FACULTY_SITE_COMPENSATION_REPORT_URL%>?requestId='+requestId;
