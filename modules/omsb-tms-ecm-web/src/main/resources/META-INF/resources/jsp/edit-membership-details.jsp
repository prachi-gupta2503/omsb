...
<% 
    ...
    String editProfileUrl = themeDisplay.getPortalURL()+"/group"+siteFriendlyURL+"/my-profile";
   %>
				...
				<div class="omsb-card">
					...
					<div class="omsb-page-top-info">
						...
						<div class="information">
							<a class="btn omsb-bc-red-button" href="<%=editProfileUrl%>">
									Edit Profile</a>
						</div>
					</div>
					<aui:form action="${editMemberDetailsActionURL}" method="post"
								...
								<c:if test="${not empty civilCardFrontPhotoUrl}">
									<div class="label-content">
										<div class="omsb-card-caserport row">
											...
											<div class="righbar col-4">
												<a href="${civilCardBackPhotoUrl}" target="_blank">
													<button class="btn view_btn" title="View">
														<img
															src="<%=themeDisplay.getPathThemeImages()%>/svg/view_icon.svg"
															alt="" />
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12 pt-3">
								...
								<c:if test="${empty passportDocumentUrl}">
									<liferay-ui:message key="not-available" />
								</c:if>
								<c:if test="${not empty passportDocumentUrl}">
									<div class="label-content">
										<div class="omsb-card-caserport ">
											<div class="leftbar">
												<h4 class="casereport-title">${passportNumber}</h4>
											</div>
											<div class="righbar">
												<a href="${passportDocumentUrl}" target="_blank">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<div class="form-group">
								<aui:input cssClass="form-control" type="hidden"
									...
									label="ec-member-request-gpa" value="0">
								</aui:input>
		...
		if(isValid){
			...
			return false; 
			  ...
			  $('#educationDetailTable').on('click', '.edit-button', function() {	
			    ...
			    console.log('<%=editEducationDetailsData.toString()%>');
