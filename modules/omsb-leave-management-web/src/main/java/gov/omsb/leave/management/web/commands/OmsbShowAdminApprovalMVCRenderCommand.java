...
@Component(immediate = true, property = {
		...
		"mvc.command.name="
				+ OmsbLeaveManagementWebConstants.ADMIN_APPROVAL_RENDER_COMMAND }, service = MVCRenderCommand.class)
public class OmsbShowAdminApprovalMVCRenderCommand implements MVCRenderCommand {
	...
	public String render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
		...
		return OmsbLeaveManagementWebConstants.ADMIN_APPROVAL_JSP;
	}
	...
	private Log log = LogFactoryUtil.getLog(OmsbShowAdminApprovalMVCRenderCommand.class.getName());
