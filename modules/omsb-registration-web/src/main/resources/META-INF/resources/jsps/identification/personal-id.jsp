                            	...
                            	<div class="omsb-card omsb-card-graybg omsb-BorderRadius-4">
									...
									<div class="row identify-row">
										...
										<div class="col-md-12 col-sm-12 col-xs-12">
											<h5 class="reg-form-section-title text-left m-0 pt-3"><strong><liferay-ui:message key="or"/></strong></h5>
										</div>
...
$(document).ready(function(){
	...
	$('#btnpersonalIdSaveAndContinue').click(function(){
		...
		if(passportNo>0){
			...
			console.log("inside dfrn");
			validateDFRM();
		}
		console.log("validDob ::",validDob);
		if (validPassport == true && validDob == true || validDfrn ==true) {
			validPersonId=true;
			$("#passPortcheck1").hide();
			$("#passPortcheck2").hide();
		}else{
