							...
							<div class="row">
								...
								<div class="col-lg-4 col-md-6">
								  <c:if test="${not empty person.civilId}" >
									<div class="form-group">
										<label class="control-label required"><liferay-ui:message key="omani-civil-id-or-omani-resident-id" /></label>
									...
									<div class="form-group">
										...
										<div class="omsb-ilo-area">
											<input type="text" name="<portlet:namespace/>mobileNumber" id="mobileNumber" value="${personalDetails.mobileNumber}"
												class="form-control" ${personalDetails.mobileNumberVerified?'readOnly':''} onKeyPress="if(this.value.length==8) return false;return onlyNumberKey(event);" onpaste="return false;" ondrop="return false;" >
