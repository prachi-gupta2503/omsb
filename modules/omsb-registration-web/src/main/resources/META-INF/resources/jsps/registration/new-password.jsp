						...
						<form action="${saveNPURL}" method="post" 
							...
							<div class="omsb-card" >
								...
								<div class="form-group">
									...
									<input class="form-control" placeholder="<liferay-ui:message key="password" />" type="password" name="<portlet:namespace/>password" id="password" onkeyup="validatePassword(this.id);" >
								</div>
								...
								<div class="form-group">
									...
									<input class="form-control" placeholder="<liferay-ui:message key="confirm-password" />" type="password" name="<portlet:namespace/>confirmPassword" id="confirmPassword" onkeyup="validateRePassword(this.id);" >
								</div>
