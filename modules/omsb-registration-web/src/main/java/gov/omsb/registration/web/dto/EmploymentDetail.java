...
public class EmploymentDetail {
	...
	private WorkSectorItems workSecondSubSectorItems ;
	...
	public WorkSectorItems getWorkSecondSubSectorItems() {
		return workSecondSubSectorItems;
	}

	public void setWorkSecondSubSectorItems(WorkSectorItems workSecondSubSectorItems) {
		this.workSecondSubSectorItems = workSecondSubSectorItems;
	}
