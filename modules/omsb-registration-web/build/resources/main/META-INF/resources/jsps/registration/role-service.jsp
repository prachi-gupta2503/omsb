										...
										<div class="row ">
											...
											<div class="col-lg-4 col-md-6 d-none" id="sectionOtherDiv_1">
												<div class="form-group">
													...
													<input  type="text" name="<portlet:namespace/>sectionOther_1" id="sectionOther_1" class="form-control" value="${sectionOther}" >
												</div>
											...
											<div class="col-lg-4 col-md-6 d-none" id="functionOtherDiv_1">
												<div class="form-group">
													...
													<input  type="text" name="<portlet:namespace/>functionOther_1" id="functionOther_1" class="form-control" value="${functionOther}" >
												</div>
											...
											<div class="col-lg-4 col-md-6 d-none" id="programtypeOtherDiv_1">
												<div class="form-group">
													...
													<input  type="text" name="<portlet:namespace/>programtypeOther_1" id="programtypeOther_1" class="form-control" value="${programTypeOther}" >
												</div>
											...
											<div class="col-lg-4 col-md-6 d-none" id="programOtherDiv_1">
												<div class="form-group">
													...
													<input  type="text" name="<portlet:namespace/>programOther_1" id="programOther_1" class="form-control" value="${programOther}" >
												</div>
									...
									<div class="d-none" id="registrant_detail_area" >
										...
										<div class="omsb-card omsb-card-graybg omsb-noBorderRadius" id="role_detail_area">
											...
											<div class="col-lg-4 col-md-6 d-none" id="roleOtherDiv_2">
												<div class="form-group">
													<label class="control-label required"><liferay-ui:message key="role-other" /></label>
													<input type="text" name="<portlet:namespace/>roleOther_2" id="roleOther_2" class="form-control" value="${roleOther}" >
												</div>
											...
											<div class="col-lg-4 col-md-6 d-none" id="sectionOtherDiv_2">
												<div class="form-group">
													<label class="control-label required"><liferay-ui:message key="section-other" /></label>
													<input  type="text" name="<portlet:namespace/>sectionOther_2" id="sectionOther_2" class="form-control" value="${sectionOther}" >
												</div>
											...
											<div class="col-lg-4 col-md-6 d-none" id="programOtherDiv_2">
												<div class="form-group">
													<label class="control-label required"><liferay-ui:message key="program-other" /></label>
													<input type="text" name="<portlet:namespace/>programOther_2" id="programOther_2" class="form-control" value="${programOther}" >
												</div>
											...
											<div class="col-lg-4 col-md-6 d-none" id="programPositionOtherDiv_2">
												<div class="form-group">
													<label class="control-label required"><liferay-ui:message key="program-position-other" /></label>
													<input type="text" name="<portlet:namespace/>programPositionOther_2" id="programPositionOther_2" class="form-control" value="${programPositionOther}" >
												</div>
											...
											<div class="col-lg-4 col-md-6 d-none" id="purposeOtherDiv_2">
												<div class="form-group">
													<label class="control-label required"><liferay-ui:message key="purpose-other" /></label>
													<input type="text" name="<portlet:namespace/>purposeOther_2" id="purposeOther_2" class="form-control" value="${purposeOther}" >
												</div>
...
function validateAndSaveFormData(button) {
	...
	function setRole_1(selectedRole){
		...
		} else if(selectedRole.toLowerCase() === 'GFP Trainee'.toLowerCase() || selectedRole.toLowerCase() === 'Fellowship Trainee'.toLowerCase() || selectedRole.toLowerCase() === 'Residency Trainee'.toLowerCase()){
			$('#programDiv_1').removeClass("d-none");
