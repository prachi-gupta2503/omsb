					...
					<div class="Id-forms">
                        ...
                        <c:if test="${pkiAvaibility}">  
						 	<div class="form-group">
								...
								<input class="form-control" placeholder="<liferay-ui:message key="mobile"/>" type="text" id="mobileno" name="<portlet:namespace/>mobileno" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==8) return false;" >
						 	</div>
						 ...
						 <div class="form-group col-md-6 col-sm-6">
						 	<label class="control-label"><liferay-ui:message key="omani-civil-id"/></label> <input
								class="form-control" placeholder="<liferay-ui:message key="omani-civil-id"/>" type="text"
