							...
							<div class="omsb-card">
								...
								<c:if test="${not empty civilId}">
									...
									<div class="form-group col-md-6 col-sm-6">
										<label class="control-label"><liferay-ui:message key="civil-id" /></label>
										<input class="form-control" placeholder="<liferay-ui:message key="civil-id" />" type="text" value="${civilId}" id="civilId" name="civilId" readonly>
									</div>
								</c:if>
