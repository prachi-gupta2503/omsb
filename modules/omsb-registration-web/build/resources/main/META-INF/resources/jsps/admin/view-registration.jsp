		...
		<div class="container">
			<div class="omsb-card ">
				...
				<div class="row">
					...
					<div class="col-md-4 label-box">
						<label class="label-name"><liferay-ui:message key="civil-id" /></label>
		...
		<liferay-portlet:actionURL name="<%=MVCCommands.SAVE_ADMIN_DECISION%>" var="saveProfileApproverDecisionURL" />
			...
			<form action="${saveProfileApproverDecisionURL}" method="post" 
				...
				<div class="modal-footer omsb-popup-buttons-3">
					...
					<button class="btn omsb-bg-red-button" type="button" title="<liferay-ui:message key="close" />"><liferay-ui:message key="close" /></button>
				</div>
				</form>
			</div>
