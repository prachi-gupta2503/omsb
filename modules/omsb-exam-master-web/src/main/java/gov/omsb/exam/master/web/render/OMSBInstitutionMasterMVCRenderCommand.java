...
@Component(immediate = true, property = { "javax.portlet.name=" + OmsbExamMasterWebPortletKeys.OMSBEXAMMASTERWEB,
		"mvc.command.name=" + MVCCommandNames.OMSB_INSTITUTION_MASTER_RENDER, }, service = MVCRenderCommand.class)

public class OMSBInstitutionMasterMVCRenderCommand implements MVCRenderCommand {
	...
	public String render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
		...
		return OmsbExamMasterWebPortletKeys.OMSB_INSTITUTION_MASTER_JSP;
	}
