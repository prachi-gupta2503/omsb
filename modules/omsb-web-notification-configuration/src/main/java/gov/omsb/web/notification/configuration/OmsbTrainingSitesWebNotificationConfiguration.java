...
@OCD(id = "gov.omsb.web.notification.configuration.OmsbTrainingSitesWebNotificationConfiguration", localization = "content/Language", name = "web-notification-training-sites")
public interface OmsbTrainingSitesWebNotificationConfiguration {
