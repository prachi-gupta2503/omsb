 ...
 * @generated
 */
public abstract class FormDefinitionFinderBaseImpl
	extends BasePersistenceImpl<FormDefinition> {

	public FormDefinitionFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return formDefinitionPersistence.getBadColumnNames();
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FormDefinitionFinderBaseImpl.class);
