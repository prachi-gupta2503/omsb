...
/**
 * Provides the local service interface for FormRecordEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see FormRecordEntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FormRecordEntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>gov.omsb.form.builder.service.impl.FormRecordEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the form record entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FormRecordEntryLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public FormRecordEntry findFormRecordEntryByFormDefinitionIdAndRecordId(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FormRecordEntry> getFormDefinitionByStatus(
