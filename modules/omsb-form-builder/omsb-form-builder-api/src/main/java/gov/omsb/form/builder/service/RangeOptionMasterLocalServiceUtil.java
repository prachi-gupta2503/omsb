...
/**
 * Provides the local service utility for RangeOptionMaster. This utility wraps
 * <code>gov.omsb.form.builder.service.impl.RangeOptionMasterLocalServiceImpl</code> and
 ...
 * @generated
 */
public class RangeOptionMasterLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>gov.omsb.form.builder.service.impl.RangeOptionMasterLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static RangeOptionMaster addRangeOptionMaster(
		RangeOptionMaster rangeOptionMaster) {

		return getService().addRangeOptionMaster(rangeOptionMaster);
	}
	 ...
	 */
	public static RangeOptionMaster createRangeOptionMaster(
		long rangeOptionId) {

		return getService().createRangeOptionMaster(rangeOptionId);
	}
	 ...
	 */
	public static RangeOptionMaster deleteRangeOptionMaster(long rangeOptionId)
		throws PortalException {

		return getService().deleteRangeOptionMaster(rangeOptionId);
	}
	 ...
	 * @return the range option master that was removed
	 */
	public static RangeOptionMaster deleteRangeOptionMaster(
		RangeOptionMaster rangeOptionMaster) {

		return getService().deleteRangeOptionMaster(rangeOptionMaster);
	}
	...
	public static RangeOptionMaster fetchRangeOptionMaster(long rangeOptionId) {
		return getService().fetchRangeOptionMaster(rangeOptionId);
	}
	 ...
	 */
	public static RangeOptionMaster fetchRangeOptionMasterByUuidAndGroupId(
		String uuid, long groupId) {

		return getService().fetchRangeOptionMasterByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 * @throws PortalException if a range option master with the primary key could not be found
	 */
	public static RangeOptionMaster getRangeOptionMaster(long rangeOptionId)
		throws PortalException {

		return getService().getRangeOptionMaster(rangeOptionId);
	}
	 ...
	 */
	public static RangeOptionMaster getRangeOptionMasterByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return getService().getRangeOptionMasterByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 */
	public static List<RangeOptionMaster> getRangeOptionMasters(
		int start, int end) {

		return getService().getRangeOptionMasters(start, end);
	}
	 ...
	 */
	public static List<RangeOptionMaster>
		getRangeOptionMastersByUuidAndCompanyId(String uuid, long companyId) {

		return getService().getRangeOptionMastersByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static int getRangeOptionMastersCount() {
		return getService().getRangeOptionMastersCount();
	}
	 ...
	 */
	public static RangeOptionMaster updateRangeOptionMaster(
		RangeOptionMaster rangeOptionMaster) {

		return getService().updateRangeOptionMaster(rangeOptionMaster);
	}

	public static RangeOptionMasterLocalService getService() {
		return _service;
	}

	private static volatile RangeOptionMasterLocalService _service;
