...
.list-group-item.active .checkbox input[type='checkbox'] {
   filter: invert(65%) sepia(36%) saturate(1140%) hue-rotate(345deg) brightness(99%) contrast(99%);
}
</style>
<%
...
<section class="omsb-main-wrapper omsb-notification" id="omsb-main-wrapper">
<div class="omsb-header-tab">
				<div class="container">
...
<clay:container>
	<aui:form action="<%= currentURL %>" method="get" name="fm">
		<div class="user-notifications tab-content" id="myTabContent">
			<div class="tab-pane fade show active" id="NotificationsList" role="tabpanel" aria-labelledby="NotificationsList-tab">
