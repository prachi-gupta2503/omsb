...
public class OmsbSupervisorEmailConfigurationFormRenderer implements ConfigurationFormRenderer {

	public static final String CLASS_NAME = OmsbSupervisorEmailConfiguration.class.getName();
	...
	public void render(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse)
		...
		String subjectXML = OmsbSupervisorEmailConfigurationAction.subjectXML();
	    String bodyXML = OmsbSupervisorEmailConfigurationAction.bodyXML();
	...
	private static final Log _logger = LogFactoryUtil.getLog(OmsbSupervisorEmailConfigurationFormRenderer.class);
}
