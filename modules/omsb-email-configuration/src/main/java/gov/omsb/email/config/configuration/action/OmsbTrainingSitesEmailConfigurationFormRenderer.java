...
public class OmsbTrainingSitesEmailConfigurationFormRenderer implements ConfigurationFormRenderer {

	public static final String CLASS_NAME = OmsbTrainingSitesEmailConfiguration.class.getName();
	...
	public void render(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse)
		...
		String subjectXML = OmsbTrainingSitesEmailConfigurationAction.subjectXML();
	    String bodyXML = OmsbTrainingSitesEmailConfigurationAction.bodyXML();
	...
	private static final Log _logger = LogFactoryUtil.getLog(OmsbTrainingSitesEmailConfigurationFormRenderer.class);
