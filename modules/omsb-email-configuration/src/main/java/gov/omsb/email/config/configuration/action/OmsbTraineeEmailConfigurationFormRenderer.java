...
public class OmsbTraineeEmailConfigurationFormRenderer implements ConfigurationFormRenderer {

	public static final String CLASS_NAME = OmsbTraineeEmailConfiguration.class.getName();
	...
	public void render(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse)
		...
		String subjectXML = OmsbTraineeEmailConfigurationAction.subjectXML();
	    String bodyXML = OmsbTraineeEmailConfigurationAction.bodyXML();
	...
	private static final Log _logger = LogFactoryUtil.getLog(OmsbTraineeEmailConfigurationFormRenderer.class);
}
