...
public class OmsbRequestSharedRotationEmailConfigurationFormRenderer implements ConfigurationFormRenderer {

	public static final String CLASS_NAME = OmsbRequestSharedRotationEmailConfiguration.class.getName();
	...
	public void render(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse)
		...
		String subjectXML = OmsbRequestSharedRotationEmailConfigurationAction.subjectXML();
	    String bodyXML = OmsbRequestSharedRotationEmailConfigurationAction.bodyXML();
	...
	private static final Log _logger = LogFactoryUtil.getLog(OmsbRequestSharedRotationEmailConfigurationFormRenderer.class);
}
