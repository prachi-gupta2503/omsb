...
@OCD(id = "gov.omsb.email.config.configuration.OmsbTrainingSitesEmailConfiguration", localization = "content/Language", name = "email-notification-training-sites")
public interface OmsbTrainingSitesEmailConfiguration {
