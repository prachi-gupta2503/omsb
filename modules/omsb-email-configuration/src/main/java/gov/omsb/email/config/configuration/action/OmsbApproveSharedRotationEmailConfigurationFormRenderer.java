...
public class OmsbApproveSharedRotationEmailConfigurationFormRenderer implements ConfigurationFormRenderer{

	public static final String CLASS_NAME = OmsbApproveSharedRotationEmailConfiguration.class.getName();
	...
	public void render(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse)
		...
		String subjectXML = OmsbApproveSharedRotationEmailConfigurationAction.subjectXML();
	    String bodyXML = OmsbApproveSharedRotationEmailConfigurationAction.bodyXML();
