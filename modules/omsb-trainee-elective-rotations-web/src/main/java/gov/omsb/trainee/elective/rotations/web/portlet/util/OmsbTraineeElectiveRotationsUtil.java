package gov.omsb.trainee.elective.rotations.web.portlet.util;
...
public class OmsbTraineeElectiveRotationsUtil {
	...
	@Reference
	private static TraineeAdmissionDetailsRelLocalService traineeAdmissionDetailsRelLocalService;
