...
/**
 * Provides the local service utility for FacultyBankDetails. This utility wraps
 * <code>gov.omsb.tms.service.impl.FacultyBankDetailsLocalServiceImpl</code> and
 ...
 * @generated
 */
public class FacultyBankDetailsLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>gov.omsb.tms.service.impl.FacultyBankDetailsLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static FacultyBankDetails addFacultyBankDetails(
		FacultyBankDetails facultyBankDetails) {

		return getService().addFacultyBankDetails(facultyBankDetails);
	}
	 ...
	 */
	public static FacultyBankDetails createFacultyBankDetails(
		long facultyBankDetailsId) {

		return getService().createFacultyBankDetails(facultyBankDetailsId);
	}
	 ...
	 */
	public static FacultyBankDetails deleteFacultyBankDetails(
		FacultyBankDetails facultyBankDetails) {

		return getService().deleteFacultyBankDetails(facultyBankDetails);
	}
	...
	public static FacultyBankDetails deleteFacultyBankDetails(
		...
		return getService().deleteFacultyBankDetails(facultyBankDetailsId);
	}
	...
	public static FacultyBankDetails fetchFacultyBankDetails(
		long facultyBankDetailsId) {

		return getService().fetchFacultyBankDetails(facultyBankDetailsId);
	}
	 ...
	 */
	public static FacultyBankDetails fetchFacultyBankDetailsByUuidAndGroupId(
		String uuid, long groupId) {

		return getService().fetchFacultyBankDetailsByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 * @throws PortalException if a faculty bank details with the primary key could not be found
	 */
	public static FacultyBankDetails getFacultyBankDetails(
			long facultyBankDetailsId)
		throws PortalException {

		return getService().getFacultyBankDetails(facultyBankDetailsId);
	}
	 ...
	 */
	public static FacultyBankDetails getFacultyBankDetailsByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return getService().getFacultyBankDetailsByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 */
	public static List<FacultyBankDetails> getFacultyBankDetailses(
		int start, int end) {

		return getService().getFacultyBankDetailses(start, end);
	}
	 ...
	 */
	public static List<FacultyBankDetails>
		getFacultyBankDetailsesByUuidAndCompanyId(String uuid, long companyId) {

		return getService().getFacultyBankDetailsesByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static int getFacultyBankDetailsesCount() {
		return getService().getFacultyBankDetailsesCount();
	}
	 ...
	 */
	public static FacultyBankDetails updateFacultyBankDetails(
		FacultyBankDetails facultyBankDetails) {

		return getService().updateFacultyBankDetails(facultyBankDetails);
	}

	public static FacultyBankDetailsLocalService getService() {
		return _service;
	}

	private static volatile FacultyBankDetailsLocalService _service;
