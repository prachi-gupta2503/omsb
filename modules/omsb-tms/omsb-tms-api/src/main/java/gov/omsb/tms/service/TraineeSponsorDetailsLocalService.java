...
/**
 * Provides the local service interface for TraineeSponsorDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TraineeSponsorDetailsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TraineeSponsorDetailsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>gov.omsb.tms.service.impl.TraineeSponsorDetailsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the trainee sponsor details local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TraineeSponsorDetailsLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public TraineeSponsorDetails addTraineeSponsorDetails(
	...
	public TraineeSponsorDetails createTraineeSponsorDetails(
	...
	public TraineeSponsorDetails deleteTraineeSponsorDetails(
			long traineeSponsorDetailsId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TraineeSponsorDetails fetchTraineeSponsorDetails(
		long traineeSponsorDetailsId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TraineeSponsorDetails fetchTraineeSponsorDetailsByUuidAndGroupId(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TraineeSponsorDetails getTraineeSponsorDetails(
			long traineeSponsorDetailsId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TraineeSponsorDetails getTraineeSponsorDetailsByTraineeId(
		long traineeId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TraineeSponsorDetails getTraineeSponsorDetailsByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TraineeSponsorDetails> getTraineeSponsorDetailses(
		int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TraineeSponsorDetails>
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public TraineeSponsorDetails updateTraineeSponsorDetails(
		TraineeSponsorDetails traineeSponsorDetails);
