...
/**
 * Provides the local service interface for ProgramDutyRule. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ProgramDutyRuleLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ProgramDutyRuleLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>gov.omsb.tms.service.impl.ProgramDutyRuleLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the program duty rule local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ProgramDutyRuleLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public ProgramDutyRule addProgramDutyRules(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DutyRule> getDutyRulesListByProgramAndCohort(
