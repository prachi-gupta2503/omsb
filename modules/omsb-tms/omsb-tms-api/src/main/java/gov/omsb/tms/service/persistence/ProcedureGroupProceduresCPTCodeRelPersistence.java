...
/**
 * The persistence interface for the procedure group procedures cpt code rel service.
 *
 * <p>
 ...
 * @see ProcedureGroupProceduresCPTCodeRelUtil
 * @generated
 */
@ProviderType
public interface ProcedureGroupProceduresCPTCodeRelPersistence
	extends BasePersistence<ProcedureGroupProceduresCPTCodeRel> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ProcedureGroupProceduresCPTCodeRelUtil} to access the procedure group procedures cpt code rel persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public java.util.List<ProcedureGroupProceduresCPTCodeRel> findByUuid(
		String uuid);
	...
	public java.util.List<ProcedureGroupProceduresCPTCodeRel> findByUuid(
		...
		com.liferay.portal.kernel.util.OrderByComparator
			<ProcedureGroupProceduresCPTCodeRel> orderByComparator);
	 ...
	 * @return the matching procedure group procedures cpt code rels
	 */
	public java.util.List<ProcedureGroupProceduresCPTCodeRel> findByUuid_C(
	 ...
	 * @return the matching procedure group procedures cpt code rels
	 */
	public java.util.List<ProcedureGroupProceduresCPTCodeRel>
	 ...
	 */
	public void cacheResult(
		java.util.List<ProcedureGroupProceduresCPTCodeRel>
	 ...
	 */
	public java.util.List<ProcedureGroupProceduresCPTCodeRel> findAll();
