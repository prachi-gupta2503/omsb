...
/**
 * Provides the local service interface for EcMemberRequestStatus. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EcMemberRequestStatusLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface EcMemberRequestStatusLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>gov.omsb.tms.service.impl.EcMemberRequestStatusLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the ec member request status local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link EcMemberRequestStatusLocalServiceUtil} if injection and service tracking are not available.
	 */
