...
/**
 * Provides the local service interface for DutyTypes. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DutyTypesLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DutyTypesLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>gov.omsb.tms.service.impl.DutyTypesLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the duty types local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DutyTypesLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public DutyTypes addDutyTypes(String dutyType, long groupId, long userId)
	...
	public DutyTypes editDutyTypes(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DutyTypeDTO> getAcgmeCallRule8Hour(
		long dutyTypeId, long traineeId, long blockId);
