...
/**
 * Provides the local service utility for RotationObjectivesRel. This utility wraps
 * <code>gov.omsb.tms.service.impl.RotationObjectivesRelLocalServiceImpl</code> and
 ...
 * @generated
 */
public class RotationObjectivesRelLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>gov.omsb.tms.service.impl.RotationObjectivesRelLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static RotationObjectivesRel addRotationObjectivesRel(
		RotationObjectivesRel rotationObjectivesRel) {

		return getService().addRotationObjectivesRel(rotationObjectivesRel);
	}
	 ...
	 */
	public static RotationObjectivesRel createRotationObjectivesRel(
		long rotationObjectivesRelId) {

		return getService().createRotationObjectivesRel(
	 ...
	 */
	public static RotationObjectivesRel deleteRotationObjectivesRel(
			long rotationObjectivesRelId)
		throws PortalException {

		return getService().deleteRotationObjectivesRel(
			rotationObjectivesRelId);
	}
	...
	public static RotationObjectivesRel deleteRotationObjectivesRel(
		...
		return getService().deleteRotationObjectivesRel(rotationObjectivesRel);
	}
	...
	public static RotationObjectivesRel fetchRotationObjectivesRel(
		long rotationObjectivesRelId) {

		return getService().fetchRotationObjectivesRel(rotationObjectivesRelId);
	}
	...
	public static RotationObjectivesRel
		...
		return getService().fetchRotationObjectivesRelByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 * @throws PortalException if a rotation objectives rel with the primary key could not be found
	 */
	public static RotationObjectivesRel getRotationObjectivesRel(
			long rotationObjectivesRelId)
		throws PortalException {

		return getService().getRotationObjectivesRel(rotationObjectivesRelId);
	}
	...
	public static RotationObjectivesRel
		...
		return getService().getRotationObjectivesRelByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 */
	public static List<RotationObjectivesRel> getRotationObjectivesRels(
		int start, int end) {

		return getService().getRotationObjectivesRels(start, end);
	}
	...
	public static List<RotationObjectivesRel>
		...
		return getService().getRotationObjectivesRelsByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static int getRotationObjectivesRelsCount() {
		return getService().getRotationObjectivesRelsCount();
	}
	 ...
	 */
	public static RotationObjectivesRel updateRotationObjectivesRel(
		RotationObjectivesRel rotationObjectivesRel) {

		return getService().updateRotationObjectivesRel(rotationObjectivesRel);
	}

	public static RotationObjectivesRelLocalService getService() {
		return _service;
	}

	private static volatile RotationObjectivesRelLocalService _service;
