...
/**
 * Provides the local service utility for ProgramDutyAssignment. This utility wraps
 * <code>gov.omsb.tms.service.impl.ProgramDutyAssignmentLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ProgramDutyAssignmentLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>gov.omsb.tms.service.impl.ProgramDutyAssignmentLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static ProgramDutyAssignment addProgramDutyAssignment(
			long programId, long dutyAssignmentId, long cohortId,
			com.liferay.portal.kernel.service.ServiceContext serviceContext)
		throws PortalException {

		return getService().addProgramDutyAssignment(
	...
	public static ProgramDutyAssignment addProgramDutyAssignment(
		...
		return getService().addProgramDutyAssignment(programDutyAssignment);
	}
	 ...
	 */
	public static ProgramDutyAssignment createProgramDutyAssignment(
		long programDutyAssignmentId) {

		return getService().createProgramDutyAssignment(
	...
	public static ProgramDutyAssignment deleteProgramDutyAssignment(
		...
		return getService().deleteProgramDutyAssignment(programDutyAssignment);
	}
	...
	public static ProgramDutyAssignment editProgramDutyAssignment(
			long programDutyAssignmentId, String status)
		throws PortalException {

		return getService().editProgramDutyAssignment(
			programDutyAssignmentId, status);
	}

	public static ProgramDutyAssignment fetchProgramDutyAssignment(
		long programDutyAssignmentId) {

		return getService().fetchProgramDutyAssignment(programDutyAssignmentId);
	}
	...
	public static ProgramDutyAssignment
		...
		return getService().fetchProgramDutyAssignmentByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 * @throws PortalException if a program duty assignment with the primary key could not be found
	 */
	public static ProgramDutyAssignment getProgramDutyAssignment(
			long programDutyAssignmentId)
		throws PortalException {

		return getService().getProgramDutyAssignment(programDutyAssignmentId);
	}
	...
	public static ProgramDutyAssignment
		...
		return getService().getProgramDutyAssignmentByUuidAndGroupId(
			uuid, groupId);
	}

	public static List<ProgramDutyAssignment> getProgramDutyAssignmentList() {
		return getService().getProgramDutyAssignmentList();
	}
	 ...
	 */
	public static List<ProgramDutyAssignment> getProgramDutyAssignments(
		int start, int end) {

		return getService().getProgramDutyAssignments(start, end);
	}
	 ...
	 */
	public static List<ProgramDutyAssignment>
		getProgramDutyAssignmentsByUuidAndCompanyId(
			String uuid, long companyId) {

		return getService().getProgramDutyAssignmentsByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static int getProgramDutyAssignmentsCount() {
		return getService().getProgramDutyAssignmentsCount();
	}

	public static boolean isUserAvailable(
		com.liferay.portal.kernel.model.User user,
		List<gov.omsb.tms.custom.dto.UserDTO> userList) {

		return getService().isUserAvailable(user, userList);
	}
	 ...
	 */
	public static ProgramDutyAssignment updateProgramDutyAssignment(
		ProgramDutyAssignment programDutyAssignment) {

		return getService().updateProgramDutyAssignment(programDutyAssignment);
	}

	public static ProgramDutyAssignmentLocalService getService() {
		return _service;
	}

	private static volatile ProgramDutyAssignmentLocalService _service;
