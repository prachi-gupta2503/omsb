...
/**
 * Provides the local service utility for FacultyRequestStatus. This utility wraps
 * <code>gov.omsb.tms.service.impl.FacultyRequestStatusLocalServiceImpl</code> and
 ...
 * @generated
 */
public class FacultyRequestStatusLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>gov.omsb.tms.service.impl.FacultyRequestStatusLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static FacultyRequestStatus addFacultyRequestStatus(
		FacultyRequestStatus facultyRequestStatus) {

		return getService().addFacultyRequestStatus(facultyRequestStatus);
	}
	 ...
	 */
	public static FacultyRequestStatus createFacultyRequestStatus(
		long facultyRequestStatusId) {

		return getService().createFacultyRequestStatus(facultyRequestStatusId);
	}
	 ...
	 */
	public static FacultyRequestStatus deleteFacultyRequestStatus(
		FacultyRequestStatus facultyRequestStatus) {

		return getService().deleteFacultyRequestStatus(facultyRequestStatus);
	}
	...
	public static FacultyRequestStatus deleteFacultyRequestStatus(
		...
		return getService().deleteFacultyRequestStatus(facultyRequestStatusId);
	}
	...
	public static FacultyRequestStatus fetchFacultyRequestStatus(
		long facultyRequestStatusId) {

		return getService().fetchFacultyRequestStatus(facultyRequestStatusId);
	}
	 ...
	 */
	public static FacultyRequestStatus
		fetchFacultyRequestStatusByUuidAndGroupId(String uuid, long groupId) {

		return getService().fetchFacultyRequestStatusByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 * @throws PortalException if a faculty request status with the primary key could not be found
	 */
	public static FacultyRequestStatus getFacultyRequestStatus(
			long facultyRequestStatusId)
		throws PortalException {

		return getService().getFacultyRequestStatus(facultyRequestStatusId);
	}
	 ...
	 */
	public static FacultyRequestStatus getFacultyRequestStatusByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return getService().getFacultyRequestStatusByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 */
	public static List<FacultyRequestStatus> getFacultyRequestStatuses(
		int start, int end) {

		return getService().getFacultyRequestStatuses(start, end);
	}
	 ...
	 */
	public static List<FacultyRequestStatus>
		getFacultyRequestStatusesByUuidAndCompanyId(
			String uuid, long companyId) {

		return getService().getFacultyRequestStatusesByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static int getFacultyRequestStatusesCount() {
		return getService().getFacultyRequestStatusesCount();
	}
	 ...
	 */
	public static FacultyRequestStatus updateFacultyRequestStatus(
		FacultyRequestStatus facultyRequestStatus) {

		return getService().updateFacultyRequestStatus(facultyRequestStatus);
	}

	public static FacultyRequestStatusLocalService getService() {
		return _service;
	}

	private static volatile FacultyRequestStatusLocalService _service;
