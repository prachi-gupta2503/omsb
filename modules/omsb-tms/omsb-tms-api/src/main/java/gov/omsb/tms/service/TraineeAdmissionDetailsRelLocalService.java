...
/**
 * Provides the local service interface for TraineeAdmissionDetailsRel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TraineeAdmissionDetailsRelLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TraineeAdmissionDetailsRelLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>gov.omsb.tms.service.impl.TraineeAdmissionDetailsRelLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the trainee admission details rel local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TraineeAdmissionDetailsRelLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Long> getTraineeByProgramCohortAndTraineeLevel(
