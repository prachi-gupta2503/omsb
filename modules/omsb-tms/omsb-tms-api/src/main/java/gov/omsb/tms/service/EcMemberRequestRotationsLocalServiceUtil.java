...
/**
 * Provides the local service utility for EcMemberRequestRotations. This utility wraps
 * <code>gov.omsb.tms.service.impl.EcMemberRequestRotationsLocalServiceImpl</code> and
 ...
 * @generated
 */
public class EcMemberRequestRotationsLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>gov.omsb.tms.service.impl.EcMemberRequestRotationsLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static EcMemberRequestRotations addEcMemberRequestRotations(
		EcMemberRequestRotations ecMemberRequestRotations) {

		return getService().addEcMemberRequestRotations(
	 ...
	 */
	public static EcMemberRequestRotations createEcMemberRequestRotations(
		long ecMemberRequestRotationsId) {

		return getService().createEcMemberRequestRotations(
	 ...
	 */
	public static EcMemberRequestRotations deleteEcMemberRequestRotations(
		EcMemberRequestRotations ecMemberRequestRotations) {

		return getService().deleteEcMemberRequestRotations(
			ecMemberRequestRotations);
	}
	...
	public static EcMemberRequestRotations fetchEcMemberRequestRotations(
		long ecMemberRequestRotationsId) {

		return getService().fetchEcMemberRequestRotations(
			ecMemberRequestRotationsId);
	}
	...
	public static EcMemberRequestRotations
		...
		return getService().fetchEcMemberRequestRotationsByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 * @throws PortalException if a ec member request rotations with the primary key could not be found
	 */
	public static EcMemberRequestRotations getEcMemberRequestRotations(
			long ecMemberRequestRotationsId)
		throws PortalException {

		return getService().getEcMemberRequestRotations(
			ecMemberRequestRotationsId);
	}
	...
	public static EcMemberRequestRotations
		...
		return getService().getEcMemberRequestRotationsByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 */
	public static List<EcMemberRequestRotations> getEcMemberRequestRotationses(
		int start, int end) {

		return getService().getEcMemberRequestRotationses(start, end);
	}
	 ...
	 */
	public static List<EcMemberRequestRotations>
		getEcMemberRequestRotationsesByUuidAndCompanyId(
			String uuid, long companyId) {

		return getService().getEcMemberRequestRotationsesByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static int getEcMemberRequestRotationsesCount() {
		return getService().getEcMemberRequestRotationsesCount();
	}
	 ...
	 */
	public static EcMemberRequestRotations updateEcMemberRequestRotations(
		EcMemberRequestRotations ecMemberRequestRotations) {

		return getService().updateEcMemberRequestRotations(
			ecMemberRequestRotations);
	}

	public static EcMemberRequestRotationsLocalService getService() {
		return _service;
	}

	private static volatile EcMemberRequestRotationsLocalService _service;
