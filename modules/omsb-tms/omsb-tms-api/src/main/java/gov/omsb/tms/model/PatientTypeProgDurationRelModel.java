...
/**
 * The base model interface for the PatientTypeProgDurationRel service. Represents a row in the &quot;patient_type_prog_duration_rel&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>gov.omsb.tms.model.impl.PatientTypeProgDurationRelModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>gov.omsb.tms.model.impl.PatientTypeProgDurationRelImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface PatientTypeProgDurationRelModel
	extends BaseModel<PatientTypeProgDurationRel>, ShardedModel, StagedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a patient type prog duration rel model instance should use the {@link PatientTypeProgDurationRel} interface instead.
	 */
