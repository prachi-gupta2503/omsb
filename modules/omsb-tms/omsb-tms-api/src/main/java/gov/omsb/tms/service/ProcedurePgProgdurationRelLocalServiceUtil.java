...
/**
 * Provides the local service utility for ProcedurePgProgdurationRel. This utility wraps
 * <code>gov.omsb.tms.service.impl.ProcedurePgProgdurationRelLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ProcedurePgProgdurationRelLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>gov.omsb.tms.service.impl.ProcedurePgProgdurationRelLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static ProcedurePgProgdurationRel addProcedurePgProgdurationRel(
		ProcedurePgProgdurationRel procedurePgProgdurationRel) {

		return getService().addProcedurePgProgdurationRel(
	 ...
	 */
	public static ProcedurePgProgdurationRel createProcedurePgProgdurationRel(
		long procedurePgPdRelId) {

		return getService().createProcedurePgProgdurationRel(
			procedurePgPdRelId);
	}
	 ...
	 */
	public static ProcedurePgProgdurationRel deleteProcedurePgProgdurationRel(
			long procedurePgPdRelId)
		throws PortalException {

		return getService().deleteProcedurePgProgdurationRel(
			procedurePgPdRelId);
	}
	...
	public static ProcedurePgProgdurationRel fetchProcedurePgProgdurationRel(
		long procedurePgPdRelId) {

		return getService().fetchProcedurePgProgdurationRel(procedurePgPdRelId);
	}
	...
	public static ProcedurePgProgdurationRel
		...
		return getService().fetchProcedurePgProgdurationRelByUuidAndGroupId(
			uuid, groupId);
	}
	...
	public static List<ProcedurePgProgdurationRel> findByProcedureMasterId(
		...
		return getService().findByProcedureMasterId(procedureMasterId);
	}
	 ...
	 * @throws PortalException if a procedure pg progduration rel with the primary key could not be found
	 */
	public static ProcedurePgProgdurationRel getProcedurePgProgdurationRel(
			long procedurePgPdRelId)
		throws PortalException {

		return getService().getProcedurePgProgdurationRel(procedurePgPdRelId);
	}
	...
	public static ProcedurePgProgdurationRel
		...
		return getService().getProcedurePgProgdurationRelByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 */
	public static List<ProcedurePgProgdurationRel>
		getProcedurePgProgdurationRels(int start, int end) {

		return getService().getProcedurePgProgdurationRels(start, end);
	}
	...
	public static List<ProcedurePgProgdurationRel>
		...
		return getService().getProcedurePgProgdurationRelsByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static int getProcedurePgProgdurationRelsCount() {
		return getService().getProcedurePgProgdurationRelsCount();
	}
	 ...
	 */
	public static ProcedurePgProgdurationRel updateProcedurePgProgdurationRel(
		ProcedurePgProgdurationRel procedurePgProgdurationRel) {

		return getService().updateProcedurePgProgdurationRel(
			procedurePgProgdurationRel);
	}

	public static ProcedurePgProgdurationRelLocalService getService() {
		return _service;
	}

	private static volatile ProcedurePgProgdurationRelLocalService _service;
