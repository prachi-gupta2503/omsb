...
/**
 * Provides the local service interface for ProgdurationRotationTlPgProcedurePtRel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ProgdurationRotationTlPgProcedurePtRelLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ProgdurationRotationTlPgProcedurePtRelLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>gov.omsb.tms.service.impl.ProgdurationRotationTlPgProcedurePtRelLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the progduration rotation tl pg procedure pt rel local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ProgdurationRotationTlPgProcedurePtRelLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SetupProcedureDTO> getSetUpProcedureDetails(
		String languageCode);
