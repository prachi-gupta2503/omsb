...
/**
 * The persistence interface for the patient type prog duration rel service.
 *
 * <p>
 ...
 * @see PatientTypeProgDurationRelUtil
 * @generated
 */
@ProviderType
public interface PatientTypeProgDurationRelPersistence
	extends BasePersistence<PatientTypeProgDurationRel> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PatientTypeProgDurationRelUtil} to access the patient type prog duration rel persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public java.util.List<PatientTypeProgDurationRel> findByUuid(String uuid);
	 ...
	 */
	public java.util.List<PatientTypeProgDurationRel> findByUuid(
	...
	public java.util.List<PatientTypeProgDurationRel> findByUuid(
		...
		com.liferay.portal.kernel.util.OrderByComparator
			<PatientTypeProgDurationRel> orderByComparator);
	 ...
	 * @return the matching patient type prog duration rels
	 */
	public java.util.List<PatientTypeProgDurationRel> findByUuid_C(
	 ...
	 * @return the matching patient type prog duration rels
	 */
	public java.util.List<PatientTypeProgDurationRel> findByProgramDurationId(
	 ...
	 */
	public void cacheResult(
		java.util.List<PatientTypeProgDurationRel> patientTypeProgDurationRels);
	 ...
	 */
	public PatientTypeProgDurationRel create(long PatientTypeProgDurationRelId);
	 ...
	 */
	public java.util.List<PatientTypeProgDurationRel> findAll();
