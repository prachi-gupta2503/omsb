...
/**
 * Provides the local service utility for ProgramEligibilityDegreeRel. This utility wraps
 * <code>gov.omsb.tms.service.impl.ProgramEligibilityDegreeRelLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ProgramEligibilityDegreeRelLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>gov.omsb.tms.service.impl.ProgramEligibilityDegreeRelLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static ProgramEligibilityDegreeRel addProgramEligibilityDegreeRel(
		ProgramEligibilityDegreeRel programEligibilityDegreeRel) {

		return getService().addProgramEligibilityDegreeRel(
	 ...
	 */
	public static ProgramEligibilityDegreeRel createProgramEligibilityDegreeRel(
		long programEdId) {

		return getService().createProgramEligibilityDegreeRel(programEdId);
	}
	 ...
	 */
	public static ProgramEligibilityDegreeRel deleteProgramEligibilityDegreeRel(
			long programEdId)
		throws PortalException {

		return getService().deleteProgramEligibilityDegreeRel(programEdId);
	}
	...
	public static ProgramEligibilityDegreeRel deleteProgramEligibilityDegreeRel(
		...
		return getService().deleteProgramEligibilityDegreeRel(
			programEligibilityDegreeRel);
	}
	...
	public static ProgramEligibilityDegreeRel fetchProgramEligibilityDegreeRel(
		long programEdId) {

		return getService().fetchProgramEligibilityDegreeRel(programEdId);
	}
	...
	public static ProgramEligibilityDegreeRel
		...
		return getService().fetchProgramEligibilityDegreeRelByUuidAndGroupId(
			uuid, groupId);
	}
	...
	public static ProgramEligibilityDegreeRel
		...
		return getService().findByProgramAndEligibilityDegreeId(
			programMasterId, eligibilityDegreeMasterId);
	}

	public static ProgramEligibilityDegreeRel findEligibilityRelByProgramId(
		long programMasterId) {

		return getService().findEligibilityRelByProgramId(programMasterId);
	}
	 ...
	 * @throws PortalException if a program eligibility degree rel with the primary key could not be found
	 */
	public static ProgramEligibilityDegreeRel getProgramEligibilityDegreeRel(
			long programEdId)
		throws PortalException {

		return getService().getProgramEligibilityDegreeRel(programEdId);
	}
	...
	public static ProgramEligibilityDegreeRel
		...
		return getService().getProgramEligibilityDegreeRelByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 */
	public static List<ProgramEligibilityDegreeRel>
		getProgramEligibilityDegreeRels(int start, int end) {

		return getService().getProgramEligibilityDegreeRels(start, end);
	}
	...
	public static List<ProgramEligibilityDegreeRel>
		...
		return getService().getProgramEligibilityDegreeRelsByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static int getProgramEligibilityDegreeRelsCount() {
		return getService().getProgramEligibilityDegreeRelsCount();
	}
	 ...
	 */
	public static ProgramEligibilityDegreeRel updateProgramEligibilityDegreeRel(
		ProgramEligibilityDegreeRel programEligibilityDegreeRel) {

		return getService().updateProgramEligibilityDegreeRel(
			programEligibilityDegreeRel);
	}

	public static ProgramEligibilityDegreeRelLocalService getService() {
		return _service;
	}

	private static volatile ProgramEligibilityDegreeRelLocalService _service;
