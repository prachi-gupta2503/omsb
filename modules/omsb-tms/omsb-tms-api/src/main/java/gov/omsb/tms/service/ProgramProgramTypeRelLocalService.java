...
/**
 * Provides the local service interface for ProgramProgramTypeRel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ProgramProgramTypeRelLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ProgramProgramTypeRelLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>gov.omsb.tms.service.impl.ProgramProgramTypeRelLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the program program type rel local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ProgramProgramTypeRelLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public ProgramProgramTypeRel findByProgramAndProgramTypeId(
		long programMasterId, long programTypeMasterId);

	public ProgramProgramTypeRel findByProgramId(long programMasterId);

	public List<ProgramProgramTypeRel> findProgramMasterByPerogramTypeId(
		long programTypeId);
