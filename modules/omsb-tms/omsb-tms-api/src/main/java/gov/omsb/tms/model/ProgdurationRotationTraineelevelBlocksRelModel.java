...
/**
 * The base model interface for the ProgdurationRotationTraineelevelBlocksRel service. Represents a row in the &quot;progduration_rotation_traineelevel_blocks_rel&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>gov.omsb.tms.model.impl.ProgdurationRotationTraineelevelBlocksRelModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>gov.omsb.tms.model.impl.ProgdurationRotationTraineelevelBlocksRelImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface ProgdurationRotationTraineelevelBlocksRelModel
	extends BaseModel<ProgdurationRotationTraineelevelBlocksRel>, ShardedModel,
			StagedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a progduration rotation traineelevel blocks rel model instance should use the {@link ProgdurationRotationTraineelevelBlocksRel} interface instead.
	 */
