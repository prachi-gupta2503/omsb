...
/**
 * Provides the remote service interface for ProgramDutyAssignment. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Brian Wing Shun Chan
 * @see ProgramDutyAssignmentServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface ProgramDutyAssignmentService extends BaseService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>gov.omsb.tms.service.impl.ProgramDutyAssignmentServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the program duty assignment remote service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ProgramDutyAssignmentServiceUtil} if injection and service tracking are not available.
	 */
