...
/**
 * The base model interface for the TraineeElectiverotationPriorityDetails service. Represents a row in the &quot;trainee_electiverotation_priority_details&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>gov.omsb.tms.model.impl.TraineeElectiverotationPriorityDetailsModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>gov.omsb.tms.model.impl.TraineeElectiverotationPriorityDetailsImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface TraineeElectiverotationPriorityDetailsModel
	extends BaseModel<TraineeElectiverotationPriorityDetails>, ShardedModel,
			StagedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a trainee electiverotation priority details model instance should use the {@link TraineeElectiverotationPriorityDetails} interface instead.
	 */
