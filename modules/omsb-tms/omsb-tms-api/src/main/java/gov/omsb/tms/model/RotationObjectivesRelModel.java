...
/**
 * The base model interface for the RotationObjectivesRel service. Represents a row in the &quot;rotation_objectives_rel&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>gov.omsb.tms.model.impl.RotationObjectivesRelModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>gov.omsb.tms.model.impl.RotationObjectivesRelImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface RotationObjectivesRelModel
	extends BaseModel<RotationObjectivesRel>, LocalizedModel, ShardedModel,
			StagedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a rotation objectives rel model instance should use the {@link RotationObjectivesRel} interface instead.
	 */
