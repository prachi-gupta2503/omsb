...
/**
 * Provides the local service interface for LeaveMaster. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see LeaveMasterLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface LeaveMasterLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>gov.omsb.tms.service.impl.LeaveMasterLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the leave master local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link LeaveMasterLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public LeaveMaster addLeaveMaster(
		ServiceContext serviceContext, long traineeId, Date dateOfApplication,
		long leaveTypeId, Date fromDate, Date toDate, int numberOfDays,
	...
	public List<LeaveMaster> findLeaveDetailsByTraineeIds(
		List<Long> traineeIds, Date startDate, Date endDate);

	public List<LeaveMaster> findLeaveDetailsByTraineeIdsWithStatus(
		List<Long> traineeIds, Date startDate, Date endDate, int status);
	...
	public LeaveMaster updateStatus(
