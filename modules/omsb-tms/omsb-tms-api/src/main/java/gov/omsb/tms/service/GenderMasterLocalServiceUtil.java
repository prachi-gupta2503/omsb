...
/**
 * Provides the local service utility for GenderMaster. This utility wraps
 * <code>gov.omsb.tms.service.impl.GenderMasterLocalServiceImpl</code> and
 ...
 * @generated
 */
public class GenderMasterLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>gov.omsb.tms.service.impl.GenderMasterLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static GenderMaster addGenderMaster(GenderMaster genderMaster) {
		return getService().addGenderMaster(genderMaster);
	}
	 ...
	 */
	public static GenderMaster createGenderMaster(long genderMasterId) {
		return getService().createGenderMaster(genderMasterId);
	}
	 ...
	 */
	public static GenderMaster deleteGenderMaster(GenderMaster genderMaster) {
		return getService().deleteGenderMaster(genderMaster);
	}
	 ...
	 */
	public static GenderMaster deleteGenderMaster(long genderMasterId)
		throws PortalException {

		return getService().deleteGenderMaster(genderMasterId);
	}
	...
	public static GenderMaster fetchGenderMaster(long genderMasterId) {
		return getService().fetchGenderMaster(genderMasterId);
	}
	 ...
	 */
	public static GenderMaster fetchGenderMasterByUuidAndGroupId(
		String uuid, long groupId) {

		return getService().fetchGenderMasterByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 * @throws PortalException if a gender master with the primary key could not be found
	 */
	public static GenderMaster getGenderMaster(long genderMasterId)
		throws PortalException {

		return getService().getGenderMaster(genderMasterId);
	}
	 ...
	 */
	public static GenderMaster getGenderMasterByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return getService().getGenderMasterByUuidAndGroupId(uuid, groupId);
	}
	 ...
	 */
	public static List<GenderMaster> getGenderMasters(int start, int end) {
		return getService().getGenderMasters(start, end);
	}
	 ...
	 */
	public static List<GenderMaster> getGenderMastersByUuidAndCompanyId(
		String uuid, long companyId) {

		return getService().getGenderMastersByUuidAndCompanyId(uuid, companyId);
	}
	...
	public static List<GenderMaster> getGenderMastersByUuidAndCompanyId(
		...
		return getService().getGenderMastersByUuidAndCompanyId(
	 ...
	 */
	public static int getGenderMastersCount() {
		return getService().getGenderMastersCount();
	}
	 ...
	 */
	public static GenderMaster updateGenderMaster(GenderMaster genderMaster) {
		return getService().updateGenderMaster(genderMaster);
	}

	public static GenderMasterLocalService getService() {
		return _service;
	}

	private static volatile GenderMasterLocalService _service;
