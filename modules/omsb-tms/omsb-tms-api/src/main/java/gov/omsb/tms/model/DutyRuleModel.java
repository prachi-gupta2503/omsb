...
/**
 * The base model interface for the DutyRule service. Represents a row in the &quot;duty_rule_master&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>gov.omsb.tms.model.impl.DutyRuleModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>gov.omsb.tms.model.impl.DutyRuleImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface DutyRuleModel
	extends BaseModel<DutyRule>, ShardedModel, StagedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a duty rule model instance should use the {@link DutyRule} interface instead.
	 */
