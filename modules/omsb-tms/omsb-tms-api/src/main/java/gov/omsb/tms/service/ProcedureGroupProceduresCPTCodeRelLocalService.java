...
/**
 * Provides the local service interface for ProcedureGroupProceduresCPTCodeRel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ProcedureGroupProceduresCPTCodeRelLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface ProcedureGroupProceduresCPTCodeRelLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>gov.omsb.tms.service.impl.ProcedureGroupProceduresCPTCodeRelLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the procedure group procedures cpt code rel local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ProcedureGroupProceduresCPTCodeRelLocalServiceUtil} if injection and service tracking are not available.
	 */
