...
/**
 * Provides the local service utility for TraineeLoggedProcedureDetails. This utility wraps
 * <code>gov.omsb.tms.service.impl.TraineeLoggedProcedureDetailsLocalServiceImpl</code> and
 ...
 * @generated
 */
public class TraineeLoggedProcedureDetailsLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>gov.omsb.tms.service.impl.TraineeLoggedProcedureDetailsLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static TraineeLoggedProcedureDetails
		...
		return getService().addTraineeLoggedProcedureDetails(
	...
	public static TraineeLoggedProcedureDetails
		...
		return getService().createTraineeLoggedProcedureDetails(
	...
	public static TraineeLoggedProcedureDetails
		...
		return getService().deleteTraineeLoggedProcedureDetails(
			traineeLoggedProcedureDetailsId);
	}
	...
	public static TraineeLoggedProcedureDetails
		...
		return getService().fetchTraineeLoggedProcedureDetails(
			traineeLoggedProcedureDetailsId);
	}
	...
	public static TraineeLoggedProcedureDetails
		...
		return getService().fetchTraineeLoggedProcedureDetailsByUuidAndGroupId(
			uuid, groupId);
	}
	...
	public static List<TraineeLoggedProcedureDetails> findByPatientIdByLike(
		...
		return getService().findByPatientIdByLike(patientId);
	}
	...
	public static List<TraineeLoggedProcedureDetails>
		findTraineeLoggedProcedureDetailsByPatientId(String patientId) {

		return getService().findTraineeLoggedProcedureDetailsByPatientId(
			patientId);
	}
	...
	public static long getRotationIdByDatePerformed(
		String datePerformed, long traineeId) {

		return getService().getRotationIdByDatePerformed(
			datePerformed, traineeId);
	}

	public static gov.omsb.tms.custom.dto.TraineeLoggedProcedureDetailsDTO
		getTraineeLoggedProcedureDetail(
			long supervisorId, long traineeLoggedProcedureDetailsId,
			String languageCode) {

		return getService().getTraineeLoggedProcedureDetail(
	...
	public static TraineeLoggedProcedureDetails
		...
		return getService().getTraineeLoggedProcedureDetails(
			traineeLoggedProcedureDetailsId);
	}
	...
	public static TraineeLoggedProcedureDetails
		...
		return getService().getTraineeLoggedProcedureDetailsByUuidAndGroupId(
			uuid, groupId);
	}
	...
	public static List<TraineeLoggedProcedureDetails>
		...
		return getService().getTraineeLoggedProcedureDetailses(start, end);
	}
	 ...
	 */
	public static int getTraineeLoggedProcedureDetailsesCount() {
		return getService().getTraineeLoggedProcedureDetailsesCount();
	}

	public static List<gov.omsb.tms.custom.dto.TraineeLoggedProcedureDetailsDTO>
		...
		return getService().getTraineeLoggedProcedureDetailsList(
	...
	public static TraineeLoggedProcedureDetails
		...
		return getService().updateTraineeLoggedProcedureDetails(
			traineeLoggedProcedureDetails);
	}

	public static TraineeLoggedProcedureDetailsLocalService getService() {
		return _service;
	}

	private static volatile TraineeLoggedProcedureDetailsLocalService _service;
