...
/**
 * The persistence utility for the leave annual master service. This utility wraps <code>gov.omsb.tms.service.persistence.impl.LeaveAnnualMasterPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see LeaveAnnualMasterPersistence
 * @generated
 */
public class LeaveAnnualMasterUtil {
	 ...
	 */
	public static void clearCache(LeaveAnnualMaster leaveAnnualMaster) {
		getPersistence().clearCache(leaveAnnualMaster);
	}
	 ...
	 */
	public static Map<Serializable, LeaveAnnualMaster> fetchByPrimaryKeys(
	 ...
	 */
	public static List<LeaveAnnualMaster> findWithDynamicQuery(
	 ...
	 */
	public static LeaveAnnualMaster update(
		LeaveAnnualMaster leaveAnnualMaster) {

		return getPersistence().update(leaveAnnualMaster);
	}
	 ...
	 */
	public static LeaveAnnualMaster update(
		LeaveAnnualMaster leaveAnnualMaster, ServiceContext serviceContext) {

		return getPersistence().update(leaveAnnualMaster, serviceContext);
	}
	 ...
	 */
	public static List<LeaveAnnualMaster> findByUuid(String uuid) {
	 ...
	 */
	public static List<LeaveAnnualMaster> findByUuid(
	 ...
	 */
	public static LeaveAnnualMaster findByUuid_First(
			String uuid, OrderByComparator<LeaveAnnualMaster> orderByComparator)
		throws gov.omsb.tms.exception.NoSuchLeaveAnnualMasterException {
	 ...
	 */
	public static LeaveAnnualMaster fetchByUuid_First(
		String uuid, OrderByComparator<LeaveAnnualMaster> orderByComparator) {
	 ...
	 * @throws NoSuchLeaveAnnualMasterException if a matching leave annual master could not be found
	 */
	public static LeaveAnnualMaster findByUuid_Last(
			String uuid, OrderByComparator<LeaveAnnualMaster> orderByComparator)
		throws gov.omsb.tms.exception.NoSuchLeaveAnnualMasterException {
	 ...
	 */
	public static LeaveAnnualMaster fetchByUuid_Last(
		String uuid, OrderByComparator<LeaveAnnualMaster> orderByComparator) {
	 ...
	 */
	public static LeaveAnnualMaster[] findByUuid_PrevAndNext(
			long leaveAnnualMasterId, String uuid,
			OrderByComparator<LeaveAnnualMaster> orderByComparator)
		throws gov.omsb.tms.exception.NoSuchLeaveAnnualMasterException {

		return getPersistence().findByUuid_PrevAndNext(
			leaveAnnualMasterId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchLeaveAnnualMasterException if a matching leave annual master could not be found
	 */
	public static LeaveAnnualMaster findByUUID_G(String uuid, long groupId)
		throws gov.omsb.tms.exception.NoSuchLeaveAnnualMasterException {
	 ...
	 */
	public static LeaveAnnualMaster fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching leave annual master, or <code>null</code> if a matching leave annual master could not be found
	 */
	public static LeaveAnnualMaster fetchByUUID_G(
	 ...
	 */
	public static LeaveAnnualMaster removeByUUID_G(String uuid, long groupId)
		throws gov.omsb.tms.exception.NoSuchLeaveAnnualMasterException {
	 ...
	 * @return the matching leave annual masters
	 */
	public static List<LeaveAnnualMaster> findByUuid_C(
	 ...
	 * @throws NoSuchLeaveAnnualMasterException if a matching leave annual master could not be found
	 */
	public static LeaveAnnualMaster findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<LeaveAnnualMaster> orderByComparator)
		throws gov.omsb.tms.exception.NoSuchLeaveAnnualMasterException {
	 ...
	 * @return the first matching leave annual master, or <code>null</code> if a matching leave annual master could not be found
	 */
	public static LeaveAnnualMaster fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<LeaveAnnualMaster> orderByComparator) {
	 ...
	 * @throws NoSuchLeaveAnnualMasterException if a matching leave annual master could not be found
	 */
	public static LeaveAnnualMaster findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<LeaveAnnualMaster> orderByComparator)
		throws gov.omsb.tms.exception.NoSuchLeaveAnnualMasterException {
	 ...
	 * @return the last matching leave annual master, or <code>null</code> if a matching leave annual master could not be found
	 */
	public static LeaveAnnualMaster fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<LeaveAnnualMaster> orderByComparator) {
	 ...
	 * @throws NoSuchLeaveAnnualMasterException if a leave annual master with the primary key could not be found
	 */
	public static LeaveAnnualMaster[] findByUuid_C_PrevAndNext(
			long leaveAnnualMasterId, String uuid, long companyId,
			OrderByComparator<LeaveAnnualMaster> orderByComparator)
		throws gov.omsb.tms.exception.NoSuchLeaveAnnualMasterException {

		return getPersistence().findByUuid_C_PrevAndNext(
			leaveAnnualMasterId, uuid, companyId, orderByComparator);
	}
	 ...
	 */
	public static void cacheResult(LeaveAnnualMaster leaveAnnualMaster) {
		getPersistence().cacheResult(leaveAnnualMaster);
	}
	 ...
	 */
	public static void cacheResult(List<LeaveAnnualMaster> leaveAnnualMasters) {
		getPersistence().cacheResult(leaveAnnualMasters);
	}
	 ...
	 */
	public static LeaveAnnualMaster create(long leaveAnnualMasterId) {
		return getPersistence().create(leaveAnnualMasterId);
	}
	 ...
	 * @throws NoSuchLeaveAnnualMasterException if a leave annual master with the primary key could not be found
	 */
	public static LeaveAnnualMaster remove(long leaveAnnualMasterId)
		throws gov.omsb.tms.exception.NoSuchLeaveAnnualMasterException {

		return getPersistence().remove(leaveAnnualMasterId);
	}

	public static LeaveAnnualMaster updateImpl(
		LeaveAnnualMaster leaveAnnualMaster) {

		return getPersistence().updateImpl(leaveAnnualMaster);
	}
	 ...
	 * @throws NoSuchLeaveAnnualMasterException if a leave annual master with the primary key could not be found
	 */
	public static LeaveAnnualMaster findByPrimaryKey(long leaveAnnualMasterId)
		throws gov.omsb.tms.exception.NoSuchLeaveAnnualMasterException {

		return getPersistence().findByPrimaryKey(leaveAnnualMasterId);
	}
	 ...
	 */
	public static LeaveAnnualMaster fetchByPrimaryKey(
		long leaveAnnualMasterId) {

		return getPersistence().fetchByPrimaryKey(leaveAnnualMasterId);
	}
	 ...
	 */
	public static List<LeaveAnnualMaster> findAll() {
	 ...
	 */
	public static List<LeaveAnnualMaster> findAll(int start, int end) {
	...
	public static LeaveAnnualMasterPersistence getPersistence() {
		return _persistence;
	}

	private static volatile LeaveAnnualMasterPersistence _persistence;
