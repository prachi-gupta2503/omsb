...
/**
 * The persistence interface for the omsb tms finder service.
 *
 * <p>
 ...
 * @see OmsbTmsFinderUtil
 * @generated
 */
@ProviderType
public interface OmsbTmsFinderPersistence
	extends BasePersistence<OmsbTmsFinder> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OmsbTmsFinderUtil} to access the omsb tms finder persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public java.util.List<OmsbTmsFinder> findByUuid(String uuid);
	 ...
	 */
	public java.util.List<OmsbTmsFinder> findByUuid(
	...
	public java.util.List<OmsbTmsFinder> findByUuid(
		String uuid, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<OmsbTmsFinder>
			orderByComparator);
	 ...
	 * @return the matching omsb tms finders
	 */
	public java.util.List<OmsbTmsFinder> findByUuid_C(
	 ...
	 */
	public void cacheResult(java.util.List<OmsbTmsFinder> omsbTmsFinders);
	 ...
	 */
	public java.util.List<OmsbTmsFinder> findAll();
	 ...
	 */
	public java.util.List<OmsbTmsFinder> findAll(int start, int end);
