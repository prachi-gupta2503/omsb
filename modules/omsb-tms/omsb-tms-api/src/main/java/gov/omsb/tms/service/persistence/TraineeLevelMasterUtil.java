...
/**
 * The persistence utility for the trainee level master service. This utility wraps <code>gov.omsb.tms.service.persistence.impl.TraineeLevelMasterPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see TraineeLevelMasterPersistence
 * @generated
 */
public class TraineeLevelMasterUtil {
	 ...
	 */
	public static void clearCache(TraineeLevelMaster traineeLevelMaster) {
		getPersistence().clearCache(traineeLevelMaster);
	}
	 ...
	 */
	public static Map<Serializable, TraineeLevelMaster> fetchByPrimaryKeys(
	 ...
	 */
	public static List<TraineeLevelMaster> findWithDynamicQuery(
	 ...
	 */
	public static TraineeLevelMaster update(
		TraineeLevelMaster traineeLevelMaster) {

		return getPersistence().update(traineeLevelMaster);
	}
	 ...
	 */
	public static TraineeLevelMaster update(
		TraineeLevelMaster traineeLevelMaster, ServiceContext serviceContext) {

		return getPersistence().update(traineeLevelMaster, serviceContext);
	}
	 ...
	 */
	public static List<TraineeLevelMaster> findByUuid(String uuid) {
	 ...
	 */
	public static List<TraineeLevelMaster> findByUuid(
	 ...
	 */
	public static TraineeLevelMaster findByUuid_First(
			String uuid,
			OrderByComparator<TraineeLevelMaster> orderByComparator)
		throws gov.omsb.tms.exception.NoSuchTraineeLevelMasterException {
	 ...
	 */
	public static TraineeLevelMaster fetchByUuid_First(
	 ...
	 * @throws NoSuchTraineeLevelMasterException if a matching trainee level master could not be found
	 */
	public static TraineeLevelMaster findByUuid_Last(
			String uuid,
			OrderByComparator<TraineeLevelMaster> orderByComparator)
		throws gov.omsb.tms.exception.NoSuchTraineeLevelMasterException {
	 ...
	 */
	public static TraineeLevelMaster fetchByUuid_Last(
		String uuid, OrderByComparator<TraineeLevelMaster> orderByComparator) {
	 ...
	 */
	public static TraineeLevelMaster[] findByUuid_PrevAndNext(
			long traineeLevelMasterId, String uuid,
			OrderByComparator<TraineeLevelMaster> orderByComparator)
		throws gov.omsb.tms.exception.NoSuchTraineeLevelMasterException {

		return getPersistence().findByUuid_PrevAndNext(
			traineeLevelMasterId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchTraineeLevelMasterException if a matching trainee level master could not be found
	 */
	public static TraineeLevelMaster findByUUID_G(String uuid, long groupId)
		throws gov.omsb.tms.exception.NoSuchTraineeLevelMasterException {
	 ...
	 */
	public static TraineeLevelMaster fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching trainee level master, or <code>null</code> if a matching trainee level master could not be found
	 */
	public static TraineeLevelMaster fetchByUUID_G(
	 ...
	 */
	public static TraineeLevelMaster removeByUUID_G(String uuid, long groupId)
		throws gov.omsb.tms.exception.NoSuchTraineeLevelMasterException {
	 ...
	 * @return the matching trainee level masters
	 */
	public static List<TraineeLevelMaster> findByUuid_C(
	 ...
	 * @throws NoSuchTraineeLevelMasterException if a matching trainee level master could not be found
	 */
	public static TraineeLevelMaster findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<TraineeLevelMaster> orderByComparator)
		throws gov.omsb.tms.exception.NoSuchTraineeLevelMasterException {
	 ...
	 * @return the first matching trainee level master, or <code>null</code> if a matching trainee level master could not be found
	 */
	public static TraineeLevelMaster fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<TraineeLevelMaster> orderByComparator) {
	 ...
	 * @throws NoSuchTraineeLevelMasterException if a matching trainee level master could not be found
	 */
	public static TraineeLevelMaster findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<TraineeLevelMaster> orderByComparator)
		throws gov.omsb.tms.exception.NoSuchTraineeLevelMasterException {
	 ...
	 * @return the last matching trainee level master, or <code>null</code> if a matching trainee level master could not be found
	 */
	public static TraineeLevelMaster fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<TraineeLevelMaster> orderByComparator) {
	 ...
	 * @throws NoSuchTraineeLevelMasterException if a trainee level master with the primary key could not be found
	 */
	public static TraineeLevelMaster[] findByUuid_C_PrevAndNext(
			long traineeLevelMasterId, String uuid, long companyId,
			OrderByComparator<TraineeLevelMaster> orderByComparator)
		throws gov.omsb.tms.exception.NoSuchTraineeLevelMasterException {

		return getPersistence().findByUuid_C_PrevAndNext(
			traineeLevelMasterId, uuid, companyId, orderByComparator);
	}
	 ...
	 * @return the matching trainee level masters
	 */
	public static List<TraineeLevelMaster> findBytraineeLevelNameByLike(
		String traineeLevelName) {

		return getPersistence().findBytraineeLevelNameByLike(traineeLevelName);
	}
	...
	public static List<TraineeLevelMaster> findBytraineeLevelNameByLike(
		...
		return getPersistence().findBytraineeLevelNameByLike(
			traineeLevelName, start, end);
	}
	...
	public static List<TraineeLevelMaster> findBytraineeLevelNameByLike(
		...
		return getPersistence().findBytraineeLevelNameByLike(
			traineeLevelName, start, end, orderByComparator, useFinderCache);
	}
	 ...
	 * @throws NoSuchTraineeLevelMasterException if a matching trainee level master could not be found
	 */
	public static TraineeLevelMaster findBytraineeLevelNameByLike_First(
			String traineeLevelName,
			OrderByComparator<TraineeLevelMaster> orderByComparator)
		throws gov.omsb.tms.exception.NoSuchTraineeLevelMasterException {

		return getPersistence().findBytraineeLevelNameByLike_First(
	 ...
	 * @return the first matching trainee level master, or <code>null</code> if a matching trainee level master could not be found
	 */
	public static TraineeLevelMaster fetchBytraineeLevelNameByLike_First(
		String traineeLevelName,
		OrderByComparator<TraineeLevelMaster> orderByComparator) {

		return getPersistence().fetchBytraineeLevelNameByLike_First(
			traineeLevelName, orderByComparator);
	}
	 ...
	 * @throws NoSuchTraineeLevelMasterException if a matching trainee level master could not be found
	 */
	public static TraineeLevelMaster findBytraineeLevelNameByLike_Last(
			String traineeLevelName,
			OrderByComparator<TraineeLevelMaster> orderByComparator)
		throws gov.omsb.tms.exception.NoSuchTraineeLevelMasterException {

		return getPersistence().findBytraineeLevelNameByLike_Last(
			traineeLevelName, orderByComparator);
	}
	 ...
	 * @return the last matching trainee level master, or <code>null</code> if a matching trainee level master could not be found
	 */
	public static TraineeLevelMaster fetchBytraineeLevelNameByLike_Last(
		String traineeLevelName,
		OrderByComparator<TraineeLevelMaster> orderByComparator) {

		return getPersistence().fetchBytraineeLevelNameByLike_Last(
			traineeLevelName, orderByComparator);
	}
	 ...
	 * @throws NoSuchTraineeLevelMasterException if a trainee level master with the primary key could not be found
	 */
	public static TraineeLevelMaster[] findBytraineeLevelNameByLike_PrevAndNext(
			long traineeLevelMasterId, String traineeLevelName,
			OrderByComparator<TraineeLevelMaster> orderByComparator)
		throws gov.omsb.tms.exception.NoSuchTraineeLevelMasterException {

		return getPersistence().findBytraineeLevelNameByLike_PrevAndNext(
			traineeLevelMasterId, traineeLevelName, orderByComparator);
	}
	 ...
	 * @param traineeLevelName the trainee level name
	 */
	public static void removeBytraineeLevelNameByLike(String traineeLevelName) {
		getPersistence().removeBytraineeLevelNameByLike(traineeLevelName);
	}
	 ...
	 * @return the number of matching trainee level masters
	 */
	public static int countBytraineeLevelNameByLike(String traineeLevelName) {
		return getPersistence().countBytraineeLevelNameByLike(traineeLevelName);
	}
	 ...
	 */
	public static void cacheResult(TraineeLevelMaster traineeLevelMaster) {
		getPersistence().cacheResult(traineeLevelMaster);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(traineeLevelMasters);
	}
	 ...
	 */
	public static TraineeLevelMaster create(long traineeLevelMasterId) {
		return getPersistence().create(traineeLevelMasterId);
	}
	 ...
	 * @throws NoSuchTraineeLevelMasterException if a trainee level master with the primary key could not be found
	 */
	public static TraineeLevelMaster remove(long traineeLevelMasterId)
		throws gov.omsb.tms.exception.NoSuchTraineeLevelMasterException {

		return getPersistence().remove(traineeLevelMasterId);
	}

	public static TraineeLevelMaster updateImpl(
		TraineeLevelMaster traineeLevelMaster) {

		return getPersistence().updateImpl(traineeLevelMaster);
	}
	 ...
	 * @throws NoSuchTraineeLevelMasterException if a trainee level master with the primary key could not be found
	 */
	public static TraineeLevelMaster findByPrimaryKey(long traineeLevelMasterId)
		throws gov.omsb.tms.exception.NoSuchTraineeLevelMasterException {

		return getPersistence().findByPrimaryKey(traineeLevelMasterId);
	}
	 ...
	 */
	public static TraineeLevelMaster fetchByPrimaryKey(
		long traineeLevelMasterId) {

		return getPersistence().fetchByPrimaryKey(traineeLevelMasterId);
	}
	 ...
	 */
	public static List<TraineeLevelMaster> findAll() {
	 ...
	 */
	public static List<TraineeLevelMaster> findAll(int start, int end) {
	...
	public static TraineeLevelMasterPersistence getPersistence() {
		return _persistence;
	}

	private static volatile TraineeLevelMasterPersistence _persistence;
