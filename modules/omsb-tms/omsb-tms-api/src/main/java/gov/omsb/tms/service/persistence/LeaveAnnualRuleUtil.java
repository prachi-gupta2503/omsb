...
/**
 * The persistence utility for the leave annual rule service. This utility wraps <code>gov.omsb.tms.service.persistence.impl.LeaveAnnualRulePersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see LeaveAnnualRulePersistence
 * @generated
 */
public class LeaveAnnualRuleUtil {
	 ...
	 */
	public static void clearCache(LeaveAnnualRule leaveAnnualRule) {
		getPersistence().clearCache(leaveAnnualRule);
	}
	 ...
	 */
	public static Map<Serializable, LeaveAnnualRule> fetchByPrimaryKeys(
	 ...
	 */
	public static List<LeaveAnnualRule> findWithDynamicQuery(
	 ...
	 */
	public static LeaveAnnualRule update(LeaveAnnualRule leaveAnnualRule) {
		return getPersistence().update(leaveAnnualRule);
	}

	/**
	 * @see com.liferay.portal.kernel.service.persistence.BasePersistence#update(com.liferay.portal.kernel.model.BaseModel, ServiceContext)
	 */
	public static LeaveAnnualRule update(
		LeaveAnnualRule leaveAnnualRule, ServiceContext serviceContext) {

		return getPersistence().update(leaveAnnualRule, serviceContext);
	}
	 ...
	 */
	public static List<LeaveAnnualRule> findByUuid(String uuid) {
	 ...
	 */
	public static List<LeaveAnnualRule> findByUuid(
	 ...
	 */
	public static LeaveAnnualRule findByUuid_First(
			String uuid, OrderByComparator<LeaveAnnualRule> orderByComparator)
		throws gov.omsb.tms.exception.NoSuchLeaveAnnualRuleException {
	 ...
	 */
	public static LeaveAnnualRule fetchByUuid_First(
		String uuid, OrderByComparator<LeaveAnnualRule> orderByComparator) {
	 ...
	 * @throws NoSuchLeaveAnnualRuleException if a matching leave annual rule could not be found
	 */
	public static LeaveAnnualRule findByUuid_Last(
			String uuid, OrderByComparator<LeaveAnnualRule> orderByComparator)
		throws gov.omsb.tms.exception.NoSuchLeaveAnnualRuleException {
	 ...
	 */
	public static LeaveAnnualRule fetchByUuid_Last(
		String uuid, OrderByComparator<LeaveAnnualRule> orderByComparator) {
	 ...
	 */
	public static LeaveAnnualRule[] findByUuid_PrevAndNext(
			long leaveAnnualRuleId, String uuid,
			OrderByComparator<LeaveAnnualRule> orderByComparator)
		throws gov.omsb.tms.exception.NoSuchLeaveAnnualRuleException {

		return getPersistence().findByUuid_PrevAndNext(
			leaveAnnualRuleId, uuid, orderByComparator);
	}
	 ...
	 * @throws NoSuchLeaveAnnualRuleException if a matching leave annual rule could not be found
	 */
	public static LeaveAnnualRule findByUUID_G(String uuid, long groupId)
		throws gov.omsb.tms.exception.NoSuchLeaveAnnualRuleException {
	 ...
	 */
	public static LeaveAnnualRule fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching leave annual rule, or <code>null</code> if a matching leave annual rule could not be found
	 */
	public static LeaveAnnualRule fetchByUUID_G(
	 ...
	 */
	public static LeaveAnnualRule removeByUUID_G(String uuid, long groupId)
		throws gov.omsb.tms.exception.NoSuchLeaveAnnualRuleException {
	 ...
	 * @return the matching leave annual rules
	 */
	public static List<LeaveAnnualRule> findByUuid_C(
	 ...
	 * @throws NoSuchLeaveAnnualRuleException if a matching leave annual rule could not be found
	 */
	public static LeaveAnnualRule findByUuid_C_First(
			String uuid, long companyId,
			OrderByComparator<LeaveAnnualRule> orderByComparator)
		throws gov.omsb.tms.exception.NoSuchLeaveAnnualRuleException {
	 ...
	 * @return the first matching leave annual rule, or <code>null</code> if a matching leave annual rule could not be found
	 */
	public static LeaveAnnualRule fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<LeaveAnnualRule> orderByComparator) {
	 ...
	 * @throws NoSuchLeaveAnnualRuleException if a matching leave annual rule could not be found
	 */
	public static LeaveAnnualRule findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<LeaveAnnualRule> orderByComparator)
		throws gov.omsb.tms.exception.NoSuchLeaveAnnualRuleException {
	 ...
	 * @return the last matching leave annual rule, or <code>null</code> if a matching leave annual rule could not be found
	 */
	public static LeaveAnnualRule fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<LeaveAnnualRule> orderByComparator) {
	 ...
	 * @throws NoSuchLeaveAnnualRuleException if a leave annual rule with the primary key could not be found
	 */
	public static LeaveAnnualRule[] findByUuid_C_PrevAndNext(
			long leaveAnnualRuleId, String uuid, long companyId,
			OrderByComparator<LeaveAnnualRule> orderByComparator)
		throws gov.omsb.tms.exception.NoSuchLeaveAnnualRuleException {

		return getPersistence().findByUuid_C_PrevAndNext(
			leaveAnnualRuleId, uuid, companyId, orderByComparator);
	}
	 ...
	 */
	public static void cacheResult(LeaveAnnualRule leaveAnnualRule) {
		getPersistence().cacheResult(leaveAnnualRule);
	}
	 ...
	 */
	public static void cacheResult(List<LeaveAnnualRule> leaveAnnualRules) {
		getPersistence().cacheResult(leaveAnnualRules);
	}
	 ...
	 */
	public static LeaveAnnualRule create(long leaveAnnualRuleId) {
		return getPersistence().create(leaveAnnualRuleId);
	}
	 ...
	 * @throws NoSuchLeaveAnnualRuleException if a leave annual rule with the primary key could not be found
	 */
	public static LeaveAnnualRule remove(long leaveAnnualRuleId)
		throws gov.omsb.tms.exception.NoSuchLeaveAnnualRuleException {

		return getPersistence().remove(leaveAnnualRuleId);
	}

	public static LeaveAnnualRule updateImpl(LeaveAnnualRule leaveAnnualRule) {
		return getPersistence().updateImpl(leaveAnnualRule);
	}
	 ...
	 * @throws NoSuchLeaveAnnualRuleException if a leave annual rule with the primary key could not be found
	 */
	public static LeaveAnnualRule findByPrimaryKey(long leaveAnnualRuleId)
		throws gov.omsb.tms.exception.NoSuchLeaveAnnualRuleException {

		return getPersistence().findByPrimaryKey(leaveAnnualRuleId);
	}
	 ...
	 */
	public static LeaveAnnualRule fetchByPrimaryKey(long leaveAnnualRuleId) {
		return getPersistence().fetchByPrimaryKey(leaveAnnualRuleId);
	}
	 ...
	 */
	public static List<LeaveAnnualRule> findAll() {
	 ...
	 */
	public static List<LeaveAnnualRule> findAll(int start, int end) {
	...
	public static LeaveAnnualRulePersistence getPersistence() {
		return _persistence;
	}

	private static volatile LeaveAnnualRulePersistence _persistence;
