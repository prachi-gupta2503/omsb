...
import gov.omsb.tms.service.DutyRuleService;
import gov.omsb.tms.service.DutyRuleServiceUtil;
...
/**
 * Provides the base implementation for the duty rule remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.DutyRuleServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.DutyRuleServiceImpl
 * @generated
 */
public abstract class DutyRuleServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DutyRuleService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DutyRuleService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DutyRuleServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DutyRuleService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		dutyRuleService = (DutyRuleService)aopProxy;

		_setServiceUtilService(dutyRuleService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DutyRuleService.class.getName();
	}
	...
	private void _setServiceUtilService(DutyRuleService dutyRuleService) {
		try {
			Field field = DutyRuleServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, dutyRuleService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.DutyRuleLocalService dutyRuleLocalService;

	protected DutyRuleService dutyRuleService;
