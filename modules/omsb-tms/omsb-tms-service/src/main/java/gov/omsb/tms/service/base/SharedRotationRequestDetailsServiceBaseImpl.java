...
import gov.omsb.tms.service.SharedRotationRequestDetailsService;
import gov.omsb.tms.service.SharedRotationRequestDetailsServiceUtil;
...
/**
 * Provides the base implementation for the shared rotation request details remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.SharedRotationRequestDetailsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.SharedRotationRequestDetailsServiceImpl
 * @generated
 */
public abstract class SharedRotationRequestDetailsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   SharedRotationRequestDetailsService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SharedRotationRequestDetailsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SharedRotationRequestDetailsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SharedRotationRequestDetailsService.class,
	...
	public void setAopProxy(Object aopProxy) {
		sharedRotationRequestDetailsService =
			(SharedRotationRequestDetailsService)aopProxy;

		_setServiceUtilService(sharedRotationRequestDetailsService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SharedRotationRequestDetailsService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				SharedRotationRequestDetailsServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, sharedRotationRequestDetailsService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.SharedRotationRequestDetailsLocalService
		sharedRotationRequestDetailsLocalService;

	protected SharedRotationRequestDetailsService
		sharedRotationRequestDetailsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SharedRotationRequestDetailsServiceBaseImpl.class);
