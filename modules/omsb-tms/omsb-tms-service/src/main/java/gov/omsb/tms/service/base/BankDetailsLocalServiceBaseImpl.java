...
/**
 * Provides the base implementation for the bank details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.BankDetailsLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.BankDetailsLocalServiceImpl
 * @generated
 */
public abstract class BankDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, BankDetailsLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BankDetailsLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>BankDetailsLocalServiceUtil</code>.
	 */
	...
	public BankDetails addBankDetails(BankDetails bankDetails) {
		...
		return bankDetailsPersistence.update(bankDetails);
	}
	...
	public BankDetails createBankDetails(long bankDetailsId) {
		return bankDetailsPersistence.create(bankDetailsId);
	}
	...
	public BankDetails deleteBankDetails(long bankDetailsId)
		...
		return bankDetailsPersistence.remove(bankDetailsId);
	}
	...
	public BankDetails deleteBankDetails(BankDetails bankDetails) {
		return bankDetailsPersistence.remove(bankDetails);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return bankDetailsPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			BankDetails.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return bankDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return bankDetailsPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return bankDetailsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return bankDetailsPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public BankDetails fetchBankDetails(long bankDetailsId) {
		return bankDetailsPersistence.fetchByPrimaryKey(bankDetailsId);
	}
	...
	public BankDetails fetchBankDetailsByUuidAndGroupId(
		...
		return bankDetailsPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public BankDetails getBankDetails(long bankDetailsId)
		...
		return bankDetailsPersistence.findByPrimaryKey(bankDetailsId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(bankDetailsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(BankDetails.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("bankDetailsId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			bankDetailsLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(BankDetails.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<BankDetails>() {

				@Override
				public void performAction(BankDetails bankDetails)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, bankDetails);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return bankDetailsPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement BankDetailsLocalServiceImpl#deleteBankDetails(BankDetails) to avoid orphaned data");
		}

		return bankDetailsLocalService.deleteBankDetails(
			(BankDetails)persistedModel);
	}

	@Override
	public BasePersistence<BankDetails> getBasePersistence() {
		return bankDetailsPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return bankDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<BankDetails> getBankDetailsesByUuidAndCompanyId(
		...
		return bankDetailsPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<BankDetails> getBankDetailsesByUuidAndCompanyId(
		...
		return bankDetailsPersistence.findByUuid_C(
	...
	public BankDetails getBankDetailsByUuidAndGroupId(String uuid, long groupId)
		...
		return bankDetailsPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<BankDetails> getBankDetailses(int start, int end) {
		return bankDetailsPersistence.findAll(start, end);
	}
	...
	public int getBankDetailsesCount() {
		return bankDetailsPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BankDetailsLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		bankDetailsLocalService = (BankDetailsLocalService)aopProxy;

		_setLocalServiceUtilService(bankDetailsLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return BankDetailsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = bankDetailsPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = BankDetailsLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, bankDetailsLocalService);
		}
	...
	protected BankDetailsLocalService bankDetailsLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		BankDetailsLocalServiceBaseImpl.class);
