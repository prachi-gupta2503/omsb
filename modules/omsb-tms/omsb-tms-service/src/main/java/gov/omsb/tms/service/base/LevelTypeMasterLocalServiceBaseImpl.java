...
import gov.omsb.tms.service.LevelTypeMasterLocalServiceUtil;
...
/**
 * Provides the base implementation for the level type master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.LevelTypeMasterLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.LevelTypeMasterLocalServiceImpl
 * @generated
 */
public abstract class LevelTypeMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   LevelTypeMasterLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LevelTypeMasterLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>LevelTypeMasterLocalServiceUtil</code>.
	 */
	...
	@Override
	public LevelTypeMaster addLevelTypeMaster(LevelTypeMaster levelTypeMaster) {
		levelTypeMaster.setNew(true);

		return levelTypeMasterPersistence.update(levelTypeMaster);
	}
	...
	public LevelTypeMaster createLevelTypeMaster(long LevelTypeMasterId) {
		return levelTypeMasterPersistence.create(LevelTypeMasterId);
	}
	...
	@Override
	public LevelTypeMaster deleteLevelTypeMaster(long LevelTypeMasterId)
		throws PortalException {

		return levelTypeMasterPersistence.remove(LevelTypeMasterId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LevelTypeMaster deleteLevelTypeMaster(
		LevelTypeMaster levelTypeMaster) {

		return levelTypeMasterPersistence.remove(levelTypeMaster);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return levelTypeMasterPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			LevelTypeMaster.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return levelTypeMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return levelTypeMasterPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return levelTypeMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return levelTypeMasterPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public LevelTypeMaster fetchLevelTypeMaster(long LevelTypeMasterId) {
		return levelTypeMasterPersistence.fetchByPrimaryKey(LevelTypeMasterId);
	}
	 ...
	 */
	@Override
	public LevelTypeMaster fetchLevelTypeMasterByUuidAndGroupId(
		String uuid, long groupId) {

		return levelTypeMasterPersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public LevelTypeMaster getLevelTypeMaster(long LevelTypeMasterId)
		throws PortalException {

		return levelTypeMasterPersistence.findByPrimaryKey(LevelTypeMasterId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(levelTypeMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(LevelTypeMaster.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("LevelTypeMasterId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(LevelTypeMaster.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<LevelTypeMaster>() {

				@Override
				public void performAction(LevelTypeMaster levelTypeMaster)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, levelTypeMaster);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return levelTypeMasterPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement LevelTypeMasterLocalServiceImpl#deleteLevelTypeMaster(LevelTypeMaster) to avoid orphaned data");
		}

		return levelTypeMasterLocalService.deleteLevelTypeMaster(
			(LevelTypeMaster)persistedModel);
	}

	@Override
	public BasePersistence<LevelTypeMaster> getBasePersistence() {
		return levelTypeMasterPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return levelTypeMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LevelTypeMaster> getLevelTypeMastersByUuidAndCompanyId(
		String uuid, long companyId) {

		return levelTypeMasterPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<LevelTypeMaster> getLevelTypeMastersByUuidAndCompanyId(
		...
		return levelTypeMasterPersistence.findByUuid_C(
	 ...
	 */
	@Override
	public LevelTypeMaster getLevelTypeMasterByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return levelTypeMasterPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<LevelTypeMaster> getLevelTypeMasters(int start, int end) {
		return levelTypeMasterPersistence.findAll(start, end);
	}
	...
	public int getLevelTypeMastersCount() {
		return levelTypeMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LevelTypeMaster updateLevelTypeMaster(
		LevelTypeMaster levelTypeMaster) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LevelTypeMasterLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		levelTypeMasterLocalService = (LevelTypeMasterLocalService)aopProxy;

		_setLocalServiceUtilService(levelTypeMasterLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return LevelTypeMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = levelTypeMasterPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				LevelTypeMasterLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, levelTypeMasterLocalService);
		}
	...
	protected LevelTypeMasterLocalService levelTypeMasterLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LevelTypeMasterLocalServiceBaseImpl.class);
