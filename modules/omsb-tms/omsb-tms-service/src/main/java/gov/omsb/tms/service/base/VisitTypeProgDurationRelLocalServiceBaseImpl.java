...
/**
 * Provides the base implementation for the visit type prog duration rel local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.VisitTypeProgDurationRelLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.VisitTypeProgDurationRelLocalServiceImpl
 * @generated
 */
public abstract class VisitTypeProgDurationRelLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>VisitTypeProgDurationRelLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>VisitTypeProgDurationRelLocalServiceUtil</code>.
	 */
	...
	public VisitTypeProgDurationRel addVisitTypeProgDurationRel(
		...
		return visitTypeProgDurationRelPersistence.update(
	...
	public VisitTypeProgDurationRel createVisitTypeProgDurationRel(
		...
		return visitTypeProgDurationRelPersistence.create(
	...
	public VisitTypeProgDurationRel deleteVisitTypeProgDurationRel(
		...
		return visitTypeProgDurationRelPersistence.remove(
			VisitTypeProgDurationRelId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return visitTypeProgDurationRelPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			VisitTypeProgDurationRel.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return visitTypeProgDurationRelPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return visitTypeProgDurationRelPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public VisitTypeProgDurationRel fetchVisitTypeProgDurationRel(
		...
		return visitTypeProgDurationRelPersistence.fetchByPrimaryKey(
			VisitTypeProgDurationRelId);
	}
	...
	public VisitTypeProgDurationRel
		...
		return visitTypeProgDurationRelPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public VisitTypeProgDurationRel getVisitTypeProgDurationRel(
		...
		return visitTypeProgDurationRelPersistence.findByPrimaryKey(
			VisitTypeProgDurationRelId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(VisitTypeProgDurationRel.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			VisitTypeProgDurationRel.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, visitTypeProgDurationRel);
				}
		...
		exportActionableDynamicQuery.setStagedModelType(
			new StagedModelType(
				PortalUtil.getClassNameId(
					VisitTypeProgDurationRel.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement VisitTypeProgDurationRelLocalServiceImpl#deleteVisitTypeProgDurationRel(VisitTypeProgDurationRel) to avoid orphaned data");
		}

		return visitTypeProgDurationRelLocalService.
			deleteVisitTypeProgDurationRel(
				(VisitTypeProgDurationRel)persistedModel);
	}

	@Override
	public BasePersistence<VisitTypeProgDurationRel> getBasePersistence() {
		return visitTypeProgDurationRelPersistence;
	}
	...
	public List<VisitTypeProgDurationRel>
		...
		return visitTypeProgDurationRelPersistence.findByUuid_C(
			uuid, companyId);
	}
	...
	public VisitTypeProgDurationRel getVisitTypeProgDurationRelByUuidAndGroupId(
		...
		return visitTypeProgDurationRelPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<VisitTypeProgDurationRel> getVisitTypeProgDurationRels(
		...
		return visitTypeProgDurationRelPersistence.findAll(start, end);
	}
	...
	public int getVisitTypeProgDurationRelsCount() {
		return visitTypeProgDurationRelPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			VisitTypeProgDurationRelLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		visitTypeProgDurationRelLocalService =
			(VisitTypeProgDurationRelLocalService)aopProxy;

		_setLocalServiceUtilService(visitTypeProgDurationRelLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return VisitTypeProgDurationRelLocalService.class.getName();
	}
	...
	protected String getModelClassName() {
		return VisitTypeProgDurationRel.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				visitTypeProgDurationRelPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				VisitTypeProgDurationRelLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, visitTypeProgDurationRelLocalService);
		}
	...
	protected VisitTypeProgDurationRelLocalService
		visitTypeProgDurationRelLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		VisitTypeProgDurationRelLocalServiceBaseImpl.class);
