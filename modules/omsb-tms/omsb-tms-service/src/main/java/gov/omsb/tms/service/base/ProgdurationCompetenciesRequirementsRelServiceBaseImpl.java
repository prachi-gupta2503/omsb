...
import gov.omsb.tms.service.ProgdurationCompetenciesRequirementsRelService;
import gov.omsb.tms.service.ProgdurationCompetenciesRequirementsRelServiceUtil;
...
/**
 * Provides the base implementation for the progduration competencies requirements rel remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.ProgdurationCompetenciesRequirementsRelServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.ProgdurationCompetenciesRequirementsRelServiceImpl
 * @generated
 */
public abstract class ProgdurationCompetenciesRequirementsRelServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   ProgdurationCompetenciesRequirementsRelService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProgdurationCompetenciesRequirementsRelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProgdurationCompetenciesRequirementsRelServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProgdurationCompetenciesRequirementsRelService.class,
	...
	public void setAopProxy(Object aopProxy) {
		progdurationCompetenciesRequirementsRelService =
			(ProgdurationCompetenciesRequirementsRelService)aopProxy;

		_setServiceUtilService(progdurationCompetenciesRequirementsRelService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProgdurationCompetenciesRequirementsRelService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				ProgdurationCompetenciesRequirementsRelServiceUtil.class.
					getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, progdurationCompetenciesRequirementsRelService);
		}
	...
	@Reference
	protected
		gov.omsb.tms.service.ProgdurationCompetenciesRequirementsRelLocalService
			progdurationCompetenciesRequirementsRelLocalService;

	protected ProgdurationCompetenciesRequirementsRelService
		progdurationCompetenciesRequirementsRelService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProgdurationCompetenciesRequirementsRelServiceBaseImpl.class);
