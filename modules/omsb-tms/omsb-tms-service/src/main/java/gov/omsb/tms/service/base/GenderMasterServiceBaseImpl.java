...
import gov.omsb.tms.service.GenderMasterService;
import gov.omsb.tms.service.GenderMasterServiceUtil;
...
/**
 * Provides the base implementation for the gender master remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.GenderMasterServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.GenderMasterServiceImpl
 * @generated
 */
public abstract class GenderMasterServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, GenderMasterService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>GenderMasterService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>GenderMasterServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			GenderMasterService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		genderMasterService = (GenderMasterService)aopProxy;

		_setServiceUtilService(genderMasterService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return GenderMasterService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = GenderMasterServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, genderMasterService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.GenderMasterLocalService
		genderMasterLocalService;

	protected GenderMasterService genderMasterService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		GenderMasterServiceBaseImpl.class);
