...
import gov.omsb.tms.service.CptCodeMasterService;
import gov.omsb.tms.service.CptCodeMasterServiceUtil;
...
/**
 * Provides the base implementation for the cpt code master remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.CptCodeMasterServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.CptCodeMasterServiceImpl
 * @generated
 */
public abstract class CptCodeMasterServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CptCodeMasterService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CptCodeMasterService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>CptCodeMasterServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CptCodeMasterService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		cptCodeMasterService = (CptCodeMasterService)aopProxy;

		_setServiceUtilService(cptCodeMasterService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return CptCodeMasterService.class.getName();
	}

	protected Class<?> getModelClass() {
		return CptCodeMaster.class;
	}

	protected String getModelClassName() {
		return CptCodeMaster.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = cptCodeMasterPersistence.getDataSource();
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = CptCodeMasterServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, cptCodeMasterService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.CptCodeMasterLocalService
		cptCodeMasterLocalService;

	protected CptCodeMasterService cptCodeMasterService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CptCodeMasterServiceBaseImpl.class);
