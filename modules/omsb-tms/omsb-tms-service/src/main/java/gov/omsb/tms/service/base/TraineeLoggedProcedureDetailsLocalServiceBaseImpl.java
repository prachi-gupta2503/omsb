...
/**
 * Provides the base implementation for the trainee logged procedure details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.TraineeLoggedProcedureDetailsLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.TraineeLoggedProcedureDetailsLocalServiceImpl
 * @generated
 */
public abstract class TraineeLoggedProcedureDetailsLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TraineeLoggedProcedureDetailsLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TraineeLoggedProcedureDetailsLocalServiceUtil</code>.
	 */
	...
	public TraineeLoggedProcedureDetails addTraineeLoggedProcedureDetails(
		...
		return traineeLoggedProcedureDetailsPersistence.update(
	...
	public TraineeLoggedProcedureDetails createTraineeLoggedProcedureDetails(
		...
		return traineeLoggedProcedureDetailsPersistence.create(
	...
	public TraineeLoggedProcedureDetails deleteTraineeLoggedProcedureDetails(
		...
		return traineeLoggedProcedureDetailsPersistence.remove(
			traineeLoggedProcedureDetailsId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return traineeLoggedProcedureDetailsPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TraineeLoggedProcedureDetails.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return traineeLoggedProcedureDetailsPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return traineeLoggedProcedureDetailsPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public TraineeLoggedProcedureDetails fetchTraineeLoggedProcedureDetails(
		...
		return traineeLoggedProcedureDetailsPersistence.fetchByPrimaryKey(
			traineeLoggedProcedureDetailsId);
	}
	...
	public TraineeLoggedProcedureDetails
		...
		return traineeLoggedProcedureDetailsPersistence.fetchByUUID_G(
			uuid, groupId);
	}
	...
	public TraineeLoggedProcedureDetails getTraineeLoggedProcedureDetails(
		...
		return traineeLoggedProcedureDetailsPersistence.findByPrimaryKey(
			traineeLoggedProcedureDetailsId);
	}
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, traineeLoggedProcedureDetails);
				}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TraineeLoggedProcedureDetailsLocalServiceImpl#deleteTraineeLoggedProcedureDetails(TraineeLoggedProcedureDetails) to avoid orphaned data");
		}

		return traineeLoggedProcedureDetailsLocalService.
			deleteTraineeLoggedProcedureDetails(
				(TraineeLoggedProcedureDetails)persistedModel);
	}

	@Override
	public BasePersistence<TraineeLoggedProcedureDetails> getBasePersistence() {
		return traineeLoggedProcedureDetailsPersistence;
	}
	...
	public List<TraineeLoggedProcedureDetails>
		...
		return traineeLoggedProcedureDetailsPersistence.findByUuid_C(
			uuid, companyId);
	}
	...
	public TraineeLoggedProcedureDetails
		...
		return traineeLoggedProcedureDetailsPersistence.findByUUID_G(
			uuid, groupId);
	}
	...
	public List<TraineeLoggedProcedureDetails>
		...
		return traineeLoggedProcedureDetailsPersistence.findAll(start, end);
	}
	...
	public int getTraineeLoggedProcedureDetailsesCount() {
		return traineeLoggedProcedureDetailsPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TraineeLoggedProcedureDetailsLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		traineeLoggedProcedureDetailsLocalService =
			(TraineeLoggedProcedureDetailsLocalService)aopProxy;

		_setLocalServiceUtilService(traineeLoggedProcedureDetailsLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TraineeLoggedProcedureDetailsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				traineeLoggedProcedureDetailsPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				TraineeLoggedProcedureDetailsLocalServiceUtil.class.
					getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, traineeLoggedProcedureDetailsLocalService);
		}
	...
	protected TraineeLoggedProcedureDetailsLocalService
		traineeLoggedProcedureDetailsLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TraineeLoggedProcedureDetailsLocalServiceBaseImpl.class);
