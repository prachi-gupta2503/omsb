...
import gov.omsb.tms.service.ProgramDurationDetailsService;
import gov.omsb.tms.service.ProgramDurationDetailsServiceUtil;
...
/**
 * Provides the base implementation for the program duration details remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.ProgramDurationDetailsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.ProgramDurationDetailsServiceImpl
 * @generated
 */
public abstract class ProgramDurationDetailsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   ProgramDurationDetailsService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProgramDurationDetailsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProgramDurationDetailsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProgramDurationDetailsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		programDurationDetailsService = (ProgramDurationDetailsService)aopProxy;

		_setServiceUtilService(programDurationDetailsService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProgramDurationDetailsService.class.getName();
	}
	...
	private void _setServiceUtilService(
		ProgramDurationDetailsService programDurationDetailsService) {

		try {
			Field field =
				ProgramDurationDetailsServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, programDurationDetailsService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.ProgramDurationDetailsLocalService
		programDurationDetailsLocalService;

	protected ProgramDurationDetailsService programDurationDetailsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProgramDurationDetailsServiceBaseImpl.class);
