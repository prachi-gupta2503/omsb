...
import gov.omsb.tms.service.PatientTypeMasterService;
import gov.omsb.tms.service.PatientTypeMasterServiceUtil;
...
/**
 * Provides the base implementation for the patient type master remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.PatientTypeMasterServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.PatientTypeMasterServiceImpl
 * @generated
 */
public abstract class PatientTypeMasterServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PatientTypeMasterService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PatientTypeMasterService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PatientTypeMasterServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PatientTypeMasterService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		patientTypeMasterService = (PatientTypeMasterService)aopProxy;

		_setServiceUtilService(patientTypeMasterService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return PatientTypeMasterService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = PatientTypeMasterServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, patientTypeMasterService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.PatientTypeMasterLocalService
		patientTypeMasterLocalService;

	protected PatientTypeMasterService patientTypeMasterService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		PatientTypeMasterServiceBaseImpl.class);
