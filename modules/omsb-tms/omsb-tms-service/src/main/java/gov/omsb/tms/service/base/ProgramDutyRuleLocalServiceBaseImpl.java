...
/**
 * Provides the base implementation for the program duty rule local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.ProgramDutyRuleLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.ProgramDutyRuleLocalServiceImpl
 * @generated
 */
public abstract class ProgramDutyRuleLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   ProgramDutyRuleLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProgramDutyRuleLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProgramDutyRuleLocalServiceUtil</code>.
	 */
	...
	@Override
	public ProgramDutyRule addProgramDutyRule(ProgramDutyRule programDutyRule) {
		programDutyRule.setNew(true);

		return programDutyRulePersistence.update(programDutyRule);
	}
	...
	public ProgramDutyRule createProgramDutyRule(long programDutyRuleId) {
		return programDutyRulePersistence.create(programDutyRuleId);
	}
	...
	@Override
	public ProgramDutyRule deleteProgramDutyRule(long programDutyRuleId)
		throws PortalException {

		return programDutyRulePersistence.remove(programDutyRuleId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ProgramDutyRule deleteProgramDutyRule(
		ProgramDutyRule programDutyRule) {

		return programDutyRulePersistence.remove(programDutyRule);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return programDutyRulePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ProgramDutyRule.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return programDutyRulePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return programDutyRulePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return programDutyRulePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return programDutyRulePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public ProgramDutyRule fetchProgramDutyRule(long programDutyRuleId) {
		return programDutyRulePersistence.fetchByPrimaryKey(programDutyRuleId);
	}
	 ...
	 */
	@Override
	public ProgramDutyRule fetchProgramDutyRuleByUuidAndGroupId(
		String uuid, long groupId) {

		return programDutyRulePersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public ProgramDutyRule getProgramDutyRule(long programDutyRuleId)
		throws PortalException {

		return programDutyRulePersistence.findByPrimaryKey(programDutyRuleId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(programDutyRuleLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ProgramDutyRule.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("programDutyRuleId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(ProgramDutyRule.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<ProgramDutyRule>() {

				@Override
				public void performAction(ProgramDutyRule programDutyRule)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, programDutyRule);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return programDutyRulePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ProgramDutyRuleLocalServiceImpl#deleteProgramDutyRule(ProgramDutyRule) to avoid orphaned data");
		}

		return programDutyRuleLocalService.deleteProgramDutyRule(
			(ProgramDutyRule)persistedModel);
	}

	@Override
	public BasePersistence<ProgramDutyRule> getBasePersistence() {
		return programDutyRulePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return programDutyRulePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ProgramDutyRule> getProgramDutyRulesByUuidAndCompanyId(
		String uuid, long companyId) {

		return programDutyRulePersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<ProgramDutyRule> getProgramDutyRulesByUuidAndCompanyId(
		...
		return programDutyRulePersistence.findByUuid_C(
	 ...
	 */
	@Override
	public ProgramDutyRule getProgramDutyRuleByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return programDutyRulePersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<ProgramDutyRule> getProgramDutyRules(int start, int end) {
		return programDutyRulePersistence.findAll(start, end);
	}
	...
	public int getProgramDutyRulesCount() {
		return programDutyRulePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ProgramDutyRule updateProgramDutyRule(
		ProgramDutyRule programDutyRule) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProgramDutyRuleLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		programDutyRuleLocalService = (ProgramDutyRuleLocalService)aopProxy;

		_setLocalServiceUtilService(programDutyRuleLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProgramDutyRuleLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = programDutyRulePersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				ProgramDutyRuleLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, programDutyRuleLocalService);
		}
	...
	protected ProgramDutyRuleLocalService programDutyRuleLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProgramDutyRuleLocalServiceBaseImpl.class);
