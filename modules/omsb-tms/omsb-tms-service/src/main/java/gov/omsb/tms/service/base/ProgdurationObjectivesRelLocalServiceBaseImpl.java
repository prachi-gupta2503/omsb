...
/**
 * Provides the base implementation for the progduration objectives rel local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.ProgdurationObjectivesRelLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.ProgdurationObjectivesRelLocalServiceImpl
 * @generated
 */
public abstract class ProgdurationObjectivesRelLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProgdurationObjectivesRelLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProgdurationObjectivesRelLocalServiceUtil</code>.
	 */
	...
	public ProgdurationObjectivesRel addProgdurationObjectivesRel(
		...
		return progdurationObjectivesRelPersistence.update(
	...
	public ProgdurationObjectivesRel createProgdurationObjectivesRel(
		...
		return progdurationObjectivesRelPersistence.create(PDObjectivesId);
	}
	...
	public ProgdurationObjectivesRel deleteProgdurationObjectivesRel(
		...
		return progdurationObjectivesRelPersistence.remove(PDObjectivesId);
	}
	...
	public ProgdurationObjectivesRel deleteProgdurationObjectivesRel(
		...
		return progdurationObjectivesRelPersistence.remove(
			progdurationObjectivesRel);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return progdurationObjectivesRelPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ProgdurationObjectivesRel.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return progdurationObjectivesRelPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return progdurationObjectivesRelPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public ProgdurationObjectivesRel fetchProgdurationObjectivesRel(
		...
		return progdurationObjectivesRelPersistence.fetchByPrimaryKey(
			PDObjectivesId);
	}
	...
	public ProgdurationObjectivesRel
		...
		return progdurationObjectivesRelPersistence.fetchByUUID_G(
			uuid, groupId);
	}
	...
	public ProgdurationObjectivesRel getProgdurationObjectivesRel(
		...
		return progdurationObjectivesRelPersistence.findByPrimaryKey(
			PDObjectivesId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(ProgdurationObjectivesRel.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("PDObjectivesId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			ProgdurationObjectivesRel.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, progdurationObjectivesRel);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return progdurationObjectivesRelPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ProgdurationObjectivesRelLocalServiceImpl#deleteProgdurationObjectivesRel(ProgdurationObjectivesRel) to avoid orphaned data");
		}

		return progdurationObjectivesRelLocalService.
			deleteProgdurationObjectivesRel(
				(ProgdurationObjectivesRel)persistedModel);
	}

	@Override
	public BasePersistence<ProgdurationObjectivesRel> getBasePersistence() {
		return progdurationObjectivesRelPersistence;
	}
	...
	public List<ProgdurationObjectivesRel>
		...
		return progdurationObjectivesRelPersistence.findByUuid_C(
			uuid, companyId);
	}
	...
	public ProgdurationObjectivesRel
		...
		return progdurationObjectivesRelPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<ProgdurationObjectivesRel> getProgdurationObjectivesRels(
		...
		return progdurationObjectivesRelPersistence.findAll(start, end);
	}
	...
	public int getProgdurationObjectivesRelsCount() {
		return progdurationObjectivesRelPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProgdurationObjectivesRelLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		progdurationObjectivesRelLocalService =
			(ProgdurationObjectivesRelLocalService)aopProxy;

		_setLocalServiceUtilService(progdurationObjectivesRelLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProgdurationObjectivesRelLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				progdurationObjectivesRelPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				ProgdurationObjectivesRelLocalServiceUtil.class.
					getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, progdurationObjectivesRelLocalService);
		}
	...
	protected ProgdurationObjectivesRelLocalService
		progdurationObjectivesRelLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProgdurationObjectivesRelLocalServiceBaseImpl.class);
