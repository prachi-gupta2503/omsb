...
/**
 * Provides the base implementation for the competencies master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.CompetenciesMasterLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.CompetenciesMasterLocalServiceImpl
 * @generated
 */
public abstract class CompetenciesMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, CompetenciesMasterLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CompetenciesMasterLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>CompetenciesMasterLocalServiceUtil</code>.
	 */
	...
	public CompetenciesMaster addCompetenciesMaster(
		...
		return competenciesMasterPersistence.update(competenciesMaster);
	}
	...
	public CompetenciesMaster createCompetenciesMaster(
		...
		return competenciesMasterPersistence.create(competenciesMasterId);
	}
	...
	public CompetenciesMaster deleteCompetenciesMaster(
		...
		return competenciesMasterPersistence.remove(competenciesMasterId);
	}
	...
	public CompetenciesMaster deleteCompetenciesMaster(
		...
		return competenciesMasterPersistence.remove(competenciesMaster);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return competenciesMasterPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			CompetenciesMaster.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return competenciesMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return competenciesMasterPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return competenciesMasterPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public CompetenciesMaster fetchCompetenciesMaster(
		...
		return competenciesMasterPersistence.fetchByPrimaryKey(
	...
	public CompetenciesMaster fetchCompetenciesMasterByUuidAndGroupId(
		...
		return competenciesMasterPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public CompetenciesMaster getCompetenciesMaster(long competenciesMasterId)
		...
		return competenciesMasterPersistence.findByPrimaryKey(
			competenciesMasterId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			competenciesMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CompetenciesMaster.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(CompetenciesMaster.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod
				...
				@Override
				public void performAction(CompetenciesMaster competenciesMaster)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, competenciesMaster);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return competenciesMasterPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement CompetenciesMasterLocalServiceImpl#deleteCompetenciesMaster(CompetenciesMaster) to avoid orphaned data");
		}

		return competenciesMasterLocalService.deleteCompetenciesMaster(
			(CompetenciesMaster)persistedModel);
	}

	@Override
	public BasePersistence<CompetenciesMaster> getBasePersistence() {
		return competenciesMasterPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return competenciesMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<CompetenciesMaster> getCompetenciesMastersByUuidAndCompanyId(
		...
		return competenciesMasterPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<CompetenciesMaster> getCompetenciesMastersByUuidAndCompanyId(
		...
		return competenciesMasterPersistence.findByUuid_C(
	...
	public CompetenciesMaster getCompetenciesMasterByUuidAndGroupId(
		...
		return competenciesMasterPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<CompetenciesMaster> getCompetenciesMasters(int start, int end) {
		return competenciesMasterPersistence.findAll(start, end);
	}
	...
	public int getCompetenciesMastersCount() {
		return competenciesMasterPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CompetenciesMasterLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		competenciesMasterLocalService =
			(CompetenciesMasterLocalService)aopProxy;

		_setLocalServiceUtilService(competenciesMasterLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return CompetenciesMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				competenciesMasterPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				CompetenciesMasterLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, competenciesMasterLocalService);
		}
	...
	protected CompetenciesMasterLocalService competenciesMasterLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CompetenciesMasterLocalServiceBaseImpl.class);
