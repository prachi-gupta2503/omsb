...
import gov.omsb.tms.service.TraineeLevelMasterService;
import gov.omsb.tms.service.TraineeLevelMasterServiceUtil;
...
/**
 * Provides the base implementation for the trainee level master remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.TraineeLevelMasterServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.TraineeLevelMasterServiceImpl
 * @generated
 */
public abstract class TraineeLevelMasterServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, TraineeLevelMasterService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TraineeLevelMasterService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TraineeLevelMasterServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TraineeLevelMasterService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		traineeLevelMasterService = (TraineeLevelMasterService)aopProxy;

		_setServiceUtilService(traineeLevelMasterService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TraineeLevelMasterService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				traineeLevelMasterPersistence.getDataSource();
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = TraineeLevelMasterServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, traineeLevelMasterService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.TraineeLevelMasterLocalService
		traineeLevelMasterLocalService;

	protected TraineeLevelMasterService traineeLevelMasterService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TraineeLevelMasterServiceBaseImpl.class);
