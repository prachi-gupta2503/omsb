...
import gov.omsb.tms.service.EcMemberRequestStateService;
import gov.omsb.tms.service.EcMemberRequestStateServiceUtil;
...
/**
 * Provides the base implementation for the ec member request state remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.EcMemberRequestStateServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.EcMemberRequestStateServiceImpl
 * @generated
 */
public abstract class EcMemberRequestStateServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EcMemberRequestStateService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EcMemberRequestStateService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>EcMemberRequestStateServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EcMemberRequestStateService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		ecMemberRequestStateService = (EcMemberRequestStateService)aopProxy;

		_setServiceUtilService(ecMemberRequestStateService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return EcMemberRequestStateService.class.getName();
	}
	...
	private void _setServiceUtilService(
		EcMemberRequestStateService ecMemberRequestStateService) {

		try {
			Field field =
				EcMemberRequestStateServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, ecMemberRequestStateService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.EcMemberRequestStateLocalService
		ecMemberRequestStateLocalService;

	protected EcMemberRequestStateService ecMemberRequestStateService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EcMemberRequestStateServiceBaseImpl.class);
