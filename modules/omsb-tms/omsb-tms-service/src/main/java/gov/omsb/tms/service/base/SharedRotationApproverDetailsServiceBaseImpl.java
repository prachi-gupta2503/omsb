...
import gov.omsb.tms.service.SharedRotationApproverDetailsService;
import gov.omsb.tms.service.SharedRotationApproverDetailsServiceUtil;
...
/**
 * Provides the base implementation for the shared rotation approver details remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.SharedRotationApproverDetailsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.SharedRotationApproverDetailsServiceImpl
 * @generated
 */
public abstract class SharedRotationApproverDetailsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   SharedRotationApproverDetailsService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SharedRotationApproverDetailsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SharedRotationApproverDetailsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SharedRotationApproverDetailsService.class,
	...
	public void setAopProxy(Object aopProxy) {
		sharedRotationApproverDetailsService =
			(SharedRotationApproverDetailsService)aopProxy;

		_setServiceUtilService(sharedRotationApproverDetailsService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SharedRotationApproverDetailsService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				SharedRotationApproverDetailsServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, sharedRotationApproverDetailsService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.SharedRotationApproverDetailsLocalService
		sharedRotationApproverDetailsLocalService;

	protected SharedRotationApproverDetailsService
		sharedRotationApproverDetailsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SharedRotationApproverDetailsServiceBaseImpl.class);
