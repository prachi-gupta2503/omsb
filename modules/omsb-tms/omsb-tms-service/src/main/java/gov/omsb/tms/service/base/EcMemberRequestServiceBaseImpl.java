...
import gov.omsb.tms.service.EcMemberRequestService;
import gov.omsb.tms.service.EcMemberRequestServiceUtil;
...
/**
 * Provides the base implementation for the ec member request remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.EcMemberRequestServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.EcMemberRequestServiceImpl
 * @generated
 */
public abstract class EcMemberRequestServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EcMemberRequestService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EcMemberRequestService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>EcMemberRequestServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EcMemberRequestService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		ecMemberRequestService = (EcMemberRequestService)aopProxy;

		_setServiceUtilService(ecMemberRequestService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return EcMemberRequestService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = EcMemberRequestServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, ecMemberRequestService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.EcMemberRequestLocalService
		ecMemberRequestLocalService;

	protected EcMemberRequestService ecMemberRequestService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EcMemberRequestServiceBaseImpl.class);
