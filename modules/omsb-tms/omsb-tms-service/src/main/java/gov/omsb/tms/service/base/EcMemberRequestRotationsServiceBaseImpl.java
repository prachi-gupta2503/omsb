...
import gov.omsb.tms.service.EcMemberRequestRotationsService;
import gov.omsb.tms.service.EcMemberRequestRotationsServiceUtil;
...
/**
 * Provides the base implementation for the ec member request rotations remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.EcMemberRequestRotationsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.EcMemberRequestRotationsServiceImpl
 * @generated
 */
public abstract class EcMemberRequestRotationsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EcMemberRequestRotationsService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EcMemberRequestRotationsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>EcMemberRequestRotationsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EcMemberRequestRotationsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		ecMemberRequestRotationsService =
			(EcMemberRequestRotationsService)aopProxy;

		_setServiceUtilService(ecMemberRequestRotationsService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return EcMemberRequestRotationsService.class.getName();
	}
	...
	private void _setServiceUtilService(
		EcMemberRequestRotationsService ecMemberRequestRotationsService) {

		try {
			Field field =
				EcMemberRequestRotationsServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, ecMemberRequestRotationsService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.EcMemberRequestRotationsLocalService
		ecMemberRequestRotationsLocalService;

	protected EcMemberRequestRotationsService ecMemberRequestRotationsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EcMemberRequestRotationsServiceBaseImpl.class);
