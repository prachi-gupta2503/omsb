...
import gov.omsb.tms.service.LeaveMasterService;
import gov.omsb.tms.service.LeaveMasterServiceUtil;
...
/**
 * Provides the base implementation for the leave master remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.LeaveMasterServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.LeaveMasterServiceImpl
 * @generated
 */
public abstract class LeaveMasterServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, LeaveMasterService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LeaveMasterService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>LeaveMasterServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LeaveMasterService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		leaveMasterService = (LeaveMasterService)aopProxy;

		_setServiceUtilService(leaveMasterService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return LeaveMasterService.class.getName();
	}
	...
	private void _setServiceUtilService(LeaveMasterService leaveMasterService) {
		try {
			Field field = LeaveMasterServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, leaveMasterService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.LeaveMasterLocalService
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LeaveMasterServiceBaseImpl.class);
