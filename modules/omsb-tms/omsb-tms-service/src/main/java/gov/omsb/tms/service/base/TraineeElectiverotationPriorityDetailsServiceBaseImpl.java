...
import gov.omsb.tms.service.TraineeElectiverotationPriorityDetailsService;
import gov.omsb.tms.service.TraineeElectiverotationPriorityDetailsServiceUtil;
...
/**
 * Provides the base implementation for the trainee electiverotation priority details remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.TraineeElectiverotationPriorityDetailsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.TraineeElectiverotationPriorityDetailsServiceImpl
 * @generated
 */
public abstract class TraineeElectiverotationPriorityDetailsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   TraineeElectiverotationPriorityDetailsService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TraineeElectiverotationPriorityDetailsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TraineeElectiverotationPriorityDetailsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TraineeElectiverotationPriorityDetailsService.class,
	...
	public void setAopProxy(Object aopProxy) {
		traineeElectiverotationPriorityDetailsService =
			(TraineeElectiverotationPriorityDetailsService)aopProxy;

		_setServiceUtilService(traineeElectiverotationPriorityDetailsService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TraineeElectiverotationPriorityDetailsService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				TraineeElectiverotationPriorityDetailsServiceUtil.class.
					getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, traineeElectiverotationPriorityDetailsService);
		}
	...
	@Reference
	protected
		gov.omsb.tms.service.TraineeElectiverotationPriorityDetailsLocalService
			traineeElectiverotationPriorityDetailsLocalService;

	protected TraineeElectiverotationPriorityDetailsService
		traineeElectiverotationPriorityDetailsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TraineeElectiverotationPriorityDetailsServiceBaseImpl.class);
