...
/**
 * Provides the base implementation for the program type master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.ProgramTypeMasterLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.ProgramTypeMasterLocalServiceImpl
 * @generated
 */
public abstract class ProgramTypeMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   ProgramTypeMasterLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProgramTypeMasterLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProgramTypeMasterLocalServiceUtil</code>.
	 */
	...
	public ProgramTypeMaster addProgramTypeMaster(
		...
		return programTypeMasterPersistence.update(programTypeMaster);
	}
	...
	public ProgramTypeMaster createProgramTypeMaster(long programTypeMasterId) {
		return programTypeMasterPersistence.create(programTypeMasterId);
	}
	...
	public ProgramTypeMaster deleteProgramTypeMaster(long programTypeMasterId)
		...
		return programTypeMasterPersistence.remove(programTypeMasterId);
	}
	...
	public ProgramTypeMaster deleteProgramTypeMaster(
		...
		return programTypeMasterPersistence.remove(programTypeMaster);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return programTypeMasterPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ProgramTypeMaster.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return programTypeMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return programTypeMasterPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return programTypeMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return programTypeMasterPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public ProgramTypeMaster fetchProgramTypeMaster(long programTypeMasterId) {
		return programTypeMasterPersistence.fetchByPrimaryKey(
			programTypeMasterId);
	}
	...
	public ProgramTypeMaster fetchProgramTypeMasterByUuidAndGroupId(
		...
		return programTypeMasterPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public ProgramTypeMaster getProgramTypeMaster(long programTypeMasterId)
		...
		return programTypeMasterPersistence.findByPrimaryKey(
			programTypeMasterId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(ProgramTypeMaster.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("programTypeMasterId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(ProgramTypeMaster.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod
				...
				@Override
				public void performAction(ProgramTypeMaster programTypeMaster)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, programTypeMaster);
				}

			});
		exportActionableDynamicQuery.setStagedModelType(
			new StagedModelType(
				PortalUtil.getClassNameId(ProgramTypeMaster.class.getName())));
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return programTypeMasterPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ProgramTypeMasterLocalServiceImpl#deleteProgramTypeMaster(ProgramTypeMaster) to avoid orphaned data");
		}

		return programTypeMasterLocalService.deleteProgramTypeMaster(
			(ProgramTypeMaster)persistedModel);
	}

	@Override
	public BasePersistence<ProgramTypeMaster> getBasePersistence() {
		return programTypeMasterPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return programTypeMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ProgramTypeMaster> getProgramTypeMastersByUuidAndCompanyId(
		...
		return programTypeMasterPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<ProgramTypeMaster> getProgramTypeMastersByUuidAndCompanyId(
		...
		return programTypeMasterPersistence.findByUuid_C(
	...
	public ProgramTypeMaster getProgramTypeMasterByUuidAndGroupId(
		...
		return programTypeMasterPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<ProgramTypeMaster> getProgramTypeMasters(int start, int end) {
		return programTypeMasterPersistence.findAll(start, end);
	}
	...
	public int getProgramTypeMastersCount() {
		return programTypeMasterPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProgramTypeMasterLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		programTypeMasterLocalService = (ProgramTypeMasterLocalService)aopProxy;

		_setLocalServiceUtilService(programTypeMasterLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProgramTypeMasterLocalService.class.getName();
	}

	protected Class<?> getModelClass() {
		return ProgramTypeMaster.class;
	}

	protected String getModelClassName() {
		return ProgramTypeMaster.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				programTypeMasterPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				ProgramTypeMasterLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, programTypeMasterLocalService);
		}
	...
	protected ProgramTypeMasterLocalService programTypeMasterLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProgramTypeMasterLocalServiceBaseImpl.class);
