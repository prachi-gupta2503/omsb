...
import gov.omsb.tms.service.RotationMasterService;
import gov.omsb.tms.service.RotationMasterServiceUtil;
...
/**
 * Provides the base implementation for the rotation master remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.RotationMasterServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.RotationMasterServiceImpl
 * @generated
 */
public abstract class RotationMasterServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, RotationMasterService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RotationMasterService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>RotationMasterServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			RotationMasterService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		rotationMasterService = (RotationMasterService)aopProxy;

		_setServiceUtilService(rotationMasterService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return RotationMasterService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = rotationMasterPersistence.getDataSource();
	...
	private void _setServiceUtilService(
		RotationMasterService rotationMasterService) {

		try {
			Field field = RotationMasterServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, rotationMasterService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.RotationMasterLocalService
		rotationMasterLocalService;

	protected RotationMasterService rotationMasterService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RotationMasterServiceBaseImpl.class);
