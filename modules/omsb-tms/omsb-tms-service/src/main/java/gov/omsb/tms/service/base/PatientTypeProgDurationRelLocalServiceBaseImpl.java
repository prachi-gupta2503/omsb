...
/**
 * Provides the base implementation for the patient type prog duration rel local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.PatientTypeProgDurationRelLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.PatientTypeProgDurationRelLocalServiceImpl
 * @generated
 */
public abstract class PatientTypeProgDurationRelLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PatientTypeProgDurationRelLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PatientTypeProgDurationRelLocalServiceUtil</code>.
	 */
	...
	public PatientTypeProgDurationRel addPatientTypeProgDurationRel(
		...
		return patientTypeProgDurationRelPersistence.update(
	...
	public PatientTypeProgDurationRel createPatientTypeProgDurationRel(
		...
		return patientTypeProgDurationRelPersistence.create(
	...
	public PatientTypeProgDurationRel deletePatientTypeProgDurationRel(
		...
		return patientTypeProgDurationRelPersistence.remove(
			PatientTypeProgDurationRelId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return patientTypeProgDurationRelPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PatientTypeProgDurationRel.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return patientTypeProgDurationRelPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return patientTypeProgDurationRelPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public PatientTypeProgDurationRel fetchPatientTypeProgDurationRel(
		...
		return patientTypeProgDurationRelPersistence.fetchByPrimaryKey(
			PatientTypeProgDurationRelId);
	}
	...
	public PatientTypeProgDurationRel
		...
		return patientTypeProgDurationRelPersistence.fetchByUUID_G(
			uuid, groupId);
	}
	...
	public PatientTypeProgDurationRel getPatientTypeProgDurationRel(
		...
		return patientTypeProgDurationRelPersistence.findByPrimaryKey(
			PatientTypeProgDurationRelId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(PatientTypeProgDurationRel.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			PatientTypeProgDurationRel.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, patientTypeProgDurationRel);
				}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement PatientTypeProgDurationRelLocalServiceImpl#deletePatientTypeProgDurationRel(PatientTypeProgDurationRel) to avoid orphaned data");
		}

		return patientTypeProgDurationRelLocalService.
			deletePatientTypeProgDurationRel(
				(PatientTypeProgDurationRel)persistedModel);
	}

	@Override
	public BasePersistence<PatientTypeProgDurationRel> getBasePersistence() {
		return patientTypeProgDurationRelPersistence;
	}
	...
	public List<PatientTypeProgDurationRel>
		...
		return patientTypeProgDurationRelPersistence.findByUuid_C(
			uuid, companyId);
	}
	...
	public PatientTypeProgDurationRel
		...
		return patientTypeProgDurationRelPersistence.findByUUID_G(
			uuid, groupId);
	}
	...
	public List<PatientTypeProgDurationRel> getPatientTypeProgDurationRels(
		...
		return patientTypeProgDurationRelPersistence.findAll(start, end);
	}
	...
	public int getPatientTypeProgDurationRelsCount() {
		return patientTypeProgDurationRelPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PatientTypeProgDurationRelLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		patientTypeProgDurationRelLocalService =
			(PatientTypeProgDurationRelLocalService)aopProxy;

		_setLocalServiceUtilService(patientTypeProgDurationRelLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return PatientTypeProgDurationRelLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				patientTypeProgDurationRelPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				PatientTypeProgDurationRelLocalServiceUtil.class.
					getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, patientTypeProgDurationRelLocalService);
		}
	...
	protected PatientTypeProgDurationRelLocalService
		patientTypeProgDurationRelLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		PatientTypeProgDurationRelLocalServiceBaseImpl.class);
