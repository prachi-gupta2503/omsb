...
import gov.omsb.tms.service.ProcedureGroupMasterService;
import gov.omsb.tms.service.ProcedureGroupMasterServiceUtil;
...
/**
 * Provides the base implementation for the procedure group master remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.ProcedureGroupMasterServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.ProcedureGroupMasterServiceImpl
 * @generated
 */
public abstract class ProcedureGroupMasterServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   ProcedureGroupMasterService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProcedureGroupMasterService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProcedureGroupMasterServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProcedureGroupMasterService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		procedureGroupMasterService = (ProcedureGroupMasterService)aopProxy;

		_setServiceUtilService(procedureGroupMasterService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProcedureGroupMasterService.class.getName();
	}
	...
	private void _setServiceUtilService(
		ProcedureGroupMasterService procedureGroupMasterService) {

		try {
			Field field =
				ProcedureGroupMasterServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, procedureGroupMasterService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.ProcedureGroupMasterLocalService
		procedureGroupMasterLocalService;

	protected ProcedureGroupMasterService procedureGroupMasterService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProcedureGroupMasterServiceBaseImpl.class);
