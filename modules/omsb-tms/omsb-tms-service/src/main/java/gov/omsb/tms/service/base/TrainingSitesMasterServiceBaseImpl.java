...
import gov.omsb.tms.service.TrainingSitesMasterService;
import gov.omsb.tms.service.TrainingSitesMasterServiceUtil;
...
/**
 * Provides the base implementation for the training sites master remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.TrainingSitesMasterServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.TrainingSitesMasterServiceImpl
 * @generated
 */
public abstract class TrainingSitesMasterServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, TrainingSitesMasterService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TrainingSitesMasterService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TrainingSitesMasterServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TrainingSitesMasterService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		trainingSitesMasterService = (TrainingSitesMasterService)aopProxy;

		_setServiceUtilService(trainingSitesMasterService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TrainingSitesMasterService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = TrainingSitesMasterServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, trainingSitesMasterService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.TrainingSitesMasterLocalService
		trainingSitesMasterLocalService;

	protected TrainingSitesMasterService trainingSitesMasterService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TrainingSitesMasterServiceBaseImpl.class);
