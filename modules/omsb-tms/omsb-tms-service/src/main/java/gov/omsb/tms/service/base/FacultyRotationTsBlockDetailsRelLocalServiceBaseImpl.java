...
import gov.omsb.tms.service.FacultyRotationTsBlockDetailsRelLocalServiceUtil;
...
/**
 * Provides the base implementation for the faculty rotation ts block details rel local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.FacultyRotationTsBlockDetailsRelLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.FacultyRotationTsBlockDetailsRelLocalServiceImpl
 * @generated
 */
public abstract class FacultyRotationTsBlockDetailsRelLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, FacultyRotationTsBlockDetailsRelLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FacultyRotationTsBlockDetailsRelLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>FacultyRotationTsBlockDetailsRelLocalServiceUtil</code>.
	 */
	...
	@Override
	public FacultyRotationTsBlockDetailsRel addFacultyRotationTsBlockDetailsRel(
		FacultyRotationTsBlockDetailsRel facultyRotationTsBlockDetailsRel) {

		facultyRotationTsBlockDetailsRel.setNew(true);

		return facultyRotationTsBlockDetailsRelPersistence.update(
	...
	public FacultyRotationTsBlockDetailsRel
		...
		return facultyRotationTsBlockDetailsRelPersistence.create(
	...
	public FacultyRotationTsBlockDetailsRel
		...
		return facultyRotationTsBlockDetailsRelPersistence.remove(
			facultyRotationTsBlockDetailsRelId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return facultyRotationTsBlockDetailsRelPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			FacultyRotationTsBlockDetailsRel.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return facultyRotationTsBlockDetailsRelPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return facultyRotationTsBlockDetailsRelPersistence.
	...
	public FacultyRotationTsBlockDetailsRel
		...
		return facultyRotationTsBlockDetailsRelPersistence.fetchByPrimaryKey(
			facultyRotationTsBlockDetailsRelId);
	}
	...
	public FacultyRotationTsBlockDetailsRel
		...
		return facultyRotationTsBlockDetailsRelPersistence.fetchByUUID_G(
			uuid, groupId);
	}
	 ...
	 */
	@Override
	public FacultyRotationTsBlockDetailsRel getFacultyRotationTsBlockDetailsRel(
			long facultyRotationTsBlockDetailsRelId)
		throws PortalException {

		return facultyRotationTsBlockDetailsRelPersistence.findByPrimaryKey(
			facultyRotationTsBlockDetailsRelId);
	}
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, facultyRotationTsBlockDetailsRel);
				}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement FacultyRotationTsBlockDetailsRelLocalServiceImpl#deleteFacultyRotationTsBlockDetailsRel(FacultyRotationTsBlockDetailsRel) to avoid orphaned data");
		}

		return facultyRotationTsBlockDetailsRelLocalService.
			deleteFacultyRotationTsBlockDetailsRel(
				(FacultyRotationTsBlockDetailsRel)persistedModel);
	}

	@Override
	public BasePersistence<FacultyRotationTsBlockDetailsRel>
		getBasePersistence() {
	...
	public List<FacultyRotationTsBlockDetailsRel>
		...
		return facultyRotationTsBlockDetailsRelPersistence.findByUuid_C(
			uuid, companyId);
	}
	...
	public FacultyRotationTsBlockDetailsRel
		...
		return facultyRotationTsBlockDetailsRelPersistence.findByUUID_G(
			uuid, groupId);
	}
	...
	public List<FacultyRotationTsBlockDetailsRel>
		...
		return facultyRotationTsBlockDetailsRelPersistence.findAll(start, end);
	}
	...
	public int getFacultyRotationTsBlockDetailsRelsCount() {
		return facultyRotationTsBlockDetailsRelPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FacultyRotationTsBlockDetailsRelLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		facultyRotationTsBlockDetailsRelLocalService =
			(FacultyRotationTsBlockDetailsRelLocalService)aopProxy;
	...
	public String getOSGiServiceIdentifier() {
		return FacultyRotationTsBlockDetailsRelLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				facultyRotationTsBlockDetailsRelPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				FacultyRotationTsBlockDetailsRelLocalServiceUtil.class.
					getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, facultyRotationTsBlockDetailsRelLocalService);
		}
	...
	protected FacultyRotationTsBlockDetailsRelLocalService
		facultyRotationTsBlockDetailsRelLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FacultyRotationTsBlockDetailsRelLocalServiceBaseImpl.class);
