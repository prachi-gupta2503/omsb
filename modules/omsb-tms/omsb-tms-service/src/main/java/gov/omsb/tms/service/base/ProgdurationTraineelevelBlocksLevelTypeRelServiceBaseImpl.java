...
import gov.omsb.tms.service.ProgdurationTraineelevelBlocksLevelTypeRelService;
import gov.omsb.tms.service.ProgdurationTraineelevelBlocksLevelTypeRelServiceUtil;
...
/**
 * Provides the base implementation for the progduration traineelevel blocks level type rel remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.ProgdurationTraineelevelBlocksLevelTypeRelServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.ProgdurationTraineelevelBlocksLevelTypeRelServiceImpl
 * @generated
 */
public abstract class ProgdurationTraineelevelBlocksLevelTypeRelServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProgdurationTraineelevelBlocksLevelTypeRelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProgdurationTraineelevelBlocksLevelTypeRelServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProgdurationTraineelevelBlocksLevelTypeRelService.class,
	...
	public void setAopProxy(Object aopProxy) {
		progdurationTraineelevelBlocksLevelTypeRelService =
			(ProgdurationTraineelevelBlocksLevelTypeRelService)aopProxy;
	...
	public String getOSGiServiceIdentifier() {
		return ProgdurationTraineelevelBlocksLevelTypeRelService.class.
			getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				ProgdurationTraineelevelBlocksLevelTypeRelServiceUtil.class.
					getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, progdurationTraineelevelBlocksLevelTypeRelService);
		}
	...
	protected ProgdurationTraineelevelBlocksLevelTypeRelService
		progdurationTraineelevelBlocksLevelTypeRelService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProgdurationTraineelevelBlocksLevelTypeRelServiceBaseImpl.class);
