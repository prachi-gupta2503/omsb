...
/**
 * Provides the base implementation for the faculty type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.FacultyTypeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.FacultyTypeLocalServiceImpl
 * @generated
 */
public abstract class FacultyTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, FacultyTypeLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FacultyTypeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>FacultyTypeLocalServiceUtil</code>.
	 */
	...
	@Override
	public FacultyType addFacultyType(FacultyType facultyType) {
	...
	public FacultyType createFacultyType(long facultyTypeId) {
		return facultyTypePersistence.create(facultyTypeId);
	}
	...
	@Override
	public FacultyType deleteFacultyType(long facultyTypeId)
		throws PortalException {

		return facultyTypePersistence.remove(facultyTypeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public FacultyType deleteFacultyType(FacultyType facultyType) {
		return facultyTypePersistence.remove(facultyType);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return facultyTypePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			FacultyType.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return facultyTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return facultyTypePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return facultyTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return facultyTypePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public FacultyType fetchFacultyType(long facultyTypeId) {
		return facultyTypePersistence.fetchByPrimaryKey(facultyTypeId);
	}
	 ...
	 */
	@Override
	public FacultyType getFacultyType(long facultyTypeId)
		throws PortalException {

		return facultyTypePersistence.findByPrimaryKey(facultyTypeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(facultyTypeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(FacultyType.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("facultyTypeId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			facultyTypeLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(FacultyType.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return facultyTypePersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement FacultyTypeLocalServiceImpl#deleteFacultyType(FacultyType) to avoid orphaned data");
		}

		return facultyTypeLocalService.deleteFacultyType(
			(FacultyType)persistedModel);
	}

	@Override
	public BasePersistence<FacultyType> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return facultyTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FacultyType> getFacultyTypes(int start, int end) {
		return facultyTypePersistence.findAll(start, end);
	}
	...
	public int getFacultyTypesCount() {
		return facultyTypePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FacultyType updateFacultyType(FacultyType facultyType) {
		return facultyTypePersistence.update(facultyType);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FacultyTypeLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		facultyTypeLocalService = (FacultyTypeLocalService)aopProxy;

		_setLocalServiceUtilService(facultyTypeLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return FacultyTypeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = facultyTypePersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = FacultyTypeLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, facultyTypeLocalService);
		}
	...
	protected FacultyTypeLocalService facultyTypeLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FacultyTypeLocalServiceBaseImpl.class);
