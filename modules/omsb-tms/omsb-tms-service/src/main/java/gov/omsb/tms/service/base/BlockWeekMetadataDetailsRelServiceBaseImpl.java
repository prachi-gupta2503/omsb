...
import gov.omsb.tms.service.BlockWeekMetadataDetailsRelService;
import gov.omsb.tms.service.BlockWeekMetadataDetailsRelServiceUtil;
...
/**
 * Provides the base implementation for the block week metadata details rel remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.BlockWeekMetadataDetailsRelServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.BlockWeekMetadataDetailsRelServiceImpl
 * @generated
 */
public abstract class BlockWeekMetadataDetailsRelServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, BlockWeekMetadataDetailsRelService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BlockWeekMetadataDetailsRelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>BlockWeekMetadataDetailsRelServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BlockWeekMetadataDetailsRelService.class,
	...
	public void setAopProxy(Object aopProxy) {
		blockWeekMetadataDetailsRelService =
			(BlockWeekMetadataDetailsRelService)aopProxy;

		_setServiceUtilService(blockWeekMetadataDetailsRelService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return BlockWeekMetadataDetailsRelService.class.getName();
	}
	...
	private void _setServiceUtilService(
		BlockWeekMetadataDetailsRelService blockWeekMetadataDetailsRelService) {

		try {
			Field field =
				BlockWeekMetadataDetailsRelServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, blockWeekMetadataDetailsRelService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.BlockWeekMetadataDetailsRelLocalService
		blockWeekMetadataDetailsRelLocalService;

	protected BlockWeekMetadataDetailsRelService
		blockWeekMetadataDetailsRelService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		BlockWeekMetadataDetailsRelServiceBaseImpl.class);
