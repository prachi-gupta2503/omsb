...
import gov.omsb.tms.service.VisitTypeMasterService;
import gov.omsb.tms.service.VisitTypeMasterServiceUtil;
...
/**
 * Provides the base implementation for the visit type master remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.VisitTypeMasterServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.VisitTypeMasterServiceImpl
 * @generated
 */
public abstract class VisitTypeMasterServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, VisitTypeMasterService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>VisitTypeMasterService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>VisitTypeMasterServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			VisitTypeMasterService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		visitTypeMasterService = (VisitTypeMasterService)aopProxy;

		_setServiceUtilService(visitTypeMasterService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return VisitTypeMasterService.class.getName();
	}
	...
	private void _setServiceUtilService(
		VisitTypeMasterService visitTypeMasterService) {

		try {
			Field field = VisitTypeMasterServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, visitTypeMasterService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.VisitTypeMasterLocalService
		visitTypeMasterLocalService;

	protected VisitTypeMasterService visitTypeMasterService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		VisitTypeMasterServiceBaseImpl.class);
