...
import gov.omsb.tms.service.FacultyRequestService;
import gov.omsb.tms.service.FacultyRequestServiceUtil;
...
/**
 * Provides the base implementation for the faculty request remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.FacultyRequestServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.FacultyRequestServiceImpl
 * @generated
 */
public abstract class FacultyRequestServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FacultyRequestService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FacultyRequestService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>FacultyRequestServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FacultyRequestService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		facultyRequestService = (FacultyRequestService)aopProxy;

		_setServiceUtilService(facultyRequestService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return FacultyRequestService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = facultyRequestPersistence.getDataSource();
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = FacultyRequestServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, facultyRequestService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.FacultyRequestLocalService
		facultyRequestLocalService;

	protected FacultyRequestService facultyRequestService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FacultyRequestServiceBaseImpl.class);
