...
import gov.omsb.tms.service.LeaveAnnualMaxTraineeService;
import gov.omsb.tms.service.LeaveAnnualMaxTraineeServiceUtil;
...
/**
 * Provides the base implementation for the leave annual max trainee remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.LeaveAnnualMaxTraineeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.LeaveAnnualMaxTraineeServiceImpl
 * @generated
 */
public abstract class LeaveAnnualMaxTraineeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   LeaveAnnualMaxTraineeService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LeaveAnnualMaxTraineeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>LeaveAnnualMaxTraineeServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LeaveAnnualMaxTraineeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		leaveAnnualMaxTraineeService = (LeaveAnnualMaxTraineeService)aopProxy;

		_setServiceUtilService(leaveAnnualMaxTraineeService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return LeaveAnnualMaxTraineeService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				LeaveAnnualMaxTraineeServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, leaveAnnualMaxTraineeService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.LeaveAnnualMaxTraineeLocalService
		leaveAnnualMaxTraineeLocalService;

	protected LeaveAnnualMaxTraineeService leaveAnnualMaxTraineeService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LeaveAnnualMaxTraineeServiceBaseImpl.class);
