...
/**
 * Provides the base implementation for the duty types local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.DutyTypesLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.DutyTypesLocalServiceImpl
 * @generated
 */
public abstract class DutyTypesLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, DutyTypesLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DutyTypesLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DutyTypesLocalServiceUtil</code>.
	 */
	...
	@Override
	public DutyTypes addDutyTypes(DutyTypes dutyTypes) {
		dutyTypes.setNew(true);

		return dutyTypesPersistence.update(dutyTypes);
	}
	...
	public DutyTypes createDutyTypes(long dutyTypeId) {
		return dutyTypesPersistence.create(dutyTypeId);
	}
	...
	public DutyTypes deleteDutyTypes(long dutyTypeId) throws PortalException {
		return dutyTypesPersistence.remove(dutyTypeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DutyTypes deleteDutyTypes(DutyTypes dutyTypes) {
		return dutyTypesPersistence.remove(dutyTypes);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return dutyTypesPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			DutyTypes.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return dutyTypesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return dutyTypesPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return dutyTypesPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return dutyTypesPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public DutyTypes fetchDutyTypes(long dutyTypeId) {
		return dutyTypesPersistence.fetchByPrimaryKey(dutyTypeId);
	}
	 ...
	 */
	@Override
	public DutyTypes fetchDutyTypesByUuidAndGroupId(String uuid, long groupId) {
		return dutyTypesPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public DutyTypes getDutyTypes(long dutyTypeId) throws PortalException {
		return dutyTypesPersistence.findByPrimaryKey(dutyTypeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(dutyTypesLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DutyTypes.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("dutyTypeId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			dutyTypesLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(DutyTypes.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("dutyTypeId");
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<DutyTypes>() {

				@Override
				public void performAction(DutyTypes dutyTypes)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, dutyTypes);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return dutyTypesPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement DutyTypesLocalServiceImpl#deleteDutyTypes(DutyTypes) to avoid orphaned data");
		}

		return dutyTypesLocalService.deleteDutyTypes((DutyTypes)persistedModel);
	}

	@Override
	public BasePersistence<DutyTypes> getBasePersistence() {
		return dutyTypesPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return dutyTypesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DutyTypes> getDutyTypesesByUuidAndCompanyId(
		String uuid, long companyId) {

		return dutyTypesPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<DutyTypes> getDutyTypesesByUuidAndCompanyId(
		...
		return dutyTypesPersistence.findByUuid_C(
	 ...
	 */
	@Override
	public DutyTypes getDutyTypesByUuidAndGroupId(String uuid, long groupId)
		throws PortalException {

		return dutyTypesPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<DutyTypes> getDutyTypeses(int start, int end) {
		return dutyTypesPersistence.findAll(start, end);
	}
	...
	public int getDutyTypesesCount() {
		return dutyTypesPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DutyTypes updateDutyTypes(DutyTypes dutyTypes) {
		return dutyTypesPersistence.update(dutyTypes);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DutyTypesLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		dutyTypesLocalService = (DutyTypesLocalService)aopProxy;

		_setLocalServiceUtilService(dutyTypesLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DutyTypesLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = dutyTypesPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = DutyTypesLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, dutyTypesLocalService);
		}
	...
	protected DutyTypesLocalService dutyTypesLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DutyTypesLocalServiceBaseImpl.class);
