...
import gov.omsb.tms.service.BlocksMetadataDetailsRelService;
import gov.omsb.tms.service.BlocksMetadataDetailsRelServiceUtil;
...
/**
 * Provides the base implementation for the blocks metadata details rel remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.BlocksMetadataDetailsRelServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.BlocksMetadataDetailsRelServiceImpl
 * @generated
 */
public abstract class BlocksMetadataDetailsRelServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, BlocksMetadataDetailsRelService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BlocksMetadataDetailsRelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>BlocksMetadataDetailsRelServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BlocksMetadataDetailsRelService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		blocksMetadataDetailsRelService =
			(BlocksMetadataDetailsRelService)aopProxy;

		_setServiceUtilService(blocksMetadataDetailsRelService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return BlocksMetadataDetailsRelService.class.getName();
	}
	...
	private void _setServiceUtilService(
		BlocksMetadataDetailsRelService blocksMetadataDetailsRelService) {

		try {
			Field field =
				BlocksMetadataDetailsRelServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, blocksMetadataDetailsRelService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.BlocksMetadataDetailsRelLocalService
		blocksMetadataDetailsRelLocalService;

	protected BlocksMetadataDetailsRelService blocksMetadataDetailsRelService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		BlocksMetadataDetailsRelServiceBaseImpl.class);
