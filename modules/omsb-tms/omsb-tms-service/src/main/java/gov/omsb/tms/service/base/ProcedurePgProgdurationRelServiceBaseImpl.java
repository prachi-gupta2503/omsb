...
import gov.omsb.tms.service.ProcedurePgProgdurationRelService;
import gov.omsb.tms.service.ProcedurePgProgdurationRelServiceUtil;
...
/**
 * Provides the base implementation for the procedure pg progduration rel remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.ProcedurePgProgdurationRelServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.ProcedurePgProgdurationRelServiceImpl
 * @generated
 */
public abstract class ProcedurePgProgdurationRelServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   ProcedurePgProgdurationRelService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProcedurePgProgdurationRelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProcedurePgProgdurationRelServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProcedurePgProgdurationRelService.class,
	...
	public void setAopProxy(Object aopProxy) {
		procedurePgProgdurationRelService =
			(ProcedurePgProgdurationRelService)aopProxy;

		_setServiceUtilService(procedurePgProgdurationRelService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProcedurePgProgdurationRelService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				ProcedurePgProgdurationRelServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, procedurePgProgdurationRelService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.ProcedurePgProgdurationRelLocalService
		procedurePgProgdurationRelLocalService;

	protected ProcedurePgProgdurationRelService
		procedurePgProgdurationRelService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProcedurePgProgdurationRelServiceBaseImpl.class);
