...
import gov.omsb.tms.service.TraineeAdmissionDetailsRelService;
import gov.omsb.tms.service.TraineeAdmissionDetailsRelServiceUtil;
...
/**
 * Provides the base implementation for the trainee admission details rel remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.TraineeAdmissionDetailsRelServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.TraineeAdmissionDetailsRelServiceImpl
 * @generated
 */
public abstract class TraineeAdmissionDetailsRelServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TraineeAdmissionDetailsRelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TraineeAdmissionDetailsRelServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TraineeAdmissionDetailsRelService.class,
	...
	public void setAopProxy(Object aopProxy) {
		traineeAdmissionDetailsRelService =
			(TraineeAdmissionDetailsRelService)aopProxy;

		_setServiceUtilService(traineeAdmissionDetailsRelService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TraineeAdmissionDetailsRelService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				TraineeAdmissionDetailsRelServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, traineeAdmissionDetailsRelService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.TraineeAdmissionDetailsRelLocalService
		traineeAdmissionDetailsRelLocalService;

	protected TraineeAdmissionDetailsRelService
		traineeAdmissionDetailsRelService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TraineeAdmissionDetailsRelServiceBaseImpl.class);
