...
import gov.omsb.tms.service.TraineeSponsorDetailsService;
import gov.omsb.tms.service.TraineeSponsorDetailsServiceUtil;
...
/**
 * Provides the base implementation for the trainee sponsor details remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.TraineeSponsorDetailsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.TraineeSponsorDetailsServiceImpl
 * @generated
 */
public abstract class TraineeSponsorDetailsServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TraineeSponsorDetailsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TraineeSponsorDetailsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TraineeSponsorDetailsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		traineeSponsorDetailsService = (TraineeSponsorDetailsService)aopProxy;

		_setServiceUtilService(traineeSponsorDetailsService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TraineeSponsorDetailsService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				traineeSponsorDetailsPersistence.getDataSource();
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				TraineeSponsorDetailsServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, traineeSponsorDetailsService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.TraineeSponsorDetailsLocalService
		traineeSponsorDetailsLocalService;

	protected TraineeSponsorDetailsService traineeSponsorDetailsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TraineeSponsorDetailsServiceBaseImpl.class);
