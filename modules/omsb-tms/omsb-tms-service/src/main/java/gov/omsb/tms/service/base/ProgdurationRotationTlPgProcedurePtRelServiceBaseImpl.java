...
import gov.omsb.tms.service.ProgdurationRotationTlPgProcedurePtRelService;
import gov.omsb.tms.service.ProgdurationRotationTlPgProcedurePtRelServiceUtil;
...
/**
 * Provides the base implementation for the progduration rotation tl pg procedure pt rel remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.ProgdurationRotationTlPgProcedurePtRelServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.ProgdurationRotationTlPgProcedurePtRelServiceImpl
 * @generated
 */
public abstract class ProgdurationRotationTlPgProcedurePtRelServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProgdurationRotationTlPgProcedurePtRelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProgdurationRotationTlPgProcedurePtRelServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProgdurationRotationTlPgProcedurePtRelService.class,
	...
	public void setAopProxy(Object aopProxy) {
		progdurationRotationTlPgProcedurePtRelService =
			(ProgdurationRotationTlPgProcedurePtRelService)aopProxy;

		_setServiceUtilService(progdurationRotationTlPgProcedurePtRelService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProgdurationRotationTlPgProcedurePtRelService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				ProgdurationRotationTlPgProcedurePtRelServiceUtil.class.
					getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, progdurationRotationTlPgProcedurePtRelService);
		}
	...
	@Reference
	protected
		gov.omsb.tms.service.ProgdurationRotationTlPgProcedurePtRelLocalService
			progdurationRotationTlPgProcedurePtRelLocalService;

	protected ProgdurationRotationTlPgProcedurePtRelService
		progdurationRotationTlPgProcedurePtRelService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProgdurationRotationTlPgProcedurePtRelServiceBaseImpl.class);
