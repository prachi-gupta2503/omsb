...
import gov.omsb.tms.service.LeaveProgramMasterService;
import gov.omsb.tms.service.LeaveProgramMasterServiceUtil;
...
/**
 * Provides the base implementation for the leave program master remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.LeaveProgramMasterServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.LeaveProgramMasterServiceImpl
 * @generated
 */
public abstract class LeaveProgramMasterServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, LeaveProgramMasterService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LeaveProgramMasterService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>LeaveProgramMasterServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LeaveProgramMasterService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		leaveProgramMasterService = (LeaveProgramMasterService)aopProxy;

		_setServiceUtilService(leaveProgramMasterService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return LeaveProgramMasterService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = LeaveProgramMasterServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, leaveProgramMasterService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.LeaveProgramMasterLocalService
		leaveProgramMasterLocalService;

	protected LeaveProgramMasterService leaveProgramMasterService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LeaveProgramMasterServiceBaseImpl.class);
