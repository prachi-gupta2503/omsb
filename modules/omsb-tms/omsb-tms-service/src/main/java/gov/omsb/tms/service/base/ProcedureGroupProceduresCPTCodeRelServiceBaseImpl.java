...
import gov.omsb.tms.service.ProcedureGroupProceduresCPTCodeRelService;
import gov.omsb.tms.service.ProcedureGroupProceduresCPTCodeRelServiceUtil;
...
/**
 * Provides the base implementation for the procedure group procedures cpt code rel remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.ProcedureGroupProceduresCPTCodeRelServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.ProcedureGroupProceduresCPTCodeRelServiceImpl
 * @generated
 */
public abstract class ProcedureGroupProceduresCPTCodeRelServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProcedureGroupProceduresCPTCodeRelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProcedureGroupProceduresCPTCodeRelServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProcedureGroupProceduresCPTCodeRelService.class,
	...
	public void setAopProxy(Object aopProxy) {
		procedureGroupProceduresCPTCodeRelService =
			(ProcedureGroupProceduresCPTCodeRelService)aopProxy;

		_setServiceUtilService(procedureGroupProceduresCPTCodeRelService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProcedureGroupProceduresCPTCodeRelService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				ProcedureGroupProceduresCPTCodeRelServiceUtil.class.
					getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, procedureGroupProceduresCPTCodeRelService);
		}
	...
	@Reference
	protected
		gov.omsb.tms.service.ProcedureGroupProceduresCPTCodeRelLocalService
			procedureGroupProceduresCPTCodeRelLocalService;

	protected ProcedureGroupProceduresCPTCodeRelService
		procedureGroupProceduresCPTCodeRelService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProcedureGroupProceduresCPTCodeRelServiceBaseImpl.class);
