...
import gov.omsb.tms.service.LeaveAnnualRuleService;
import gov.omsb.tms.service.LeaveAnnualRuleServiceUtil;
...
/**
 * Provides the base implementation for the leave annual rule remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.LeaveAnnualRuleServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.LeaveAnnualRuleServiceImpl
 * @generated
 */
public abstract class LeaveAnnualRuleServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, LeaveAnnualRuleService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LeaveAnnualRuleService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>LeaveAnnualRuleServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LeaveAnnualRuleService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		leaveAnnualRuleService = (LeaveAnnualRuleService)aopProxy;

		_setServiceUtilService(leaveAnnualRuleService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return LeaveAnnualRuleService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = LeaveAnnualRuleServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, leaveAnnualRuleService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.LeaveAnnualRuleLocalService
		leaveAnnualRuleLocalService;

	protected LeaveAnnualRuleService leaveAnnualRuleService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LeaveAnnualRuleServiceBaseImpl.class);
