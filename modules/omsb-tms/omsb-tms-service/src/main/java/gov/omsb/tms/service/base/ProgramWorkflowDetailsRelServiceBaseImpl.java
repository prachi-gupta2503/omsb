...
import gov.omsb.tms.service.ProgramWorkflowDetailsRelService;
import gov.omsb.tms.service.ProgramWorkflowDetailsRelServiceUtil;
...
/**
 * Provides the base implementation for the program workflow details rel remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.ProgramWorkflowDetailsRelServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.ProgramWorkflowDetailsRelServiceImpl
 * @generated
 */
public abstract class ProgramWorkflowDetailsRelServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   ProgramWorkflowDetailsRelService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProgramWorkflowDetailsRelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProgramWorkflowDetailsRelServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProgramWorkflowDetailsRelService.class,
	...
	public void setAopProxy(Object aopProxy) {
		programWorkflowDetailsRelService =
			(ProgramWorkflowDetailsRelService)aopProxy;

		_setServiceUtilService(programWorkflowDetailsRelService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProgramWorkflowDetailsRelService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				ProgramWorkflowDetailsRelServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, programWorkflowDetailsRelService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.ProgramWorkflowDetailsRelLocalService
		programWorkflowDetailsRelLocalService;

	protected ProgramWorkflowDetailsRelService programWorkflowDetailsRelService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProgramWorkflowDetailsRelServiceBaseImpl.class);
