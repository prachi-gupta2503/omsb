...
import gov.omsb.tms.service.RotationCompetenciesRequirementsRelService;
import gov.omsb.tms.service.RotationCompetenciesRequirementsRelServiceUtil;
...
/**
 * Provides the base implementation for the rotation competencies requirements rel remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.RotationCompetenciesRequirementsRelServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.RotationCompetenciesRequirementsRelServiceImpl
 * @generated
 */
public abstract class RotationCompetenciesRequirementsRelServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   RotationCompetenciesRequirementsRelService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RotationCompetenciesRequirementsRelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>RotationCompetenciesRequirementsRelServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			RotationCompetenciesRequirementsRelService.class,
	...
	public void setAopProxy(Object aopProxy) {
		rotationCompetenciesRequirementsRelService =
			(RotationCompetenciesRequirementsRelService)aopProxy;

		_setServiceUtilService(rotationCompetenciesRequirementsRelService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return RotationCompetenciesRequirementsRelService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				RotationCompetenciesRequirementsRelServiceUtil.class.
					getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, rotationCompetenciesRequirementsRelService);
		}
	...
	@Reference
	protected
		gov.omsb.tms.service.RotationCompetenciesRequirementsRelLocalService
			rotationCompetenciesRequirementsRelLocalService;

	protected RotationCompetenciesRequirementsRelService
		rotationCompetenciesRequirementsRelService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RotationCompetenciesRequirementsRelServiceBaseImpl.class);
