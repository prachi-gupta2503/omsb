...
import gov.omsb.tms.service.RoleTypeMasterService;
import gov.omsb.tms.service.RoleTypeMasterServiceUtil;
...
/**
 * Provides the base implementation for the role type master remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.RoleTypeMasterServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.RoleTypeMasterServiceImpl
 * @generated
 */
public abstract class RoleTypeMasterServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, RoleTypeMasterService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RoleTypeMasterService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>RoleTypeMasterServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			RoleTypeMasterService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		roleTypeMasterService = (RoleTypeMasterService)aopProxy;

		_setServiceUtilService(roleTypeMasterService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return RoleTypeMasterService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = RoleTypeMasterServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, roleTypeMasterService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.RoleTypeMasterLocalService
		roleTypeMasterLocalService;

	protected RoleTypeMasterService roleTypeMasterService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RoleTypeMasterServiceBaseImpl.class);
