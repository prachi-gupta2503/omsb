...
import gov.omsb.tms.service.OmsbTmsFinderLocalService;
...
/**
 * Provides the base implementation for the omsb tms finder local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.OmsbTmsFinderLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.OmsbTmsFinderLocalServiceImpl
 * @generated
 */
public abstract class OmsbTmsFinderLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, OmsbTmsFinderLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OmsbTmsFinderLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>OmsbTmsFinderLocalServiceUtil</code>.
	 */
	...
	@Override
	public OmsbTmsFinder addOmsbTmsFinder(OmsbTmsFinder omsbTmsFinder) {
		omsbTmsFinder.setNew(true);

		return omsbTmsFinderPersistence.update(omsbTmsFinder);
	}
	...
	public OmsbTmsFinder createOmsbTmsFinder(long omsbTmsFinderId) {
		return omsbTmsFinderPersistence.create(omsbTmsFinderId);
	}
	...
	@Override
	public OmsbTmsFinder deleteOmsbTmsFinder(long omsbTmsFinderId)
		throws PortalException {

		return omsbTmsFinderPersistence.remove(omsbTmsFinderId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public OmsbTmsFinder deleteOmsbTmsFinder(OmsbTmsFinder omsbTmsFinder) {
		return omsbTmsFinderPersistence.remove(omsbTmsFinder);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return omsbTmsFinderPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			OmsbTmsFinder.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return omsbTmsFinderPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return omsbTmsFinderPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return omsbTmsFinderPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return omsbTmsFinderPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public OmsbTmsFinder fetchOmsbTmsFinder(long omsbTmsFinderId) {
		return omsbTmsFinderPersistence.fetchByPrimaryKey(omsbTmsFinderId);
	}
	 ...
	 */
	@Override
	public OmsbTmsFinder fetchOmsbTmsFinderByUuidAndGroupId(
		String uuid, long groupId) {

		return omsbTmsFinderPersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public OmsbTmsFinder getOmsbTmsFinder(long omsbTmsFinderId)
		throws PortalException {

		return omsbTmsFinderPersistence.findByPrimaryKey(omsbTmsFinderId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(omsbTmsFinderLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(OmsbTmsFinder.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("omsbTmsFinderId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			omsbTmsFinderLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(OmsbTmsFinder.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<OmsbTmsFinder>() {

				@Override
				public void performAction(OmsbTmsFinder omsbTmsFinder)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, omsbTmsFinder);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return omsbTmsFinderPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement OmsbTmsFinderLocalServiceImpl#deleteOmsbTmsFinder(OmsbTmsFinder) to avoid orphaned data");
		}

		return omsbTmsFinderLocalService.deleteOmsbTmsFinder(
			(OmsbTmsFinder)persistedModel);
	}

	@Override
	public BasePersistence<OmsbTmsFinder> getBasePersistence() {
		return omsbTmsFinderPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return omsbTmsFinderPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<OmsbTmsFinder> getOmsbTmsFindersByUuidAndCompanyId(
		String uuid, long companyId) {

		return omsbTmsFinderPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<OmsbTmsFinder> getOmsbTmsFindersByUuidAndCompanyId(
		...
		return omsbTmsFinderPersistence.findByUuid_C(
	 ...
	 */
	@Override
	public OmsbTmsFinder getOmsbTmsFinderByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return omsbTmsFinderPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<OmsbTmsFinder> getOmsbTmsFinders(int start, int end) {
		return omsbTmsFinderPersistence.findAll(start, end);
	}
	...
	public int getOmsbTmsFindersCount() {
		return omsbTmsFinderPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public OmsbTmsFinder updateOmsbTmsFinder(OmsbTmsFinder omsbTmsFinder) {
		return omsbTmsFinderPersistence.update(omsbTmsFinder);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			OmsbTmsFinderLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		omsbTmsFinderLocalService = (OmsbTmsFinderLocalService)aopProxy;

		_setLocalServiceUtilService(omsbTmsFinderLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return OmsbTmsFinderLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = omsbTmsFinderPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = OmsbTmsFinderLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, omsbTmsFinderLocalService);
		}
	...
	protected OmsbTmsFinderLocalService omsbTmsFinderLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OmsbTmsFinderLocalServiceBaseImpl.class);
