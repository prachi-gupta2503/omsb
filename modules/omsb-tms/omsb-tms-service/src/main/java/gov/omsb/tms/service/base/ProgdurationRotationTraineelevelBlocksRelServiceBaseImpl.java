...
import gov.omsb.tms.service.ProgdurationRotationTraineelevelBlocksRelService;
import gov.omsb.tms.service.ProgdurationRotationTraineelevelBlocksRelServiceUtil;
...
/**
 * Provides the base implementation for the progduration rotation traineelevel blocks rel remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.ProgdurationRotationTraineelevelBlocksRelServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.ProgdurationRotationTraineelevelBlocksRelServiceImpl
 * @generated
 */
public abstract class ProgdurationRotationTraineelevelBlocksRelServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   ProgdurationRotationTraineelevelBlocksRelService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProgdurationRotationTraineelevelBlocksRelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProgdurationRotationTraineelevelBlocksRelServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProgdurationRotationTraineelevelBlocksRelService.class,
	...
	public void setAopProxy(Object aopProxy) {
		progdurationRotationTraineelevelBlocksRelService =
			(ProgdurationRotationTraineelevelBlocksRelService)aopProxy;
	...
	public String getOSGiServiceIdentifier() {
		return ProgdurationRotationTraineelevelBlocksRelService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				ProgdurationRotationTraineelevelBlocksRelServiceUtil.class.
					getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, progdurationRotationTraineelevelBlocksRelService);
		}
	...
	@Reference
	protected
		gov.omsb.tms.service.
			ProgdurationRotationTraineelevelBlocksRelLocalService
				progdurationRotationTraineelevelBlocksRelLocalService;

	protected ProgdurationRotationTraineelevelBlocksRelService
		progdurationRotationTraineelevelBlocksRelService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProgdurationRotationTraineelevelBlocksRelServiceBaseImpl.class);
