...
import gov.omsb.tms.service.ProgramProgramTypeRelLocalService;
...
/**
 * Provides the base implementation for the program program type rel local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.ProgramProgramTypeRelLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.ProgramProgramTypeRelLocalServiceImpl
 * @generated
 */
public abstract class ProgramProgramTypeRelLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   ProgramProgramTypeRelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProgramProgramTypeRelLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProgramProgramTypeRelLocalServiceUtil</code>.
	 */
	...
	@Override
	public ProgramProgramTypeRel addProgramProgramTypeRel(
		ProgramProgramTypeRel programProgramTypeRel) {

		programProgramTypeRel.setNew(true);

		return programProgramTypeRelPersistence.update(programProgramTypeRel);
	}
	...
	public ProgramProgramTypeRel createProgramProgramTypeRel(long programPtId) {
		return programProgramTypeRelPersistence.create(programPtId);
	}
	...
	@Override
	public ProgramProgramTypeRel deleteProgramProgramTypeRel(long programPtId)
		throws PortalException {

		return programProgramTypeRelPersistence.remove(programPtId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ProgramProgramTypeRel deleteProgramProgramTypeRel(
		ProgramProgramTypeRel programProgramTypeRel) {

		return programProgramTypeRelPersistence.remove(programProgramTypeRel);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return programProgramTypeRelPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ProgramProgramTypeRel.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return programProgramTypeRelPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return programProgramTypeRelPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public ProgramProgramTypeRel fetchProgramProgramTypeRel(long programPtId) {
		return programProgramTypeRelPersistence.fetchByPrimaryKey(programPtId);
	}
	 ...
	 */
	@Override
	public ProgramProgramTypeRel fetchProgramProgramTypeRelByUuidAndGroupId(
		String uuid, long groupId) {

		return programProgramTypeRelPersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public ProgramProgramTypeRel getProgramProgramTypeRel(long programPtId)
		throws PortalException {

		return programProgramTypeRelPersistence.findByPrimaryKey(programPtId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(ProgramProgramTypeRel.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("programPtId");
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, programProgramTypeRel);
				}
		...
		exportActionableDynamicQuery.setStagedModelType(
			new StagedModelType(
				PortalUtil.getClassNameId(
					ProgramProgramTypeRel.class.getName())));
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return programProgramTypeRelPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ProgramProgramTypeRelLocalServiceImpl#deleteProgramProgramTypeRel(ProgramProgramTypeRel) to avoid orphaned data");
		}

		return programProgramTypeRelLocalService.deleteProgramProgramTypeRel(
			(ProgramProgramTypeRel)persistedModel);
	}

	@Override
	public BasePersistence<ProgramProgramTypeRel> getBasePersistence() {
		return programProgramTypeRelPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return programProgramTypeRelPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ProgramProgramTypeRel>
		getProgramProgramTypeRelsByUuidAndCompanyId(
			String uuid, long companyId) {

		return programProgramTypeRelPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<ProgramProgramTypeRel>
		...
		return programProgramTypeRelPersistence.findByUuid_C(
	 ...
	 */
	@Override
	public ProgramProgramTypeRel getProgramProgramTypeRelByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return programProgramTypeRelPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<ProgramProgramTypeRel> getProgramProgramTypeRels(
		int start, int end) {

		return programProgramTypeRelPersistence.findAll(start, end);
	}
	...
	public int getProgramProgramTypeRelsCount() {
		return programProgramTypeRelPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ProgramProgramTypeRel updateProgramProgramTypeRel(
		ProgramProgramTypeRel programProgramTypeRel) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProgramProgramTypeRelLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		programProgramTypeRelLocalService =
			(ProgramProgramTypeRelLocalService)aopProxy;

		_setLocalServiceUtilService(programProgramTypeRelLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProgramProgramTypeRelLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				programProgramTypeRelPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				ProgramProgramTypeRelLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, programProgramTypeRelLocalService);
		}
	...
	protected ProgramProgramTypeRelLocalService
		programProgramTypeRelLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProgramProgramTypeRelLocalServiceBaseImpl.class);
