...
import gov.omsb.tms.service.RoleTypeMasterLocalServiceUtil;
...
/**
 * Provides the base implementation for the role type master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.RoleTypeMasterLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.RoleTypeMasterLocalServiceImpl
 * @generated
 */
public abstract class RoleTypeMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, RoleTypeMasterLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RoleTypeMasterLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>RoleTypeMasterLocalServiceUtil</code>.
	 */
	...
	public RoleTypeMaster addRoleTypeMaster(RoleTypeMaster roleTypeMaster) {
		...
		return roleTypeMasterPersistence.update(roleTypeMaster);
	}
	...
	public RoleTypeMaster createRoleTypeMaster(long roleTypeMasterId) {
		return roleTypeMasterPersistence.create(roleTypeMasterId);
	}
	...
	public RoleTypeMaster deleteRoleTypeMaster(long roleTypeMasterId)
		...
		return roleTypeMasterPersistence.remove(roleTypeMasterId);
	}
	...
	public RoleTypeMaster deleteRoleTypeMaster(RoleTypeMaster roleTypeMaster) {
		return roleTypeMasterPersistence.remove(roleTypeMaster);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return roleTypeMasterPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			RoleTypeMaster.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return roleTypeMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return roleTypeMasterPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return roleTypeMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return roleTypeMasterPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public RoleTypeMaster fetchRoleTypeMaster(long roleTypeMasterId) {
		return roleTypeMasterPersistence.fetchByPrimaryKey(roleTypeMasterId);
	}
	...
	public RoleTypeMaster fetchRoleTypeMasterByUuidAndGroupId(
		...
		return roleTypeMasterPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public RoleTypeMaster getRoleTypeMaster(long roleTypeMasterId)
		...
		return roleTypeMasterPersistence.findByPrimaryKey(roleTypeMasterId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(roleTypeMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(RoleTypeMaster.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("roleTypeMasterId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			roleTypeMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(RoleTypeMaster.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<RoleTypeMaster>() {

				@Override
				public void performAction(RoleTypeMaster roleTypeMaster)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, roleTypeMaster);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return roleTypeMasterPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement RoleTypeMasterLocalServiceImpl#deleteRoleTypeMaster(RoleTypeMaster) to avoid orphaned data");
		}

		return roleTypeMasterLocalService.deleteRoleTypeMaster(
			(RoleTypeMaster)persistedModel);
	}

	@Override
	public BasePersistence<RoleTypeMaster> getBasePersistence() {
		return roleTypeMasterPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return roleTypeMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<RoleTypeMaster> getRoleTypeMastersByUuidAndCompanyId(
		...
		return roleTypeMasterPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<RoleTypeMaster> getRoleTypeMastersByUuidAndCompanyId(
		...
		return roleTypeMasterPersistence.findByUuid_C(
	...
	public RoleTypeMaster getRoleTypeMasterByUuidAndGroupId(
		...
		return roleTypeMasterPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<RoleTypeMaster> getRoleTypeMasters(int start, int end) {
		return roleTypeMasterPersistence.findAll(start, end);
	}
	...
	public int getRoleTypeMastersCount() {
		return roleTypeMasterPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			RoleTypeMasterLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		roleTypeMasterLocalService = (RoleTypeMasterLocalService)aopProxy;

		_setLocalServiceUtilService(roleTypeMasterLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return RoleTypeMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = roleTypeMasterPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = RoleTypeMasterLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, roleTypeMasterLocalService);
		}
	...
	protected RoleTypeMasterLocalService roleTypeMasterLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RoleTypeMasterLocalServiceBaseImpl.class);
