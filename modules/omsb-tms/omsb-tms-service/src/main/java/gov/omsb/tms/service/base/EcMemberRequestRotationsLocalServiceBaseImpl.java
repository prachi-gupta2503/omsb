...
/**
 * Provides the base implementation for the ec member request rotations local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.EcMemberRequestRotationsLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.EcMemberRequestRotationsLocalServiceImpl
 * @generated
 */
public abstract class EcMemberRequestRotationsLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EcMemberRequestRotationsLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EcMemberRequestRotationsLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>EcMemberRequestRotationsLocalServiceUtil</code>.
	 */
	...
	public EcMemberRequestRotations addEcMemberRequestRotations(
		...
		return ecMemberRequestRotationsPersistence.update(
	...
	public EcMemberRequestRotations createEcMemberRequestRotations(
		...
		return ecMemberRequestRotationsPersistence.create(
	...
	public EcMemberRequestRotations deleteEcMemberRequestRotations(
		...
		return ecMemberRequestRotationsPersistence.remove(
			ecMemberRequestRotationsId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return ecMemberRequestRotationsPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EcMemberRequestRotations.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ecMemberRequestRotationsPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ecMemberRequestRotationsPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public EcMemberRequestRotations fetchEcMemberRequestRotations(
		...
		return ecMemberRequestRotationsPersistence.fetchByPrimaryKey(
			ecMemberRequestRotationsId);
	}
	...
	public EcMemberRequestRotations
		...
		return ecMemberRequestRotationsPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public EcMemberRequestRotations getEcMemberRequestRotations(
		...
		return ecMemberRequestRotationsPersistence.findByPrimaryKey(
			ecMemberRequestRotationsId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(EcMemberRequestRotations.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			EcMemberRequestRotations.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, ecMemberRequestRotations);
				}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement EcMemberRequestRotationsLocalServiceImpl#deleteEcMemberRequestRotations(EcMemberRequestRotations) to avoid orphaned data");
		}

		return ecMemberRequestRotationsLocalService.
			deleteEcMemberRequestRotations(
				(EcMemberRequestRotations)persistedModel);
	}

	@Override
	public BasePersistence<EcMemberRequestRotations> getBasePersistence() {
		return ecMemberRequestRotationsPersistence;
	}
	...
	public List<EcMemberRequestRotations>
		...
		return ecMemberRequestRotationsPersistence.findByUuid_C(
			uuid, companyId);
	}
	...
	public EcMemberRequestRotations getEcMemberRequestRotationsByUuidAndGroupId(
		...
		return ecMemberRequestRotationsPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<EcMemberRequestRotations> getEcMemberRequestRotationses(
		...
		return ecMemberRequestRotationsPersistence.findAll(start, end);
	}
	...
	public int getEcMemberRequestRotationsesCount() {
		return ecMemberRequestRotationsPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EcMemberRequestRotationsLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		ecMemberRequestRotationsLocalService =
			(EcMemberRequestRotationsLocalService)aopProxy;

		_setLocalServiceUtilService(ecMemberRequestRotationsLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return EcMemberRequestRotationsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				ecMemberRequestRotationsPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				EcMemberRequestRotationsLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, ecMemberRequestRotationsLocalService);
		}
	...
	protected EcMemberRequestRotationsLocalService
		ecMemberRequestRotationsLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EcMemberRequestRotationsLocalServiceBaseImpl.class);
