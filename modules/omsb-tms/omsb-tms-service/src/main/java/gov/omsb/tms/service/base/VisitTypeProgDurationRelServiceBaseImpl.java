...
import gov.omsb.tms.service.VisitTypeProgDurationRelService;
import gov.omsb.tms.service.VisitTypeProgDurationRelServiceUtil;
...
/**
 * Provides the base implementation for the visit type prog duration rel remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.VisitTypeProgDurationRelServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.VisitTypeProgDurationRelServiceImpl
 * @generated
 */
public abstract class VisitTypeProgDurationRelServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>VisitTypeProgDurationRelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>VisitTypeProgDurationRelServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			VisitTypeProgDurationRelService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		visitTypeProgDurationRelService =
			(VisitTypeProgDurationRelService)aopProxy;

		_setServiceUtilService(visitTypeProgDurationRelService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return VisitTypeProgDurationRelService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				VisitTypeProgDurationRelServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, visitTypeProgDurationRelService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.VisitTypeProgDurationRelLocalService
		visitTypeProgDurationRelLocalService;

	protected VisitTypeProgDurationRelService visitTypeProgDurationRelService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		VisitTypeProgDurationRelServiceBaseImpl.class);
