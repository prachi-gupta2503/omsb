...
/**
 * Provides the base implementation for the trainee progduration traineelevel details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.TraineeProgdurationTraineelevelDetailsLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.TraineeProgdurationTraineelevelDetailsLocalServiceImpl
 * @generated
 */
public abstract class TraineeProgdurationTraineelevelDetailsLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TraineeProgdurationTraineelevelDetailsLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TraineeProgdurationTraineelevelDetailsLocalServiceUtil</code>.
	 */
	...
	public TraineeProgdurationTraineelevelDetails
		...
		return traineeProgdurationTraineelevelDetailsPersistence.update(
			traineeProgdurationTraineelevelDetails);
	}
	...
	public TraineeProgdurationTraineelevelDetails
		...
		return traineeProgdurationTraineelevelDetailsPersistence.create(
	...
	public TraineeProgdurationTraineelevelDetails
		...
		return traineeProgdurationTraineelevelDetailsPersistence.remove(
			traineePdTlErDetailsId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return traineeProgdurationTraineelevelDetailsPersistence.dslQuery(
			dslQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return traineeProgdurationTraineelevelDetailsPersistence.
	...
	public TraineeProgdurationTraineelevelDetails
		...
		return traineeProgdurationTraineelevelDetailsPersistence.
			fetchByPrimaryKey(traineePdTlErDetailsId);
	}
	...
	public TraineeProgdurationTraineelevelDetails
		...
		return traineeProgdurationTraineelevelDetailsPersistence.fetchByUUID_G(
			uuid, groupId);
	}
	...
	public TraineeProgdurationTraineelevelDetails
		...
		return traineeProgdurationTraineelevelDetailsPersistence.
			findByPrimaryKey(traineePdTlErDetailsId);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TraineeProgdurationTraineelevelDetailsLocalServiceImpl#deleteTraineeProgdurationTraineelevelDetails(TraineeProgdurationTraineelevelDetails) to avoid orphaned data");
		}

		return traineeProgdurationTraineelevelDetailsLocalService.
			deleteTraineeProgdurationTraineelevelDetails(
				(TraineeProgdurationTraineelevelDetails)persistedModel);
	}

	@Override
	public BasePersistence<TraineeProgdurationTraineelevelDetails>
		getBasePersistence() {
	...
	public List<TraineeProgdurationTraineelevelDetails>
		...
		return traineeProgdurationTraineelevelDetailsPersistence.findByUuid_C(
			uuid, companyId);
	}
	...
	public TraineeProgdurationTraineelevelDetails
		...
		return traineeProgdurationTraineelevelDetailsPersistence.findByUUID_G(
			uuid, groupId);
	}
	...
	public List<TraineeProgdurationTraineelevelDetails>
		...
		return traineeProgdurationTraineelevelDetailsPersistence.findAll(
			start, end);
	}
	...
	public int getTraineeProgdurationTraineelevelDetailsesCount() {
		return traineeProgdurationTraineelevelDetailsPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TraineeProgdurationTraineelevelDetailsLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		traineeProgdurationTraineelevelDetailsLocalService =
			(TraineeProgdurationTraineelevelDetailsLocalService)aopProxy;
	...
	public String getOSGiServiceIdentifier() {
		return TraineeProgdurationTraineelevelDetailsLocalService.class.
			getName();
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				TraineeProgdurationTraineelevelDetailsLocalServiceUtil.class.
					getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, traineeProgdurationTraineelevelDetailsLocalService);
		}
	...
	protected TraineeProgdurationTraineelevelDetailsLocalService
		traineeProgdurationTraineelevelDetailsLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TraineeProgdurationTraineelevelDetailsLocalServiceBaseImpl.class);
