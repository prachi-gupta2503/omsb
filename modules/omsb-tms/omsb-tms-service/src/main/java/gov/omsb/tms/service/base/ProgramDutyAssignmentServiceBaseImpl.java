...
import gov.omsb.tms.service.ProgramDutyAssignmentService;
...
/**
 * Provides the base implementation for the program duty assignment remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.ProgramDutyAssignmentServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.ProgramDutyAssignmentServiceImpl
 * @generated
 */
public abstract class ProgramDutyAssignmentServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   ProgramDutyAssignmentService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProgramDutyAssignmentService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProgramDutyAssignmentServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProgramDutyAssignmentService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		programDutyAssignmentService = (ProgramDutyAssignmentService)aopProxy;

		_setServiceUtilService(programDutyAssignmentService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProgramDutyAssignmentService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				ProgramDutyAssignmentServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, programDutyAssignmentService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.ProgramDutyAssignmentLocalService
		programDutyAssignmentLocalService;

	protected ProgramDutyAssignmentService programDutyAssignmentService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProgramDutyAssignmentServiceBaseImpl.class);
