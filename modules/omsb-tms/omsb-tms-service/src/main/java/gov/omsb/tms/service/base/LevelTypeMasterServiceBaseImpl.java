...
import gov.omsb.tms.service.LevelTypeMasterService;
import gov.omsb.tms.service.LevelTypeMasterServiceUtil;
...
/**
 * Provides the base implementation for the level type master remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.LevelTypeMasterServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.LevelTypeMasterServiceImpl
 * @generated
 */
public abstract class LevelTypeMasterServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, LevelTypeMasterService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LevelTypeMasterService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>LevelTypeMasterServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LevelTypeMasterService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		levelTypeMasterService = (LevelTypeMasterService)aopProxy;

		_setServiceUtilService(levelTypeMasterService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return LevelTypeMasterService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = LevelTypeMasterServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, levelTypeMasterService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.LevelTypeMasterLocalService
		levelTypeMasterLocalService;

	protected LevelTypeMasterService levelTypeMasterService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LevelTypeMasterServiceBaseImpl.class);
