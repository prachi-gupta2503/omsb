...
import gov.omsb.tms.service.FacultyRequestStatusService;
import gov.omsb.tms.service.FacultyRequestStatusServiceUtil;
...
/**
 * Provides the base implementation for the faculty request status remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.FacultyRequestStatusServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.FacultyRequestStatusServiceImpl
 * @generated
 */
public abstract class FacultyRequestStatusServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FacultyRequestStatusService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FacultyRequestStatusService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>FacultyRequestStatusServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FacultyRequestStatusService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		facultyRequestStatusService = (FacultyRequestStatusService)aopProxy;

		_setServiceUtilService(facultyRequestStatusService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return FacultyRequestStatusService.class.getName();
	}
	...
	private void _setServiceUtilService(
		FacultyRequestStatusService facultyRequestStatusService) {

		try {
			Field field =
				FacultyRequestStatusServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, facultyRequestStatusService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.FacultyRequestStatusLocalService
		facultyRequestStatusLocalService;

	protected FacultyRequestStatusService facultyRequestStatusService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FacultyRequestStatusServiceBaseImpl.class);
