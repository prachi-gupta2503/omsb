...
/**
 * Provides the base implementation for the blocks metadata details rel local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.BlocksMetadataDetailsRelLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.BlocksMetadataDetailsRelLocalServiceImpl
 * @generated
 */
public abstract class BlocksMetadataDetailsRelLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, BlocksMetadataDetailsRelLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BlocksMetadataDetailsRelLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>BlocksMetadataDetailsRelLocalServiceUtil</code>.
	 */
	...
	public BlocksMetadataDetailsRel addBlocksMetadataDetailsRel(
		...
		return blocksMetadataDetailsRelPersistence.update(
	...
	public BlocksMetadataDetailsRel createBlocksMetadataDetailsRel(
		...
		return blocksMetadataDetailsRelPersistence.create(
	...
	public BlocksMetadataDetailsRel deleteBlocksMetadataDetailsRel(
		...
		return blocksMetadataDetailsRelPersistence.remove(
			blocksMetadataDetailsRelId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return blocksMetadataDetailsRelPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			BlocksMetadataDetailsRel.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return blocksMetadataDetailsRelPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return blocksMetadataDetailsRelPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public BlocksMetadataDetailsRel fetchBlocksMetadataDetailsRel(
		...
		return blocksMetadataDetailsRelPersistence.fetchByPrimaryKey(
			blocksMetadataDetailsRelId);
	}
	...
	public BlocksMetadataDetailsRel
		...
		return blocksMetadataDetailsRelPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public BlocksMetadataDetailsRel getBlocksMetadataDetailsRel(
		...
		return blocksMetadataDetailsRelPersistence.findByPrimaryKey(
			blocksMetadataDetailsRelId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(BlocksMetadataDetailsRel.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			BlocksMetadataDetailsRel.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, blocksMetadataDetailsRel);
				}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement BlocksMetadataDetailsRelLocalServiceImpl#deleteBlocksMetadataDetailsRel(BlocksMetadataDetailsRel) to avoid orphaned data");
		}

		return blocksMetadataDetailsRelLocalService.
			deleteBlocksMetadataDetailsRel(
				(BlocksMetadataDetailsRel)persistedModel);
	}

	@Override
	public BasePersistence<BlocksMetadataDetailsRel> getBasePersistence() {
		return blocksMetadataDetailsRelPersistence;
	}
	...
	public List<BlocksMetadataDetailsRel>
		...
		return blocksMetadataDetailsRelPersistence.findByUuid_C(
			uuid, companyId);
	}
	...
	public BlocksMetadataDetailsRel getBlocksMetadataDetailsRelByUuidAndGroupId(
		...
		return blocksMetadataDetailsRelPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<BlocksMetadataDetailsRel> getBlocksMetadataDetailsRels(
		...
		return blocksMetadataDetailsRelPersistence.findAll(start, end);
	}
	...
	public int getBlocksMetadataDetailsRelsCount() {
		return blocksMetadataDetailsRelPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BlocksMetadataDetailsRelLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		blocksMetadataDetailsRelLocalService =
			(BlocksMetadataDetailsRelLocalService)aopProxy;

		_setLocalServiceUtilService(blocksMetadataDetailsRelLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return BlocksMetadataDetailsRelLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				blocksMetadataDetailsRelPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				BlocksMetadataDetailsRelLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, blocksMetadataDetailsRelLocalService);
		}
	...
	protected BlocksMetadataDetailsRelLocalService
		blocksMetadataDetailsRelLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		BlocksMetadataDetailsRelLocalServiceBaseImpl.class);
