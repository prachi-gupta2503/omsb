...
import gov.omsb.tms.service.PatientTypeProgDurationRelService;
import gov.omsb.tms.service.PatientTypeProgDurationRelServiceUtil;
...
/**
 * Provides the base implementation for the patient type prog duration rel remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.PatientTypeProgDurationRelServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.PatientTypeProgDurationRelServiceImpl
 * @generated
 */
public abstract class PatientTypeProgDurationRelServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   PatientTypeProgDurationRelService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PatientTypeProgDurationRelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PatientTypeProgDurationRelServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PatientTypeProgDurationRelService.class,
	...
	public void setAopProxy(Object aopProxy) {
		patientTypeProgDurationRelService =
			(PatientTypeProgDurationRelService)aopProxy;

		_setServiceUtilService(patientTypeProgDurationRelService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return PatientTypeProgDurationRelService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				PatientTypeProgDurationRelServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, patientTypeProgDurationRelService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.PatientTypeProgDurationRelLocalService
		patientTypeProgDurationRelLocalService;

	protected PatientTypeProgDurationRelService
		patientTypeProgDurationRelService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		PatientTypeProgDurationRelServiceBaseImpl.class);
