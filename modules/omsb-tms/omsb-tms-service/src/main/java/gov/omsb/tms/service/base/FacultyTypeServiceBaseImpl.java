...
import gov.omsb.tms.service.FacultyTypeService;
import gov.omsb.tms.service.FacultyTypeServiceUtil;
...
/**
 * Provides the base implementation for the faculty type remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.FacultyTypeServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.FacultyTypeServiceImpl
 * @generated
 */
public abstract class FacultyTypeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FacultyTypeService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FacultyTypeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>FacultyTypeServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FacultyTypeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		facultyTypeService = (FacultyTypeService)aopProxy;

		_setServiceUtilService(facultyTypeService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return FacultyTypeService.class.getName();
	}
	...
	private void _setServiceUtilService(FacultyTypeService facultyTypeService) {
		try {
			Field field = FacultyTypeServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, facultyTypeService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.FacultyTypeLocalService
		facultyTypeLocalService;

	protected FacultyTypeService facultyTypeService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FacultyTypeServiceBaseImpl.class);
