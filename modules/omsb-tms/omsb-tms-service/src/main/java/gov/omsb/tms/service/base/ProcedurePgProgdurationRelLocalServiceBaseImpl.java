...
import gov.omsb.tms.service.ProcedurePgProgdurationRelLocalServiceUtil;
...
/**
 * Provides the base implementation for the procedure pg progduration rel local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.ProcedurePgProgdurationRelLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.ProcedurePgProgdurationRelLocalServiceImpl
 * @generated
 */
public abstract class ProcedurePgProgdurationRelLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProcedurePgProgdurationRelLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProcedurePgProgdurationRelLocalServiceUtil</code>.
	 */
	...
	public ProcedurePgProgdurationRel addProcedurePgProgdurationRel(
		...
		return procedurePgProgdurationRelPersistence.update(
	...
	public ProcedurePgProgdurationRel createProcedurePgProgdurationRel(
		...
		return procedurePgProgdurationRelPersistence.create(procedurePgPdRelId);
	}
	...
	public ProcedurePgProgdurationRel deleteProcedurePgProgdurationRel(
		...
		return procedurePgProgdurationRelPersistence.remove(procedurePgPdRelId);
	}
	...
	public ProcedurePgProgdurationRel deleteProcedurePgProgdurationRel(
		...
		return procedurePgProgdurationRelPersistence.remove(
			procedurePgProgdurationRel);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return procedurePgProgdurationRelPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ProcedurePgProgdurationRel.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return procedurePgProgdurationRelPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return procedurePgProgdurationRelPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public ProcedurePgProgdurationRel fetchProcedurePgProgdurationRel(
		...
		return procedurePgProgdurationRelPersistence.fetchByPrimaryKey(
			procedurePgPdRelId);
	}
	...
	public ProcedurePgProgdurationRel
		...
		return procedurePgProgdurationRelPersistence.fetchByUUID_G(
			uuid, groupId);
	}
	...
	public ProcedurePgProgdurationRel getProcedurePgProgdurationRel(
		...
		return procedurePgProgdurationRelPersistence.findByPrimaryKey(
			procedurePgPdRelId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(ProcedurePgProgdurationRel.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("procedurePgPdRelId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			ProcedurePgProgdurationRel.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, procedurePgProgdurationRel);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return procedurePgProgdurationRelPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ProcedurePgProgdurationRelLocalServiceImpl#deleteProcedurePgProgdurationRel(ProcedurePgProgdurationRel) to avoid orphaned data");
		}

		return procedurePgProgdurationRelLocalService.
			deleteProcedurePgProgdurationRel(
				(ProcedurePgProgdurationRel)persistedModel);
	}

	@Override
	public BasePersistence<ProcedurePgProgdurationRel> getBasePersistence() {
	...
	public List<ProcedurePgProgdurationRel>
		...
		return procedurePgProgdurationRelPersistence.findByUuid_C(
			uuid, companyId);
	}
	...
	public ProcedurePgProgdurationRel
		...
		return procedurePgProgdurationRelPersistence.findByUUID_G(
			uuid, groupId);
	}
	...
	public List<ProcedurePgProgdurationRel> getProcedurePgProgdurationRels(
		...
		return procedurePgProgdurationRelPersistence.findAll(start, end);
	}
	...
	public int getProcedurePgProgdurationRelsCount() {
		return procedurePgProgdurationRelPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProcedurePgProgdurationRelLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		procedurePgProgdurationRelLocalService =
			(ProcedurePgProgdurationRelLocalService)aopProxy;

		_setLocalServiceUtilService(procedurePgProgdurationRelLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProcedurePgProgdurationRelLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				procedurePgProgdurationRelPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				ProcedurePgProgdurationRelLocalServiceUtil.class.
					getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, procedurePgProgdurationRelLocalService);
		}
	...
	protected ProcedurePgProgdurationRelLocalService
		procedurePgProgdurationRelLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProcedurePgProgdurationRelLocalServiceBaseImpl.class);
