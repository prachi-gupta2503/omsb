...
import gov.omsb.tms.service.PatientTypeMasterLocalServiceUtil;
...
/**
 * Provides the base implementation for the patient type master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.PatientTypeMasterLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.PatientTypeMasterLocalServiceImpl
 * @generated
 */
public abstract class PatientTypeMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   PatientTypeMasterLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PatientTypeMasterLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PatientTypeMasterLocalServiceUtil</code>.
	 */
	...
	@Override
	public PatientTypeMaster addPatientTypeMaster(
		PatientTypeMaster patientTypeMaster) {

		patientTypeMaster.setNew(true);

		return patientTypeMasterPersistence.update(patientTypeMaster);
	}
	...
	public PatientTypeMaster createPatientTypeMaster(long patientTypeMasterId) {
		return patientTypeMasterPersistence.create(patientTypeMasterId);
	}
	...
	@Override
	public PatientTypeMaster deletePatientTypeMaster(long patientTypeMasterId)
		throws PortalException {

		return patientTypeMasterPersistence.remove(patientTypeMasterId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PatientTypeMaster deletePatientTypeMaster(
		PatientTypeMaster patientTypeMaster) {

		return patientTypeMasterPersistence.remove(patientTypeMaster);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return patientTypeMasterPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PatientTypeMaster.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return patientTypeMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return patientTypeMasterPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return patientTypeMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return patientTypeMasterPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public PatientTypeMaster fetchPatientTypeMaster(long patientTypeMasterId) {
		return patientTypeMasterPersistence.fetchByPrimaryKey(
			patientTypeMasterId);
	}
	 ...
	 */
	@Override
	public PatientTypeMaster fetchPatientTypeMasterByUuidAndGroupId(
		String uuid, long groupId) {

		return patientTypeMasterPersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public PatientTypeMaster getPatientTypeMaster(long patientTypeMasterId)
		throws PortalException {

		return patientTypeMasterPersistence.findByPrimaryKey(
			patientTypeMasterId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(PatientTypeMaster.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("patientTypeMasterId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(PatientTypeMaster.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod
				...
				@Override
				public void performAction(PatientTypeMaster patientTypeMaster)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, patientTypeMaster);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return patientTypeMasterPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement PatientTypeMasterLocalServiceImpl#deletePatientTypeMaster(PatientTypeMaster) to avoid orphaned data");
		}

		return patientTypeMasterLocalService.deletePatientTypeMaster(
			(PatientTypeMaster)persistedModel);
	}

	@Override
	public BasePersistence<PatientTypeMaster> getBasePersistence() {
		return patientTypeMasterPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return patientTypeMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PatientTypeMaster> getPatientTypeMastersByUuidAndCompanyId(
		String uuid, long companyId) {

		return patientTypeMasterPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<PatientTypeMaster> getPatientTypeMastersByUuidAndCompanyId(
		...
		return patientTypeMasterPersistence.findByUuid_C(
	 ...
	 */
	@Override
	public PatientTypeMaster getPatientTypeMasterByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return patientTypeMasterPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<PatientTypeMaster> getPatientTypeMasters(int start, int end) {
		return patientTypeMasterPersistence.findAll(start, end);
	}
	...
	public int getPatientTypeMastersCount() {
		return patientTypeMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PatientTypeMaster updatePatientTypeMaster(
		PatientTypeMaster patientTypeMaster) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PatientTypeMasterLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		patientTypeMasterLocalService = (PatientTypeMasterLocalService)aopProxy;

		_setLocalServiceUtilService(patientTypeMasterLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return PatientTypeMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				patientTypeMasterPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				PatientTypeMasterLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, patientTypeMasterLocalService);
		}
	...
	protected PatientTypeMasterLocalService patientTypeMasterLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		PatientTypeMasterLocalServiceBaseImpl.class);
