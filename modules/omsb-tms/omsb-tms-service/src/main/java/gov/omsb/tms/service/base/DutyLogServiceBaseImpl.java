...
import gov.omsb.tms.service.DutyLogService;
import gov.omsb.tms.service.DutyLogServiceUtil;
...
/**
 * Provides the base implementation for the duty log remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.DutyLogServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.DutyLogServiceImpl
 * @generated
 */
public abstract class DutyLogServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DutyLogService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DutyLogService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DutyLogServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DutyLogService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		dutyLogService = (DutyLogService)aopProxy;

		_setServiceUtilService(dutyLogService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DutyLogService.class.getName();
	}
	...
	private void _setServiceUtilService(DutyLogService dutyLogService) {
		try {
			Field field = DutyLogServiceUtil.class.getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, dutyLogService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.DutyLogLocalService dutyLogLocalService;

	protected DutyLogService dutyLogService;
