...
/**
 * Provides the base implementation for the program duration details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.ProgramDurationDetailsLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.ProgramDurationDetailsLocalServiceImpl
 * @generated
 */
public abstract class ProgramDurationDetailsLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProgramDurationDetailsLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProgramDurationDetailsLocalServiceUtil</code>.
	 */
	...
	public ProgramDurationDetails addProgramDurationDetails(
		...
		return programDurationDetailsPersistence.update(programDurationDetails);
	}
	...
	public ProgramDurationDetails createProgramDurationDetails(
		...
		return programDurationDetailsPersistence.create(progDurationId);
	}
	...
	public ProgramDurationDetails deleteProgramDurationDetails(
		...
		return programDurationDetailsPersistence.remove(progDurationId);
	}
	...
	public ProgramDurationDetails deleteProgramDurationDetails(
		...
		return programDurationDetailsPersistence.remove(programDurationDetails);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return programDurationDetailsPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ProgramDurationDetails.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return programDurationDetailsPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return programDurationDetailsPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public ProgramDurationDetails fetchProgramDurationDetails(
		...
		return programDurationDetailsPersistence.fetchByPrimaryKey(
			progDurationId);
	}
	...
	public ProgramDurationDetails fetchProgramDurationDetailsByUuidAndGroupId(
		...
		return programDurationDetailsPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public ProgramDurationDetails getProgramDurationDetails(long progDurationId)
		...
		return programDurationDetailsPersistence.findByPrimaryKey(
			progDurationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(ProgramDurationDetails.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("progDurationId");
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, programDurationDetails);
				}
		...
		exportActionableDynamicQuery.setStagedModelType(
			new StagedModelType(
				PortalUtil.getClassNameId(
					ProgramDurationDetails.class.getName())));
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return programDurationDetailsPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ProgramDurationDetailsLocalServiceImpl#deleteProgramDurationDetails(ProgramDurationDetails) to avoid orphaned data");
		}

		return programDurationDetailsLocalService.deleteProgramDurationDetails(
			(ProgramDurationDetails)persistedModel);
	}

	@Override
	public BasePersistence<ProgramDurationDetails> getBasePersistence() {
		return programDurationDetailsPersistence;
	}
	...
	public List<ProgramDurationDetails>
		...
		return programDurationDetailsPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<ProgramDurationDetails>
		...
		return programDurationDetailsPersistence.findByUuid_C(
	...
	public ProgramDurationDetails getProgramDurationDetailsByUuidAndGroupId(
		...
		return programDurationDetailsPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<ProgramDurationDetails> getProgramDurationDetailses(
		...
		return programDurationDetailsPersistence.findAll(start, end);
	}
	...
	public int getProgramDurationDetailsesCount() {
		return programDurationDetailsPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProgramDurationDetailsLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		programDurationDetailsLocalService =
			(ProgramDurationDetailsLocalService)aopProxy;

		_setLocalServiceUtilService(programDurationDetailsLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProgramDurationDetailsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				programDurationDetailsPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				ProgramDurationDetailsLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, programDurationDetailsLocalService);
		}
	...
	protected ProgramDurationDetailsLocalService
		programDurationDetailsLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProgramDurationDetailsLocalServiceBaseImpl.class);
