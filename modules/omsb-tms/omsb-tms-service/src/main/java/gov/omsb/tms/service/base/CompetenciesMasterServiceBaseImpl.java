...
import gov.omsb.tms.service.CompetenciesMasterService;
import gov.omsb.tms.service.CompetenciesMasterServiceUtil;
...
/**
 * Provides the base implementation for the competencies master remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.CompetenciesMasterServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.CompetenciesMasterServiceImpl
 * @generated
 */
public abstract class CompetenciesMasterServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CompetenciesMasterService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CompetenciesMasterService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>CompetenciesMasterServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CompetenciesMasterService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		competenciesMasterService = (CompetenciesMasterService)aopProxy;

		_setServiceUtilService(competenciesMasterService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return CompetenciesMasterService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = CompetenciesMasterServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, competenciesMasterService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.CompetenciesMasterLocalService
		competenciesMasterLocalService;

	protected CompetenciesMasterService competenciesMasterService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		CompetenciesMasterServiceBaseImpl.class);
