...
import gov.omsb.tms.service.LeaveTraineeMasterService;
import gov.omsb.tms.service.LeaveTraineeMasterServiceUtil;
...
/**
 * Provides the base implementation for the leave trainee master remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.LeaveTraineeMasterServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.LeaveTraineeMasterServiceImpl
 * @generated
 */
public abstract class LeaveTraineeMasterServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, LeaveTraineeMasterService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LeaveTraineeMasterService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>LeaveTraineeMasterServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LeaveTraineeMasterService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		leaveTraineeMasterService = (LeaveTraineeMasterService)aopProxy;

		_setServiceUtilService(leaveTraineeMasterService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return LeaveTraineeMasterService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = LeaveTraineeMasterServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, leaveTraineeMasterService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.LeaveTraineeMasterLocalService
		leaveTraineeMasterLocalService;

	protected LeaveTraineeMasterService leaveTraineeMasterService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LeaveTraineeMasterServiceBaseImpl.class);
