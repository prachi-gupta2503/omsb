...
import gov.omsb.tms.service.TraineeRotationTsBlockDetailsRelService;
import gov.omsb.tms.service.TraineeRotationTsBlockDetailsRelServiceUtil;
...
/**
 * Provides the base implementation for the trainee rotation ts block details rel remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.TraineeRotationTsBlockDetailsRelServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.TraineeRotationTsBlockDetailsRelServiceImpl
 * @generated
 */
public abstract class TraineeRotationTsBlockDetailsRelServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   TraineeRotationTsBlockDetailsRelService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TraineeRotationTsBlockDetailsRelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TraineeRotationTsBlockDetailsRelServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TraineeRotationTsBlockDetailsRelService.class,
	...
	public void setAopProxy(Object aopProxy) {
		traineeRotationTsBlockDetailsRelService =
			(TraineeRotationTsBlockDetailsRelService)aopProxy;

		_setServiceUtilService(traineeRotationTsBlockDetailsRelService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TraineeRotationTsBlockDetailsRelService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				TraineeRotationTsBlockDetailsRelServiceUtil.class.
					getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, traineeRotationTsBlockDetailsRelService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.TraineeRotationTsBlockDetailsRelLocalService
		traineeRotationTsBlockDetailsRelLocalService;

	protected TraineeRotationTsBlockDetailsRelService
		traineeRotationTsBlockDetailsRelService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TraineeRotationTsBlockDetailsRelServiceBaseImpl.class);
