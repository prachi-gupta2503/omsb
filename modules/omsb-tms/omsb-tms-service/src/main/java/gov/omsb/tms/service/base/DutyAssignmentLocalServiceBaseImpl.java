...
/**
 * Provides the base implementation for the duty assignment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.DutyAssignmentLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.DutyAssignmentLocalServiceImpl
 * @generated
 */
public abstract class DutyAssignmentLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, DutyAssignmentLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DutyAssignmentLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DutyAssignmentLocalServiceUtil</code>.
	 */
	...
	public DutyAssignment addDutyAssignment(DutyAssignment dutyAssignment) {
		...
		return dutyAssignmentPersistence.update(dutyAssignment);
	}
	...
	public DutyAssignment createDutyAssignment(long dutyAssignmentId) {
		return dutyAssignmentPersistence.create(dutyAssignmentId);
	}
	...
	public DutyAssignment deleteDutyAssignment(long dutyAssignmentId)
		...
		return dutyAssignmentPersistence.remove(dutyAssignmentId);
	}
	...
	public DutyAssignment deleteDutyAssignment(DutyAssignment dutyAssignment) {
		return dutyAssignmentPersistence.remove(dutyAssignment);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return dutyAssignmentPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			DutyAssignment.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return dutyAssignmentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return dutyAssignmentPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return dutyAssignmentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return dutyAssignmentPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public DutyAssignment fetchDutyAssignment(long dutyAssignmentId) {
		return dutyAssignmentPersistence.fetchByPrimaryKey(dutyAssignmentId);
	}
	...
	public DutyAssignment fetchDutyAssignmentByUuidAndGroupId(
		...
		return dutyAssignmentPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public DutyAssignment getDutyAssignment(long dutyAssignmentId)
		...
		return dutyAssignmentPersistence.findByPrimaryKey(dutyAssignmentId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(dutyAssignmentLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DutyAssignment.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("dutyAssignmentId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			dutyAssignmentLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(DutyAssignment.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<DutyAssignment>() {

				@Override
				public void performAction(DutyAssignment dutyAssignment)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, dutyAssignment);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return dutyAssignmentPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement DutyAssignmentLocalServiceImpl#deleteDutyAssignment(DutyAssignment) to avoid orphaned data");
		}

		return dutyAssignmentLocalService.deleteDutyAssignment(
			(DutyAssignment)persistedModel);
	}

	@Override
	public BasePersistence<DutyAssignment> getBasePersistence() {
		return dutyAssignmentPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return dutyAssignmentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DutyAssignment> getDutyAssignmentsByUuidAndCompanyId(
		...
		return dutyAssignmentPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<DutyAssignment> getDutyAssignmentsByUuidAndCompanyId(
		...
		return dutyAssignmentPersistence.findByUuid_C(
	...
	public DutyAssignment getDutyAssignmentByUuidAndGroupId(
		...
		return dutyAssignmentPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<DutyAssignment> getDutyAssignments(int start, int end) {
		return dutyAssignmentPersistence.findAll(start, end);
	}
	...
	public int getDutyAssignmentsCount() {
		return dutyAssignmentPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DutyAssignmentLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		dutyAssignmentLocalService = (DutyAssignmentLocalService)aopProxy;

		_setLocalServiceUtilService(dutyAssignmentLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DutyAssignmentLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = dutyAssignmentPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = DutyAssignmentLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, dutyAssignmentLocalService);
		}
	...
	protected DutyAssignmentLocalService dutyAssignmentLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DutyAssignmentLocalServiceBaseImpl.class);
