...
import gov.omsb.tms.service.QararRequestLocalService;
...
/**
 * Provides the base implementation for the qarar request local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.QararRequestLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.QararRequestLocalServiceImpl
 * @generated
 */
public abstract class QararRequestLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, QararRequestLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QararRequestLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>QararRequestLocalServiceUtil</code>.
	 */
	...
	@Override
	public QararRequest addQararRequest(QararRequest qararRequest) {
		qararRequest.setNew(true);

		return qararRequestPersistence.update(qararRequest);
	}
	...
	public QararRequest createQararRequest(long qararRequestId) {
		return qararRequestPersistence.create(qararRequestId);
	}
	...
	@Override
	public QararRequest deleteQararRequest(long qararRequestId)
		throws PortalException {

		return qararRequestPersistence.remove(qararRequestId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public QararRequest deleteQararRequest(QararRequest qararRequest) {
		return qararRequestPersistence.remove(qararRequest);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return qararRequestPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			QararRequest.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return qararRequestPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return qararRequestPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return qararRequestPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return qararRequestPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public QararRequest fetchQararRequest(long qararRequestId) {
		return qararRequestPersistence.fetchByPrimaryKey(qararRequestId);
	}
	 ...
	 */
	@Override
	public QararRequest fetchQararRequestByUuidAndGroupId(
		String uuid, long groupId) {

		return qararRequestPersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public QararRequest getQararRequest(long qararRequestId)
		throws PortalException {

		return qararRequestPersistence.findByPrimaryKey(qararRequestId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(qararRequestLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(QararRequest.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("qararRequestId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			qararRequestLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(QararRequest.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<QararRequest>() {

				@Override
				public void performAction(QararRequest qararRequest)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, qararRequest);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return qararRequestPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement QararRequestLocalServiceImpl#deleteQararRequest(QararRequest) to avoid orphaned data");
		}

		return qararRequestLocalService.deleteQararRequest(
			(QararRequest)persistedModel);
	}

	@Override
	public BasePersistence<QararRequest> getBasePersistence() {
		return qararRequestPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return qararRequestPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<QararRequest> getQararRequestsByUuidAndCompanyId(
		String uuid, long companyId) {

		return qararRequestPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<QararRequest> getQararRequestsByUuidAndCompanyId(
		...
		return qararRequestPersistence.findByUuid_C(
	 ...
	 */
	@Override
	public QararRequest getQararRequestByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return qararRequestPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<QararRequest> getQararRequests(int start, int end) {
		return qararRequestPersistence.findAll(start, end);
	}
	...
	public int getQararRequestsCount() {
		return qararRequestPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public QararRequest updateQararRequest(QararRequest qararRequest) {
		return qararRequestPersistence.update(qararRequest);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QararRequestLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		qararRequestLocalService = (QararRequestLocalService)aopProxy;

		_setLocalServiceUtilService(qararRequestLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return QararRequestLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = qararRequestPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = QararRequestLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, qararRequestLocalService);
		}
	...
	protected QararRequestLocalService qararRequestLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		QararRequestLocalServiceBaseImpl.class);
