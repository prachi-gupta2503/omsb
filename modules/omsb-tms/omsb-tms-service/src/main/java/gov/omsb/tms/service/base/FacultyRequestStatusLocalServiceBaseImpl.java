...
/**
 * Provides the base implementation for the faculty request status local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.FacultyRequestStatusLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.FacultyRequestStatusLocalServiceImpl
 * @generated
 */
public abstract class FacultyRequestStatusLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, FacultyRequestStatusLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FacultyRequestStatusLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>FacultyRequestStatusLocalServiceUtil</code>.
	 */
	...
	@Override
	public FacultyRequestStatus addFacultyRequestStatus(
		FacultyRequestStatus facultyRequestStatus) {

		facultyRequestStatus.setNew(true);

		return facultyRequestStatusPersistence.update(facultyRequestStatus);
	}
	...
	public FacultyRequestStatus createFacultyRequestStatus(
		long facultyRequestStatusId) {

		return facultyRequestStatusPersistence.create(facultyRequestStatusId);
	}
	...
	@Override
	public FacultyRequestStatus deleteFacultyRequestStatus(
			long facultyRequestStatusId)
		throws PortalException {

		return facultyRequestStatusPersistence.remove(facultyRequestStatusId);
	}
	...
	public FacultyRequestStatus deleteFacultyRequestStatus(
		...
		return facultyRequestStatusPersistence.remove(facultyRequestStatus);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return facultyRequestStatusPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			FacultyRequestStatus.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return facultyRequestStatusPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return facultyRequestStatusPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public FacultyRequestStatus fetchFacultyRequestStatus(
		long facultyRequestStatusId) {

		return facultyRequestStatusPersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public FacultyRequestStatus fetchFacultyRequestStatusByUuidAndGroupId(
		String uuid, long groupId) {

		return facultyRequestStatusPersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public FacultyRequestStatus getFacultyRequestStatus(
			long facultyRequestStatusId)
		throws PortalException {

		return facultyRequestStatusPersistence.findByPrimaryKey(
			facultyRequestStatusId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			facultyRequestStatusLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(FacultyRequestStatus.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, facultyRequestStatus);
				}
		...
		exportActionableDynamicQuery.setStagedModelType(
			new StagedModelType(
				PortalUtil.getClassNameId(
					FacultyRequestStatus.class.getName())));
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return facultyRequestStatusPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement FacultyRequestStatusLocalServiceImpl#deleteFacultyRequestStatus(FacultyRequestStatus) to avoid orphaned data");
		}

		return facultyRequestStatusLocalService.deleteFacultyRequestStatus(
			(FacultyRequestStatus)persistedModel);
	}

	@Override
	public BasePersistence<FacultyRequestStatus> getBasePersistence() {
		return facultyRequestStatusPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return facultyRequestStatusPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<FacultyRequestStatus>
		getFacultyRequestStatusesByUuidAndCompanyId(
			String uuid, long companyId) {

		return facultyRequestStatusPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<FacultyRequestStatus>
		...
		return facultyRequestStatusPersistence.findByUuid_C(
	 ...
	 */
	@Override
	public FacultyRequestStatus getFacultyRequestStatusByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return facultyRequestStatusPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<FacultyRequestStatus> getFacultyRequestStatuses(
		int start, int end) {

		return facultyRequestStatusPersistence.findAll(start, end);
	}
	...
	public int getFacultyRequestStatusesCount() {
		return facultyRequestStatusPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public FacultyRequestStatus updateFacultyRequestStatus(
		FacultyRequestStatus facultyRequestStatus) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FacultyRequestStatusLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		facultyRequestStatusLocalService =
			(FacultyRequestStatusLocalService)aopProxy;

		_setLocalServiceUtilService(facultyRequestStatusLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return FacultyRequestStatusLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				facultyRequestStatusPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				FacultyRequestStatusLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, facultyRequestStatusLocalService);
		}
	...
	protected FacultyRequestStatusLocalService facultyRequestStatusLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FacultyRequestStatusLocalServiceBaseImpl.class);
