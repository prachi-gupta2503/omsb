...
/**
 * Provides the base implementation for the faculty bank details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.FacultyBankDetailsLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.FacultyBankDetailsLocalServiceImpl
 * @generated
 */
public abstract class FacultyBankDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, FacultyBankDetailsLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FacultyBankDetailsLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>FacultyBankDetailsLocalServiceUtil</code>.
	 */
	...
	public FacultyBankDetails addFacultyBankDetails(
		...
		return facultyBankDetailsPersistence.update(facultyBankDetails);
	}
	...
	public FacultyBankDetails createFacultyBankDetails(
		...
		return facultyBankDetailsPersistence.create(facultyBankDetailsId);
	}
	...
	public FacultyBankDetails deleteFacultyBankDetails(
		...
		return facultyBankDetailsPersistence.remove(facultyBankDetailsId);
	}
	...
	public FacultyBankDetails deleteFacultyBankDetails(
		...
		return facultyBankDetailsPersistence.remove(facultyBankDetails);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return facultyBankDetailsPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			FacultyBankDetails.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return facultyBankDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return facultyBankDetailsPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return facultyBankDetailsPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public FacultyBankDetails fetchFacultyBankDetails(
		...
		return facultyBankDetailsPersistence.fetchByPrimaryKey(
	...
	public FacultyBankDetails fetchFacultyBankDetailsByUuidAndGroupId(
		...
		return facultyBankDetailsPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public FacultyBankDetails getFacultyBankDetails(long facultyBankDetailsId)
		...
		return facultyBankDetailsPersistence.findByPrimaryKey(
			facultyBankDetailsId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			facultyBankDetailsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(FacultyBankDetails.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(FacultyBankDetails.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod
				...
				@Override
				public void performAction(FacultyBankDetails facultyBankDetails)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, facultyBankDetails);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return facultyBankDetailsPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement FacultyBankDetailsLocalServiceImpl#deleteFacultyBankDetails(FacultyBankDetails) to avoid orphaned data");
		}

		return facultyBankDetailsLocalService.deleteFacultyBankDetails(
			(FacultyBankDetails)persistedModel);
	}

	@Override
	public BasePersistence<FacultyBankDetails> getBasePersistence() {
		return facultyBankDetailsPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return facultyBankDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<FacultyBankDetails> getFacultyBankDetailsesByUuidAndCompanyId(
		...
		return facultyBankDetailsPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<FacultyBankDetails> getFacultyBankDetailsesByUuidAndCompanyId(
		...
		return facultyBankDetailsPersistence.findByUuid_C(
	...
	public FacultyBankDetails getFacultyBankDetailsByUuidAndGroupId(
		...
		return facultyBankDetailsPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<FacultyBankDetails> getFacultyBankDetailses(
		int start, int end) {

		return facultyBankDetailsPersistence.findAll(start, end);
	}
	...
	public int getFacultyBankDetailsesCount() {
		return facultyBankDetailsPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FacultyBankDetailsLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		facultyBankDetailsLocalService =
			(FacultyBankDetailsLocalService)aopProxy;

		_setLocalServiceUtilService(facultyBankDetailsLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return FacultyBankDetailsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				facultyBankDetailsPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				FacultyBankDetailsLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, facultyBankDetailsLocalService);
		}
	...
	protected FacultyBankDetailsLocalService facultyBankDetailsLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FacultyBankDetailsLocalServiceBaseImpl.class);
