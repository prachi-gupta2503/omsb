...
import gov.omsb.tms.service.ProgramEligibilityDegreeRelService;
import gov.omsb.tms.service.ProgramEligibilityDegreeRelServiceUtil;
...
/**
 * Provides the base implementation for the program eligibility degree rel remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.ProgramEligibilityDegreeRelServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.ProgramEligibilityDegreeRelServiceImpl
 * @generated
 */
public abstract class ProgramEligibilityDegreeRelServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProgramEligibilityDegreeRelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProgramEligibilityDegreeRelServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProgramEligibilityDegreeRelService.class,
	...
	public void setAopProxy(Object aopProxy) {
		programEligibilityDegreeRelService =
			(ProgramEligibilityDegreeRelService)aopProxy;

		_setServiceUtilService(programEligibilityDegreeRelService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProgramEligibilityDegreeRelService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				ProgramEligibilityDegreeRelServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, programEligibilityDegreeRelService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.ProgramEligibilityDegreeRelLocalService
		programEligibilityDegreeRelLocalService;

	protected ProgramEligibilityDegreeRelService
		programEligibilityDegreeRelService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProgramEligibilityDegreeRelServiceBaseImpl.class);
