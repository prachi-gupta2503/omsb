...
import gov.omsb.tms.service.RotationObjectivesRelService;
import gov.omsb.tms.service.RotationObjectivesRelServiceUtil;
...
/**
 * Provides the base implementation for the rotation objectives rel remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.RotationObjectivesRelServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.RotationObjectivesRelServiceImpl
 * @generated
 */
public abstract class RotationObjectivesRelServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   RotationObjectivesRelService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RotationObjectivesRelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>RotationObjectivesRelServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			RotationObjectivesRelService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		rotationObjectivesRelService = (RotationObjectivesRelService)aopProxy;

		_setServiceUtilService(rotationObjectivesRelService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return RotationObjectivesRelService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				RotationObjectivesRelServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, rotationObjectivesRelService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.RotationObjectivesRelLocalService
		rotationObjectivesRelLocalService;

	protected RotationObjectivesRelService rotationObjectivesRelService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RotationObjectivesRelServiceBaseImpl.class);
