...
/**
 * Provides the base implementation for the leave annual max trainee local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.LeaveAnnualMaxTraineeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.LeaveAnnualMaxTraineeLocalServiceImpl
 * @generated
 */
public abstract class LeaveAnnualMaxTraineeLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   LeaveAnnualMaxTraineeLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LeaveAnnualMaxTraineeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>LeaveAnnualMaxTraineeLocalServiceUtil</code>.
	 */
	...
	public LeaveAnnualMaxTrainee addLeaveAnnualMaxTrainee(
		...
		return leaveAnnualMaxTraineePersistence.update(leaveAnnualMaxTrainee);
	}
	...
	public LeaveAnnualMaxTrainee createLeaveAnnualMaxTrainee(
		...
		return leaveAnnualMaxTraineePersistence.create(leaveAnnualMaxTraineeId);
	}
	...
	public LeaveAnnualMaxTrainee deleteLeaveAnnualMaxTrainee(
		...
		return leaveAnnualMaxTraineePersistence.remove(leaveAnnualMaxTraineeId);
	}
	...
	public LeaveAnnualMaxTrainee deleteLeaveAnnualMaxTrainee(
		...
		return leaveAnnualMaxTraineePersistence.remove(leaveAnnualMaxTrainee);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return leaveAnnualMaxTraineePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			LeaveAnnualMaxTrainee.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return leaveAnnualMaxTraineePersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return leaveAnnualMaxTraineePersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public LeaveAnnualMaxTrainee fetchLeaveAnnualMaxTrainee(
		...
		return leaveAnnualMaxTraineePersistence.fetchByPrimaryKey(
	...
	public LeaveAnnualMaxTrainee fetchLeaveAnnualMaxTraineeByUuidAndGroupId(
		...
		return leaveAnnualMaxTraineePersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public LeaveAnnualMaxTrainee getLeaveAnnualMaxTrainee(
		...
		return leaveAnnualMaxTraineePersistence.findByPrimaryKey(
			leaveAnnualMaxTraineeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(LeaveAnnualMaxTrainee.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, leaveAnnualMaxTrainee);
				}
		...
		exportActionableDynamicQuery.setStagedModelType(
			new StagedModelType(
				PortalUtil.getClassNameId(
					LeaveAnnualMaxTrainee.class.getName())));
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return leaveAnnualMaxTraineePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement LeaveAnnualMaxTraineeLocalServiceImpl#deleteLeaveAnnualMaxTrainee(LeaveAnnualMaxTrainee) to avoid orphaned data");
		}

		return leaveAnnualMaxTraineeLocalService.deleteLeaveAnnualMaxTrainee(
			(LeaveAnnualMaxTrainee)persistedModel);
	}

	@Override
	public BasePersistence<LeaveAnnualMaxTrainee> getBasePersistence() {
		return leaveAnnualMaxTraineePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return leaveAnnualMaxTraineePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<LeaveAnnualMaxTrainee>
		...
		return leaveAnnualMaxTraineePersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<LeaveAnnualMaxTrainee>
		...
		return leaveAnnualMaxTraineePersistence.findByUuid_C(
	...
	public LeaveAnnualMaxTrainee getLeaveAnnualMaxTraineeByUuidAndGroupId(
		...
		return leaveAnnualMaxTraineePersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<LeaveAnnualMaxTrainee> getLeaveAnnualMaxTrainees(
		...
		return leaveAnnualMaxTraineePersistence.findAll(start, end);
	}
	...
	public int getLeaveAnnualMaxTraineesCount() {
		return leaveAnnualMaxTraineePersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LeaveAnnualMaxTraineeLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		leaveAnnualMaxTraineeLocalService =
			(LeaveAnnualMaxTraineeLocalService)aopProxy;

		_setLocalServiceUtilService(leaveAnnualMaxTraineeLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return LeaveAnnualMaxTraineeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				leaveAnnualMaxTraineePersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				LeaveAnnualMaxTraineeLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, leaveAnnualMaxTraineeLocalService);
		}
	...
	protected LeaveAnnualMaxTraineeLocalService
		leaveAnnualMaxTraineeLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LeaveAnnualMaxTraineeLocalServiceBaseImpl.class);
