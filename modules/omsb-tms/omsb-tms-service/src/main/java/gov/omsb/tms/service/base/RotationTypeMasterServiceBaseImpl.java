...
import gov.omsb.tms.service.RotationTypeMasterService;
import gov.omsb.tms.service.RotationTypeMasterServiceUtil;
...
/**
 * Provides the base implementation for the rotation type master remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.RotationTypeMasterServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.RotationTypeMasterServiceImpl
 * @generated
 */
public abstract class RotationTypeMasterServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, RotationTypeMasterService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RotationTypeMasterService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>RotationTypeMasterServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			RotationTypeMasterService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		rotationTypeMasterService = (RotationTypeMasterService)aopProxy;

		_setServiceUtilService(rotationTypeMasterService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return RotationTypeMasterService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = RotationTypeMasterServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, rotationTypeMasterService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.RotationTypeMasterLocalService
		rotationTypeMasterLocalService;

	protected RotationTypeMasterService rotationTypeMasterService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RotationTypeMasterServiceBaseImpl.class);
