...
import gov.omsb.tms.service.ProgramTypeMasterService;
import gov.omsb.tms.service.ProgramTypeMasterServiceUtil;
...
/**
 * Provides the base implementation for the program type master remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.ProgramTypeMasterServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.ProgramTypeMasterServiceImpl
 * @generated
 */
public abstract class ProgramTypeMasterServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, ProgramTypeMasterService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProgramTypeMasterService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProgramTypeMasterServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProgramTypeMasterService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		programTypeMasterService = (ProgramTypeMasterService)aopProxy;

		_setServiceUtilService(programTypeMasterService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProgramTypeMasterService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = ProgramTypeMasterServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, programTypeMasterService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.ProgramTypeMasterLocalService
		programTypeMasterLocalService;

	protected ProgramTypeMasterService programTypeMasterService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProgramTypeMasterServiceBaseImpl.class);
