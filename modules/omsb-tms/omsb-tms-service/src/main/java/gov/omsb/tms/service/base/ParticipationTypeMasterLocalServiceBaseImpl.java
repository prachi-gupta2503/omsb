...
import gov.omsb.tms.service.ParticipationTypeMasterLocalServiceUtil;
...
/**
 * Provides the base implementation for the participation type master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.ParticipationTypeMasterLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.ParticipationTypeMasterLocalServiceImpl
 * @generated
 */
public abstract class ParticipationTypeMasterLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ParticipationTypeMasterLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ParticipationTypeMasterLocalServiceUtil</code>.
	 */
	...
	public ParticipationTypeMaster addParticipationTypeMaster(
		...
		return participationTypeMasterPersistence.update(
	...
	public ParticipationTypeMaster createParticipationTypeMaster(
		...
		return participationTypeMasterPersistence.create(
	...
	public ParticipationTypeMaster deleteParticipationTypeMaster(
		...
		return participationTypeMasterPersistence.remove(
			participationTypeMasterId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return participationTypeMasterPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ParticipationTypeMaster.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return participationTypeMasterPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return participationTypeMasterPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public ParticipationTypeMaster fetchParticipationTypeMaster(
		...
		return participationTypeMasterPersistence.fetchByPrimaryKey(
			participationTypeMasterId);
	}
	...
	public ParticipationTypeMaster fetchParticipationTypeMasterByUuidAndGroupId(
		...
		return participationTypeMasterPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public ParticipationTypeMaster getParticipationTypeMaster(
		...
		return participationTypeMasterPersistence.findByPrimaryKey(
			participationTypeMasterId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(ParticipationTypeMaster.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, participationTypeMaster);
				}
		...
		exportActionableDynamicQuery.setStagedModelType(
			new StagedModelType(
				PortalUtil.getClassNameId(
					ParticipationTypeMaster.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ParticipationTypeMasterLocalServiceImpl#deleteParticipationTypeMaster(ParticipationTypeMaster) to avoid orphaned data");
		}

		return participationTypeMasterLocalService.
			deleteParticipationTypeMaster(
				(ParticipationTypeMaster)persistedModel);
	}

	@Override
	public BasePersistence<ParticipationTypeMaster> getBasePersistence() {
		return participationTypeMasterPersistence;
	}
	...
	public List<ParticipationTypeMaster>
		...
		return participationTypeMasterPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<ParticipationTypeMaster>
		...
		return participationTypeMasterPersistence.findByUuid_C(
	...
	public ParticipationTypeMaster getParticipationTypeMasterByUuidAndGroupId(
		...
		return participationTypeMasterPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<ParticipationTypeMaster> getParticipationTypeMasters(
		...
		return participationTypeMasterPersistence.findAll(start, end);
	}
	...
	public int getParticipationTypeMastersCount() {
		return participationTypeMasterPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ParticipationTypeMasterLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		participationTypeMasterLocalService =
			(ParticipationTypeMasterLocalService)aopProxy;

		_setLocalServiceUtilService(participationTypeMasterLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ParticipationTypeMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				participationTypeMasterPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				ParticipationTypeMasterLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, participationTypeMasterLocalService);
		}
	...
	protected ParticipationTypeMasterLocalService
		participationTypeMasterLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ParticipationTypeMasterLocalServiceBaseImpl.class);
