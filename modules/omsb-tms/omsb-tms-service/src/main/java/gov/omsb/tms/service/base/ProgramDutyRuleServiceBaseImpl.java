...
import gov.omsb.tms.service.ProgramDutyRuleService;
import gov.omsb.tms.service.ProgramDutyRuleServiceUtil;
...
/**
 * Provides the base implementation for the program duty rule remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.ProgramDutyRuleServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.ProgramDutyRuleServiceImpl
 * @generated
 */
public abstract class ProgramDutyRuleServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, ProgramDutyRuleService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProgramDutyRuleService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProgramDutyRuleServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProgramDutyRuleService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		programDutyRuleService = (ProgramDutyRuleService)aopProxy;

		_setServiceUtilService(programDutyRuleService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProgramDutyRuleService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = ProgramDutyRuleServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, programDutyRuleService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.ProgramDutyRuleLocalService
		programDutyRuleLocalService;

	protected ProgramDutyRuleService programDutyRuleService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProgramDutyRuleServiceBaseImpl.class);
