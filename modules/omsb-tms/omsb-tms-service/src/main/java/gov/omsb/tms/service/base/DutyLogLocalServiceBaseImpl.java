...
/**
 * Provides the base implementation for the duty log local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.DutyLogLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.DutyLogLocalServiceImpl
 * @generated
 */
public abstract class DutyLogLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, DutyLogLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DutyLogLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DutyLogLocalServiceUtil</code>.
	 */
	...
	public DutyLog addDutyLog(DutyLog dutyLog) {
		...
		return dutyLogPersistence.update(dutyLog);
	}
	...
	public DutyLog createDutyLog(long dutyLogId) {
		return dutyLogPersistence.create(dutyLogId);
	}
	...
	public DutyLog deleteDutyLog(long dutyLogId) throws PortalException {
		return dutyLogPersistence.remove(dutyLogId);
	}
	...
	public DutyLog deleteDutyLog(DutyLog dutyLog) {
		return dutyLogPersistence.remove(dutyLog);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return dutyLogPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			DutyLog.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return dutyLogPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return dutyLogPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return dutyLogPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return dutyLogPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public DutyLog fetchDutyLog(long dutyLogId) {
		return dutyLogPersistence.fetchByPrimaryKey(dutyLogId);
	}
	...
	public DutyLog fetchDutyLogByUuidAndGroupId(String uuid, long groupId) {
		return dutyLogPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public DutyLog getDutyLog(long dutyLogId) throws PortalException {
		return dutyLogPersistence.findByPrimaryKey(dutyLogId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(dutyLogLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DutyLog.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("dutyLogId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(DutyLog.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("dutyLogId");
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<DutyLog>() {

				@Override
				public void performAction(DutyLog dutyLog)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, dutyLog);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return dutyLogPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement DutyLogLocalServiceImpl#deleteDutyLog(DutyLog) to avoid orphaned data");
		}

		return dutyLogLocalService.deleteDutyLog((DutyLog)persistedModel);
	}

	@Override
	public BasePersistence<DutyLog> getBasePersistence() {
		return dutyLogPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return dutyLogPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DutyLog> getDutyLogsByUuidAndCompanyId(
		...
		return dutyLogPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<DutyLog> getDutyLogsByUuidAndCompanyId(
		...
		return dutyLogPersistence.findByUuid_C(
	...
	public DutyLog getDutyLogByUuidAndGroupId(String uuid, long groupId)
		...
		return dutyLogPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<DutyLog> getDutyLogs(int start, int end) {
		return dutyLogPersistence.findAll(start, end);
	}
	...
	public int getDutyLogsCount() {
		return dutyLogPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DutyLogLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		dutyLogLocalService = (DutyLogLocalService)aopProxy;

		_setLocalServiceUtilService(dutyLogLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DutyLogLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = dutyLogPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = DutyLogLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, dutyLogLocalService);
		}
	...
	protected DutyLogLocalService dutyLogLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DutyLogLocalServiceBaseImpl.class);
