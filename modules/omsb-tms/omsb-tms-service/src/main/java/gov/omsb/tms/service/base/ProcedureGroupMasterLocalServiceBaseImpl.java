...
/**
 * Provides the base implementation for the procedure group master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.ProcedureGroupMasterLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.ProcedureGroupMasterLocalServiceImpl
 * @generated
 */
public abstract class ProcedureGroupMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   ProcedureGroupMasterLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProcedureGroupMasterLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProcedureGroupMasterLocalServiceUtil</code>.
	 */
	...
	public ProcedureGroupMaster addProcedureGroupMaster(
		...
		return procedureGroupMasterPersistence.update(procedureGroupMaster);
	}
	...
	public ProcedureGroupMaster createProcedureGroupMaster(
		...
		return procedureGroupMasterPersistence.create(procedureGroupMasterId);
	}
	...
	public ProcedureGroupMaster deleteProcedureGroupMaster(
		...
		return procedureGroupMasterPersistence.remove(procedureGroupMasterId);
	}
	...
	public ProcedureGroupMaster deleteProcedureGroupMaster(
		...
		return procedureGroupMasterPersistence.remove(procedureGroupMaster);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return procedureGroupMasterPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ProcedureGroupMaster.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return procedureGroupMasterPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return procedureGroupMasterPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public ProcedureGroupMaster fetchProcedureGroupMaster(
		...
		return procedureGroupMasterPersistence.fetchByPrimaryKey(
	...
	public ProcedureGroupMaster fetchProcedureGroupMasterByUuidAndGroupId(
		...
		return procedureGroupMasterPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public ProcedureGroupMaster getProcedureGroupMaster(
		...
		return procedureGroupMasterPersistence.findByPrimaryKey(
			procedureGroupMasterId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(ProcedureGroupMaster.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, procedureGroupMaster);
				}
		...
		exportActionableDynamicQuery.setStagedModelType(
			new StagedModelType(
				PortalUtil.getClassNameId(
					ProcedureGroupMaster.class.getName())));
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return procedureGroupMasterPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ProcedureGroupMasterLocalServiceImpl#deleteProcedureGroupMaster(ProcedureGroupMaster) to avoid orphaned data");
		}

		return procedureGroupMasterLocalService.deleteProcedureGroupMaster(
			(ProcedureGroupMaster)persistedModel);
	}

	@Override
	public BasePersistence<ProcedureGroupMaster> getBasePersistence() {
		return procedureGroupMasterPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return procedureGroupMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ProcedureGroupMaster>
		...
		return procedureGroupMasterPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<ProcedureGroupMaster>
		...
		return procedureGroupMasterPersistence.findByUuid_C(
	...
	public ProcedureGroupMaster getProcedureGroupMasterByUuidAndGroupId(
		...
		return procedureGroupMasterPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<ProcedureGroupMaster> getProcedureGroupMasters(
		...
		return procedureGroupMasterPersistence.findAll(start, end);
	}
	...
	public int getProcedureGroupMastersCount() {
		return procedureGroupMasterPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProcedureGroupMasterLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		procedureGroupMasterLocalService =
			(ProcedureGroupMasterLocalService)aopProxy;

		_setLocalServiceUtilService(procedureGroupMasterLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProcedureGroupMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				procedureGroupMasterPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				ProcedureGroupMasterLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, procedureGroupMasterLocalService);
		}
	...
	protected ProcedureGroupMasterLocalService procedureGroupMasterLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProcedureGroupMasterLocalServiceBaseImpl.class);
