...
/**
 * Provides the base implementation for the program duty assignment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.ProgramDutyAssignmentLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.ProgramDutyAssignmentLocalServiceImpl
 * @generated
 */
public abstract class ProgramDutyAssignmentLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProgramDutyAssignmentLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProgramDutyAssignmentLocalServiceUtil</code>.
	 */
	...
	public ProgramDutyAssignment addProgramDutyAssignment(
		...
		return programDutyAssignmentPersistence.update(programDutyAssignment);
	}
	...
	public ProgramDutyAssignment createProgramDutyAssignment(
		...
		return programDutyAssignmentPersistence.create(programDutyAssignmentId);
	}
	...
	public ProgramDutyAssignment deleteProgramDutyAssignment(
		...
		return programDutyAssignmentPersistence.remove(programDutyAssignmentId);
	}
	...
	public ProgramDutyAssignment deleteProgramDutyAssignment(
		...
		return programDutyAssignmentPersistence.remove(programDutyAssignment);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return programDutyAssignmentPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ProgramDutyAssignment.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return programDutyAssignmentPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return programDutyAssignmentPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public ProgramDutyAssignment fetchProgramDutyAssignment(
		...
		return programDutyAssignmentPersistence.fetchByPrimaryKey(
	...
	public ProgramDutyAssignment fetchProgramDutyAssignmentByUuidAndGroupId(
		...
		return programDutyAssignmentPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public ProgramDutyAssignment getProgramDutyAssignment(
		...
		return programDutyAssignmentPersistence.findByPrimaryKey(
			programDutyAssignmentId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(ProgramDutyAssignment.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, programDutyAssignment);
				}
		...
		exportActionableDynamicQuery.setStagedModelType(
			new StagedModelType(
				PortalUtil.getClassNameId(
					ProgramDutyAssignment.class.getName())));
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return programDutyAssignmentPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ProgramDutyAssignmentLocalServiceImpl#deleteProgramDutyAssignment(ProgramDutyAssignment) to avoid orphaned data");
		}

		return programDutyAssignmentLocalService.deleteProgramDutyAssignment(
			(ProgramDutyAssignment)persistedModel);
	}

	@Override
	public BasePersistence<ProgramDutyAssignment> getBasePersistence() {
		return programDutyAssignmentPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return programDutyAssignmentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ProgramDutyAssignment>
		...
		return programDutyAssignmentPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<ProgramDutyAssignment>
		...
		return programDutyAssignmentPersistence.findByUuid_C(
	...
	public ProgramDutyAssignment getProgramDutyAssignmentByUuidAndGroupId(
		...
		return programDutyAssignmentPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<ProgramDutyAssignment> getProgramDutyAssignments(
		...
		return programDutyAssignmentPersistence.findAll(start, end);
	}
	...
	public int getProgramDutyAssignmentsCount() {
		return programDutyAssignmentPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProgramDutyAssignmentLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		programDutyAssignmentLocalService =
			(ProgramDutyAssignmentLocalService)aopProxy;

		_setLocalServiceUtilService(programDutyAssignmentLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProgramDutyAssignmentLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				programDutyAssignmentPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				ProgramDutyAssignmentLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, programDutyAssignmentLocalService);
		}
	...
	protected ProgramDutyAssignmentLocalService
		programDutyAssignmentLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProgramDutyAssignmentLocalServiceBaseImpl.class);
