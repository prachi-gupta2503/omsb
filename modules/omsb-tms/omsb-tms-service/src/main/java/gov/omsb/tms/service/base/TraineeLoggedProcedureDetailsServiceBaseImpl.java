...
import gov.omsb.tms.service.TraineeLoggedProcedureDetailsService;
import gov.omsb.tms.service.TraineeLoggedProcedureDetailsServiceUtil;
...
/**
 * Provides the base implementation for the trainee logged procedure details remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.TraineeLoggedProcedureDetailsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.TraineeLoggedProcedureDetailsServiceImpl
 * @generated
 */
public abstract class TraineeLoggedProcedureDetailsServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TraineeLoggedProcedureDetailsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TraineeLoggedProcedureDetailsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TraineeLoggedProcedureDetailsService.class,
	...
	public void setAopProxy(Object aopProxy) {
		traineeLoggedProcedureDetailsService =
			(TraineeLoggedProcedureDetailsService)aopProxy;

		_setServiceUtilService(traineeLoggedProcedureDetailsService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TraineeLoggedProcedureDetailsService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				TraineeLoggedProcedureDetailsServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, traineeLoggedProcedureDetailsService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.TraineeLoggedProcedureDetailsLocalService
		traineeLoggedProcedureDetailsLocalService;

	protected TraineeLoggedProcedureDetailsService
		traineeLoggedProcedureDetailsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TraineeLoggedProcedureDetailsServiceBaseImpl.class);
