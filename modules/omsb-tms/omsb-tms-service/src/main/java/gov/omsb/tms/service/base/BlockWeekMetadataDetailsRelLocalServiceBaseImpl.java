...
/**
 * Provides the base implementation for the block week metadata details rel local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.BlockWeekMetadataDetailsRelLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.BlockWeekMetadataDetailsRelLocalServiceImpl
 * @generated
 */
public abstract class BlockWeekMetadataDetailsRelLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, BlockWeekMetadataDetailsRelLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BlockWeekMetadataDetailsRelLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>BlockWeekMetadataDetailsRelLocalServiceUtil</code>.
	 */
	...
	public BlockWeekMetadataDetailsRel addBlockWeekMetadataDetailsRel(
		...
		return blockWeekMetadataDetailsRelPersistence.update(
	...
	public BlockWeekMetadataDetailsRel createBlockWeekMetadataDetailsRel(
		...
		return blockWeekMetadataDetailsRelPersistence.create(
	...
	public BlockWeekMetadataDetailsRel deleteBlockWeekMetadataDetailsRel(
		...
		return blockWeekMetadataDetailsRelPersistence.remove(
			blockWeekMetadataDetailsRelId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return blockWeekMetadataDetailsRelPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			BlockWeekMetadataDetailsRel.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return blockWeekMetadataDetailsRelPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return blockWeekMetadataDetailsRelPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public BlockWeekMetadataDetailsRel fetchBlockWeekMetadataDetailsRel(
		...
		return blockWeekMetadataDetailsRelPersistence.fetchByPrimaryKey(
			blockWeekMetadataDetailsRelId);
	}
	...
	public BlockWeekMetadataDetailsRel
		...
		return blockWeekMetadataDetailsRelPersistence.fetchByUUID_G(
			uuid, groupId);
	}
	...
	public BlockWeekMetadataDetailsRel getBlockWeekMetadataDetailsRel(
		...
		return blockWeekMetadataDetailsRelPersistence.findByPrimaryKey(
			blockWeekMetadataDetailsRelId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(BlockWeekMetadataDetailsRel.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			BlockWeekMetadataDetailsRel.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement BlockWeekMetadataDetailsRelLocalServiceImpl#deleteBlockWeekMetadataDetailsRel(BlockWeekMetadataDetailsRel) to avoid orphaned data");
		}

		return blockWeekMetadataDetailsRelLocalService.
			deleteBlockWeekMetadataDetailsRel(
				(BlockWeekMetadataDetailsRel)persistedModel);
	}

	@Override
	public BasePersistence<BlockWeekMetadataDetailsRel> getBasePersistence() {
		return blockWeekMetadataDetailsRelPersistence;
	}
	...
	public List<BlockWeekMetadataDetailsRel>
		...
		return blockWeekMetadataDetailsRelPersistence.findByUuid_C(
			uuid, companyId);
	}
	...
	public BlockWeekMetadataDetailsRel
		...
		return blockWeekMetadataDetailsRelPersistence.findByUUID_G(
			uuid, groupId);
	}
	...
	public List<BlockWeekMetadataDetailsRel> getBlockWeekMetadataDetailsRels(
		...
		return blockWeekMetadataDetailsRelPersistence.findAll(start, end);
	}
	...
	public int getBlockWeekMetadataDetailsRelsCount() {
		return blockWeekMetadataDetailsRelPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BlockWeekMetadataDetailsRelLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		blockWeekMetadataDetailsRelLocalService =
			(BlockWeekMetadataDetailsRelLocalService)aopProxy;

		_setLocalServiceUtilService(blockWeekMetadataDetailsRelLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return BlockWeekMetadataDetailsRelLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				blockWeekMetadataDetailsRelPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				BlockWeekMetadataDetailsRelLocalServiceUtil.class.
					getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, blockWeekMetadataDetailsRelLocalService);
		}
	...
	protected BlockWeekMetadataDetailsRelLocalService
		blockWeekMetadataDetailsRelLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		BlockWeekMetadataDetailsRelLocalServiceBaseImpl.class);
