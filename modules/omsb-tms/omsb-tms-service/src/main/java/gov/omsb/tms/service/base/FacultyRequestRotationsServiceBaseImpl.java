...
import gov.omsb.tms.service.FacultyRequestRotationsService;
import gov.omsb.tms.service.FacultyRequestRotationsServiceUtil;
...
/**
 * Provides the base implementation for the faculty request rotations remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.FacultyRequestRotationsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.FacultyRequestRotationsServiceImpl
 * @generated
 */
public abstract class FacultyRequestRotationsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FacultyRequestRotationsService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FacultyRequestRotationsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>FacultyRequestRotationsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FacultyRequestRotationsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		facultyRequestRotationsService =
			(FacultyRequestRotationsService)aopProxy;

		_setServiceUtilService(facultyRequestRotationsService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return FacultyRequestRotationsService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				FacultyRequestRotationsServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, facultyRequestRotationsService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.FacultyRequestRotationsLocalService
		facultyRequestRotationsLocalService;

	protected FacultyRequestRotationsService facultyRequestRotationsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FacultyRequestRotationsServiceBaseImpl.class);
