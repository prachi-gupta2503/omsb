...
import gov.omsb.tms.service.FacultyRequestStateService;
import gov.omsb.tms.service.FacultyRequestStateServiceUtil;
...
/**
 * Provides the base implementation for the faculty request state remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.FacultyRequestStateServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.FacultyRequestStateServiceImpl
 * @generated
 */
public abstract class FacultyRequestStateServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FacultyRequestStateService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FacultyRequestStateService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>FacultyRequestStateServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FacultyRequestStateService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		facultyRequestStateService = (FacultyRequestStateService)aopProxy;

		_setServiceUtilService(facultyRequestStateService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return FacultyRequestStateService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = FacultyRequestStateServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, facultyRequestStateService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.FacultyRequestStateLocalService
		facultyRequestStateLocalService;

	protected FacultyRequestStateService facultyRequestStateService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FacultyRequestStateServiceBaseImpl.class);
