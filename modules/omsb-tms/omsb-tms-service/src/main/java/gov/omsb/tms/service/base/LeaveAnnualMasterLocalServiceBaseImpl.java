...
/**
 * Provides the base implementation for the leave annual master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.LeaveAnnualMasterLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.LeaveAnnualMasterLocalServiceImpl
 * @generated
 */
public abstract class LeaveAnnualMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   LeaveAnnualMasterLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LeaveAnnualMasterLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>LeaveAnnualMasterLocalServiceUtil</code>.
	 */
	...
	@Override
	public LeaveAnnualMaster addLeaveAnnualMaster(
		LeaveAnnualMaster leaveAnnualMaster) {

		leaveAnnualMaster.setNew(true);

		return leaveAnnualMasterPersistence.update(leaveAnnualMaster);
	}
	...
	public LeaveAnnualMaster createLeaveAnnualMaster(long leaveAnnualMasterId) {
		return leaveAnnualMasterPersistence.create(leaveAnnualMasterId);
	}
	...
	@Override
	public LeaveAnnualMaster deleteLeaveAnnualMaster(long leaveAnnualMasterId)
		throws PortalException {

		return leaveAnnualMasterPersistence.remove(leaveAnnualMasterId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LeaveAnnualMaster deleteLeaveAnnualMaster(
		LeaveAnnualMaster leaveAnnualMaster) {

		return leaveAnnualMasterPersistence.remove(leaveAnnualMaster);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return leaveAnnualMasterPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			LeaveAnnualMaster.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return leaveAnnualMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return leaveAnnualMasterPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return leaveAnnualMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return leaveAnnualMasterPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public LeaveAnnualMaster fetchLeaveAnnualMaster(long leaveAnnualMasterId) {
		return leaveAnnualMasterPersistence.fetchByPrimaryKey(
			leaveAnnualMasterId);
	}
	 ...
	 */
	@Override
	public LeaveAnnualMaster fetchLeaveAnnualMasterByUuidAndGroupId(
		String uuid, long groupId) {

		return leaveAnnualMasterPersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public LeaveAnnualMaster getLeaveAnnualMaster(long leaveAnnualMasterId)
		throws PortalException {

		return leaveAnnualMasterPersistence.findByPrimaryKey(
			leaveAnnualMasterId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(LeaveAnnualMaster.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("leaveAnnualMasterId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(LeaveAnnualMaster.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod
				...
				@Override
				public void performAction(LeaveAnnualMaster leaveAnnualMaster)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, leaveAnnualMaster);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return leaveAnnualMasterPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement LeaveAnnualMasterLocalServiceImpl#deleteLeaveAnnualMaster(LeaveAnnualMaster) to avoid orphaned data");
		}

		return leaveAnnualMasterLocalService.deleteLeaveAnnualMaster(
			(LeaveAnnualMaster)persistedModel);
	}

	@Override
	public BasePersistence<LeaveAnnualMaster> getBasePersistence() {
		return leaveAnnualMasterPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return leaveAnnualMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LeaveAnnualMaster> getLeaveAnnualMastersByUuidAndCompanyId(
		String uuid, long companyId) {

		return leaveAnnualMasterPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<LeaveAnnualMaster> getLeaveAnnualMastersByUuidAndCompanyId(
		...
		return leaveAnnualMasterPersistence.findByUuid_C(
	 ...
	 */
	@Override
	public LeaveAnnualMaster getLeaveAnnualMasterByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return leaveAnnualMasterPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<LeaveAnnualMaster> getLeaveAnnualMasters(int start, int end) {
		return leaveAnnualMasterPersistence.findAll(start, end);
	}
	...
	public int getLeaveAnnualMastersCount() {
		return leaveAnnualMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LeaveAnnualMaster updateLeaveAnnualMaster(
		LeaveAnnualMaster leaveAnnualMaster) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LeaveAnnualMasterLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		leaveAnnualMasterLocalService = (LeaveAnnualMasterLocalService)aopProxy;

		_setLocalServiceUtilService(leaveAnnualMasterLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return LeaveAnnualMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				leaveAnnualMasterPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				LeaveAnnualMasterLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, leaveAnnualMasterLocalService);
		}
	...
	protected LeaveAnnualMasterLocalService leaveAnnualMasterLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LeaveAnnualMasterLocalServiceBaseImpl.class);
