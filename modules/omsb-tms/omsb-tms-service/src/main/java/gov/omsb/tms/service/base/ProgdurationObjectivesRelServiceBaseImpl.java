...
import gov.omsb.tms.service.ProgdurationObjectivesRelService;
import gov.omsb.tms.service.ProgdurationObjectivesRelServiceUtil;
...
/**
 * Provides the base implementation for the progduration objectives rel remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.ProgdurationObjectivesRelServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.ProgdurationObjectivesRelServiceImpl
 * @generated
 */
public abstract class ProgdurationObjectivesRelServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   ProgdurationObjectivesRelService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProgdurationObjectivesRelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProgdurationObjectivesRelServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProgdurationObjectivesRelService.class,
	...
	public void setAopProxy(Object aopProxy) {
		progdurationObjectivesRelService =
			(ProgdurationObjectivesRelService)aopProxy;

		_setServiceUtilService(progdurationObjectivesRelService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProgdurationObjectivesRelService.class.getName();
	}
	...
	private void _setServiceUtilService(
		ProgdurationObjectivesRelService progdurationObjectivesRelService) {

		try {
			Field field =
				ProgdurationObjectivesRelServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, progdurationObjectivesRelService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.ProgdurationObjectivesRelLocalService
		progdurationObjectivesRelLocalService;

	protected ProgdurationObjectivesRelService progdurationObjectivesRelService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProgdurationObjectivesRelServiceBaseImpl.class);
