...
import gov.omsb.tms.service.FacultyRotationTsBlockDetailsRelService;
import gov.omsb.tms.service.FacultyRotationTsBlockDetailsRelServiceUtil;
...
/**
 * Provides the base implementation for the faculty rotation ts block details rel remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.FacultyRotationTsBlockDetailsRelServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.FacultyRotationTsBlockDetailsRelServiceImpl
 * @generated
 */
public abstract class FacultyRotationTsBlockDetailsRelServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FacultyRotationTsBlockDetailsRelService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FacultyRotationTsBlockDetailsRelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>FacultyRotationTsBlockDetailsRelServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FacultyRotationTsBlockDetailsRelService.class,
	...
	public void setAopProxy(Object aopProxy) {
		facultyRotationTsBlockDetailsRelService =
			(FacultyRotationTsBlockDetailsRelService)aopProxy;

		_setServiceUtilService(facultyRotationTsBlockDetailsRelService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return FacultyRotationTsBlockDetailsRelService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				FacultyRotationTsBlockDetailsRelServiceUtil.class.
					getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, facultyRotationTsBlockDetailsRelService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.FacultyRotationTsBlockDetailsRelLocalService
		facultyRotationTsBlockDetailsRelLocalService;

	protected FacultyRotationTsBlockDetailsRelService
		facultyRotationTsBlockDetailsRelService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FacultyRotationTsBlockDetailsRelServiceBaseImpl.class);
