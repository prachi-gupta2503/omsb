...
import gov.omsb.tms.service.ProgdurationRotationTrainingsitesRelService;
import gov.omsb.tms.service.ProgdurationRotationTrainingsitesRelServiceUtil;
...
/**
 * Provides the base implementation for the progduration rotation trainingsites rel remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.ProgdurationRotationTrainingsitesRelServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.ProgdurationRotationTrainingsitesRelServiceImpl
 * @generated
 */
public abstract class ProgdurationRotationTrainingsitesRelServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   ProgdurationRotationTrainingsitesRelService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProgdurationRotationTrainingsitesRelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProgdurationRotationTrainingsitesRelServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProgdurationRotationTrainingsitesRelService.class,
	...
	public void setAopProxy(Object aopProxy) {
		progdurationRotationTrainingsitesRelService =
			(ProgdurationRotationTrainingsitesRelService)aopProxy;

		_setServiceUtilService(progdurationRotationTrainingsitesRelService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProgdurationRotationTrainingsitesRelService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				ProgdurationRotationTrainingsitesRelServiceUtil.class.
					getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, progdurationRotationTrainingsitesRelService);
		}
	...
	@Reference
	protected
		gov.omsb.tms.service.ProgdurationRotationTrainingsitesRelLocalService
			progdurationRotationTrainingsitesRelLocalService;

	protected ProgdurationRotationTrainingsitesRelService
		progdurationRotationTrainingsitesRelService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProgdurationRotationTrainingsitesRelServiceBaseImpl.class);
