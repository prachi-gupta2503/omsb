...
import gov.omsb.tms.service.TraineeProgdurationTraineelevelDetailsService;
import gov.omsb.tms.service.TraineeProgdurationTraineelevelDetailsServiceUtil;
...
/**
 * Provides the base implementation for the trainee progduration traineelevel details remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.TraineeProgdurationTraineelevelDetailsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.TraineeProgdurationTraineelevelDetailsServiceImpl
 * @generated
 */
public abstract class TraineeProgdurationTraineelevelDetailsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   TraineeProgdurationTraineelevelDetailsService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TraineeProgdurationTraineelevelDetailsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TraineeProgdurationTraineelevelDetailsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TraineeProgdurationTraineelevelDetailsService.class,
	...
	public void setAopProxy(Object aopProxy) {
		traineeProgdurationTraineelevelDetailsService =
			(TraineeProgdurationTraineelevelDetailsService)aopProxy;

		_setServiceUtilService(traineeProgdurationTraineelevelDetailsService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TraineeProgdurationTraineelevelDetailsService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				TraineeProgdurationTraineelevelDetailsServiceUtil.class.
					getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, traineeProgdurationTraineelevelDetailsService);
		}
	...
	@Reference
	protected
		gov.omsb.tms.service.TraineeProgdurationTraineelevelDetailsLocalService
			traineeProgdurationTraineelevelDetailsLocalService;

	protected TraineeProgdurationTraineelevelDetailsService
		traineeProgdurationTraineelevelDetailsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TraineeProgdurationTraineelevelDetailsServiceBaseImpl.class);
