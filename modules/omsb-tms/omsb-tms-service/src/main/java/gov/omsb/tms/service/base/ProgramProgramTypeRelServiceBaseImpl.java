...
import gov.omsb.tms.service.ProgramProgramTypeRelService;
import gov.omsb.tms.service.ProgramProgramTypeRelServiceUtil;
...
/**
 * Provides the base implementation for the program program type rel remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.ProgramProgramTypeRelServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.ProgramProgramTypeRelServiceImpl
 * @generated
 */
public abstract class ProgramProgramTypeRelServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   ProgramProgramTypeRelService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProgramProgramTypeRelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProgramProgramTypeRelServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProgramProgramTypeRelService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		programProgramTypeRelService = (ProgramProgramTypeRelService)aopProxy;

		_setServiceUtilService(programProgramTypeRelService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProgramProgramTypeRelService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				ProgramProgramTypeRelServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, programProgramTypeRelService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.ProgramProgramTypeRelLocalService
		programProgramTypeRelLocalService;

	protected ProgramProgramTypeRelService programProgramTypeRelService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProgramProgramTypeRelServiceBaseImpl.class);
