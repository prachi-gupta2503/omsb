...
/**
 * Provides the base implementation for the leave master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.LeaveMasterLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.LeaveMasterLocalServiceImpl
 * @generated
 */
public abstract class LeaveMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, LeaveMasterLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LeaveMasterLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>LeaveMasterLocalServiceUtil</code>.
	 */
	...
	public LeaveMaster addLeaveMaster(LeaveMaster leaveMaster) {
		...
		return leaveMasterPersistence.update(leaveMaster);
	}
	...
	public LeaveMaster createLeaveMaster(long leaveMasterId) {
		return leaveMasterPersistence.create(leaveMasterId);
	}
	...
	@Override
	public LeaveMaster deleteLeaveMaster(long leaveMasterId)
		throws PortalException {

		return leaveMasterPersistence.remove(leaveMasterId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LeaveMaster deleteLeaveMaster(LeaveMaster leaveMaster) {
		return leaveMasterPersistence.remove(leaveMaster);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return leaveMasterPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			LeaveMaster.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return leaveMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return leaveMasterPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return leaveMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return leaveMasterPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public LeaveMaster fetchLeaveMaster(long leaveMasterId) {
		return leaveMasterPersistence.fetchByPrimaryKey(leaveMasterId);
	}
	 ...
	 */
	@Override
	public LeaveMaster fetchLeaveMasterByUuidAndGroupId(
		String uuid, long groupId) {

		return leaveMasterPersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public LeaveMaster getLeaveMaster(long leaveMasterId)
		throws PortalException {

		return leaveMasterPersistence.findByPrimaryKey(leaveMasterId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(leaveMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(LeaveMaster.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("leaveMasterId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			leaveMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(LeaveMaster.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<LeaveMaster>() {

				@Override
				public void performAction(LeaveMaster leaveMaster)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, leaveMaster);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return leaveMasterPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement LeaveMasterLocalServiceImpl#deleteLeaveMaster(LeaveMaster) to avoid orphaned data");
		}

		return leaveMasterLocalService.deleteLeaveMaster(
			(LeaveMaster)persistedModel);
	}

	@Override
	public BasePersistence<LeaveMaster> getBasePersistence() {
		return leaveMasterPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return leaveMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LeaveMaster> getLeaveMastersByUuidAndCompanyId(
		String uuid, long companyId) {

		return leaveMasterPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<LeaveMaster> getLeaveMastersByUuidAndCompanyId(
		...
		return leaveMasterPersistence.findByUuid_C(
	 ...
	 */
	@Override
	public LeaveMaster getLeaveMasterByUuidAndGroupId(String uuid, long groupId)
		throws PortalException {

		return leaveMasterPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<LeaveMaster> getLeaveMasters(int start, int end) {
		return leaveMasterPersistence.findAll(start, end);
	}
	...
	public int getLeaveMastersCount() {
		return leaveMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LeaveMaster updateLeaveMaster(LeaveMaster leaveMaster) {
		return leaveMasterPersistence.update(leaveMaster);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LeaveMasterLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		leaveMasterLocalService = (LeaveMasterLocalService)aopProxy;

		_setLocalServiceUtilService(leaveMasterLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return LeaveMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = leaveMasterPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = LeaveMasterLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, leaveMasterLocalService);
		}
	...
	protected LeaveMasterLocalService leaveMasterLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LeaveMasterLocalServiceBaseImpl.class);
