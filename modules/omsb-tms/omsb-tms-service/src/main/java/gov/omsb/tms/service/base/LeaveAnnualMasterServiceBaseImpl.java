...
import gov.omsb.tms.service.LeaveAnnualMasterService;
import gov.omsb.tms.service.LeaveAnnualMasterServiceUtil;
...
/**
 * Provides the base implementation for the leave annual master remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.LeaveAnnualMasterServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.LeaveAnnualMasterServiceImpl
 * @generated
 */
public abstract class LeaveAnnualMasterServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, LeaveAnnualMasterService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LeaveAnnualMasterService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>LeaveAnnualMasterServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LeaveAnnualMasterService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		leaveAnnualMasterService = (LeaveAnnualMasterService)aopProxy;

		_setServiceUtilService(leaveAnnualMasterService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return LeaveAnnualMasterService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = LeaveAnnualMasterServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, leaveAnnualMasterService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.LeaveAnnualMasterLocalService
		leaveAnnualMasterLocalService;

	protected LeaveAnnualMasterService leaveAnnualMasterService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LeaveAnnualMasterServiceBaseImpl.class);
