...
import gov.omsb.tms.service.TraineeCohortDetailsService;
import gov.omsb.tms.service.TraineeCohortDetailsServiceUtil;
...
/**
 * Provides the base implementation for the trainee cohort details remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.TraineeCohortDetailsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.TraineeCohortDetailsServiceImpl
 * @generated
 */
public abstract class TraineeCohortDetailsServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TraineeCohortDetailsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TraineeCohortDetailsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TraineeCohortDetailsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		traineeCohortDetailsService = (TraineeCohortDetailsService)aopProxy;

		_setServiceUtilService(traineeCohortDetailsService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TraineeCohortDetailsService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				TraineeCohortDetailsServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, traineeCohortDetailsService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.TraineeCohortDetailsLocalService
		traineeCohortDetailsLocalService;

	protected TraineeCohortDetailsService traineeCohortDetailsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TraineeCohortDetailsServiceBaseImpl.class);
