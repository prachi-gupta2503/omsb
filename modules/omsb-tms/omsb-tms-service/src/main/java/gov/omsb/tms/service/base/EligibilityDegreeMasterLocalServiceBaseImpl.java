...
import gov.omsb.tms.service.EligibilityDegreeMasterLocalServiceUtil;
...
/**
 * Provides the base implementation for the eligibility degree master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.EligibilityDegreeMasterLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.EligibilityDegreeMasterLocalServiceImpl
 * @generated
 */
public abstract class EligibilityDegreeMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EligibilityDegreeMasterLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EligibilityDegreeMasterLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>EligibilityDegreeMasterLocalServiceUtil</code>.
	 */
	...
	public EligibilityDegreeMaster addEligibilityDegreeMaster(
		...
		return eligibilityDegreeMasterPersistence.update(
	...
	public EligibilityDegreeMaster createEligibilityDegreeMaster(
		...
		return eligibilityDegreeMasterPersistence.create(
	...
	public EligibilityDegreeMaster deleteEligibilityDegreeMaster(
		...
		return eligibilityDegreeMasterPersistence.remove(
			eligibilityDegreeMasterId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return eligibilityDegreeMasterPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EligibilityDegreeMaster.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return eligibilityDegreeMasterPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return eligibilityDegreeMasterPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public EligibilityDegreeMaster fetchEligibilityDegreeMaster(
		...
		return eligibilityDegreeMasterPersistence.fetchByPrimaryKey(
			eligibilityDegreeMasterId);
	}
	...
	public EligibilityDegreeMaster fetchEligibilityDegreeMasterByUuidAndGroupId(
		...
		return eligibilityDegreeMasterPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public EligibilityDegreeMaster getEligibilityDegreeMaster(
		...
		return eligibilityDegreeMasterPersistence.findByPrimaryKey(
			eligibilityDegreeMasterId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(EligibilityDegreeMaster.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, eligibilityDegreeMaster);
				}
		...
		exportActionableDynamicQuery.setStagedModelType(
			new StagedModelType(
				PortalUtil.getClassNameId(
					EligibilityDegreeMaster.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement EligibilityDegreeMasterLocalServiceImpl#deleteEligibilityDegreeMaster(EligibilityDegreeMaster) to avoid orphaned data");
		}

		return eligibilityDegreeMasterLocalService.
			deleteEligibilityDegreeMaster(
				(EligibilityDegreeMaster)persistedModel);
	}

	@Override
	public BasePersistence<EligibilityDegreeMaster> getBasePersistence() {
		return eligibilityDegreeMasterPersistence;
	}
	...
	public List<EligibilityDegreeMaster>
		...
		return eligibilityDegreeMasterPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<EligibilityDegreeMaster>
		...
		return eligibilityDegreeMasterPersistence.findByUuid_C(
	...
	public EligibilityDegreeMaster getEligibilityDegreeMasterByUuidAndGroupId(
		...
		return eligibilityDegreeMasterPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<EligibilityDegreeMaster> getEligibilityDegreeMasters(
		...
		return eligibilityDegreeMasterPersistence.findAll(start, end);
	}
	...
	public int getEligibilityDegreeMastersCount() {
		return eligibilityDegreeMasterPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EligibilityDegreeMasterLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		eligibilityDegreeMasterLocalService =
			(EligibilityDegreeMasterLocalService)aopProxy;

		_setLocalServiceUtilService(eligibilityDegreeMasterLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return EligibilityDegreeMasterLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				EligibilityDegreeMasterLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, eligibilityDegreeMasterLocalService);
		}
	...
	protected EligibilityDegreeMasterLocalService
		eligibilityDegreeMasterLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EligibilityDegreeMasterLocalServiceBaseImpl.class);
