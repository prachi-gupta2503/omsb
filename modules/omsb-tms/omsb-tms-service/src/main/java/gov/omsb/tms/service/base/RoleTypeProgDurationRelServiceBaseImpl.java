...
import gov.omsb.tms.service.RoleTypeProgDurationRelService;
import gov.omsb.tms.service.RoleTypeProgDurationRelServiceUtil;
...
/**
 * Provides the base implementation for the role type prog duration rel remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.RoleTypeProgDurationRelServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.RoleTypeProgDurationRelServiceImpl
 * @generated
 */
public abstract class RoleTypeProgDurationRelServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   RoleTypeProgDurationRelService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>RoleTypeProgDurationRelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>RoleTypeProgDurationRelServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			RoleTypeProgDurationRelService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		roleTypeProgDurationRelService =
			(RoleTypeProgDurationRelService)aopProxy;

		_setServiceUtilService(roleTypeProgDurationRelService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return RoleTypeProgDurationRelService.class.getName();
	}

	protected Class<?> getModelClass() {
		return RoleTypeProgDurationRel.class;
	}

	protected String getModelClassName() {
		return RoleTypeProgDurationRel.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				roleTypeProgDurationRelPersistence.getDataSource();
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				RoleTypeProgDurationRelServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, roleTypeProgDurationRelService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.RoleTypeProgDurationRelLocalService
		roleTypeProgDurationRelLocalService;

	protected RoleTypeProgDurationRelService roleTypeProgDurationRelService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		RoleTypeProgDurationRelServiceBaseImpl.class);
