...
import gov.omsb.tms.service.DutyTypesService;
import gov.omsb.tms.service.DutyTypesServiceUtil;
...
/**
 * Provides the base implementation for the duty types remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.DutyTypesServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.DutyTypesServiceImpl
 * @generated
 */
public abstract class DutyTypesServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DutyTypesService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DutyTypesService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DutyTypesServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DutyTypesService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		dutyTypesService = (DutyTypesService)aopProxy;

		_setServiceUtilService(dutyTypesService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DutyTypesService.class.getName();
	}
	...
	private void _setServiceUtilService(DutyTypesService dutyTypesService) {
		try {
			Field field = DutyTypesServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, dutyTypesService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.DutyTypesLocalService dutyTypesLocalService;

	protected DutyTypesService dutyTypesService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DutyTypesServiceBaseImpl.class);
