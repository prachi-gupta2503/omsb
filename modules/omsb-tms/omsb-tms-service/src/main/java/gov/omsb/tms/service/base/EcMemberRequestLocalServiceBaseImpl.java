...
/**
 * Provides the base implementation for the ec member request local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.EcMemberRequestLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.EcMemberRequestLocalServiceImpl
 * @generated
 */
public abstract class EcMemberRequestLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EcMemberRequestLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EcMemberRequestLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>EcMemberRequestLocalServiceUtil</code>.
	 */
	...
	public EcMemberRequest addEcMemberRequest(EcMemberRequest ecMemberRequest) {
		...
		return ecMemberRequestPersistence.update(ecMemberRequest);
	}
	...
	public EcMemberRequest createEcMemberRequest(long ecMemberRequestId) {
		return ecMemberRequestPersistence.create(ecMemberRequestId);
	}
	...
	public EcMemberRequest deleteEcMemberRequest(long ecMemberRequestId)
		...
		return ecMemberRequestPersistence.remove(ecMemberRequestId);
	}
	...
	public EcMemberRequest deleteEcMemberRequest(
		...
		return ecMemberRequestPersistence.remove(ecMemberRequest);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return ecMemberRequestPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EcMemberRequest.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ecMemberRequestPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return ecMemberRequestPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ecMemberRequestPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return ecMemberRequestPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public EcMemberRequest fetchEcMemberRequest(long ecMemberRequestId) {
		return ecMemberRequestPersistence.fetchByPrimaryKey(ecMemberRequestId);
	}
	...
	public EcMemberRequest fetchEcMemberRequestByUuidAndGroupId(
		...
		return ecMemberRequestPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public EcMemberRequest getEcMemberRequest(long ecMemberRequestId)
		...
		return ecMemberRequestPersistence.findByPrimaryKey(ecMemberRequestId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ecMemberRequestLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(EcMemberRequest.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("ecMemberRequestId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			ecMemberRequestLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(EcMemberRequest.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<EcMemberRequest>() {

				@Override
				public void performAction(EcMemberRequest ecMemberRequest)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, ecMemberRequest);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return ecMemberRequestPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement EcMemberRequestLocalServiceImpl#deleteEcMemberRequest(EcMemberRequest) to avoid orphaned data");
		}

		return ecMemberRequestLocalService.deleteEcMemberRequest(
			(EcMemberRequest)persistedModel);
	}

	@Override
	public BasePersistence<EcMemberRequest> getBasePersistence() {
		return ecMemberRequestPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return ecMemberRequestPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<EcMemberRequest> getEcMemberRequestsByUuidAndCompanyId(
		...
		return ecMemberRequestPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<EcMemberRequest> getEcMemberRequestsByUuidAndCompanyId(
		...
		return ecMemberRequestPersistence.findByUuid_C(
	...
	public EcMemberRequest getEcMemberRequestByUuidAndGroupId(
		...
		return ecMemberRequestPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<EcMemberRequest> getEcMemberRequests(int start, int end) {
		return ecMemberRequestPersistence.findAll(start, end);
	}
	...
	public int getEcMemberRequestsCount() {
		return ecMemberRequestPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EcMemberRequestLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		ecMemberRequestLocalService = (EcMemberRequestLocalService)aopProxy;

		_setLocalServiceUtilService(ecMemberRequestLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return EcMemberRequestLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ecMemberRequestPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				EcMemberRequestLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, ecMemberRequestLocalService);
		}
	...
	protected EcMemberRequestLocalService ecMemberRequestLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EcMemberRequestLocalServiceBaseImpl.class);
