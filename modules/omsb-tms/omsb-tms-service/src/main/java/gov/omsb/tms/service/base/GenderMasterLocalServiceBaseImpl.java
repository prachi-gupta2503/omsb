...
/**
 * Provides the base implementation for the gender master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.GenderMasterLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.GenderMasterLocalServiceImpl
 * @generated
 */
public abstract class GenderMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, GenderMasterLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>GenderMasterLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>GenderMasterLocalServiceUtil</code>.
	 */
	...
	@Override
	public GenderMaster addGenderMaster(GenderMaster genderMaster) {
		genderMaster.setNew(true);

		return genderMasterPersistence.update(genderMaster);
	}
	...
	public GenderMaster createGenderMaster(long genderMasterId) {
		return genderMasterPersistence.create(genderMasterId);
	}
	...
	@Override
	public GenderMaster deleteGenderMaster(long genderMasterId)
		throws PortalException {

		return genderMasterPersistence.remove(genderMasterId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public GenderMaster deleteGenderMaster(GenderMaster genderMaster) {
		return genderMasterPersistence.remove(genderMaster);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return genderMasterPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			GenderMaster.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return genderMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return genderMasterPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return genderMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return genderMasterPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public GenderMaster fetchGenderMaster(long genderMasterId) {
		return genderMasterPersistence.fetchByPrimaryKey(genderMasterId);
	}
	 ...
	 */
	@Override
	public GenderMaster fetchGenderMasterByUuidAndGroupId(
		String uuid, long groupId) {

		return genderMasterPersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public GenderMaster getGenderMaster(long genderMasterId)
		throws PortalException {

		return genderMasterPersistence.findByPrimaryKey(genderMasterId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(genderMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(GenderMaster.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("genderMasterId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			genderMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(GenderMaster.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<GenderMaster>() {

				@Override
				public void performAction(GenderMaster genderMaster)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, genderMaster);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return genderMasterPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement GenderMasterLocalServiceImpl#deleteGenderMaster(GenderMaster) to avoid orphaned data");
		}

		return genderMasterLocalService.deleteGenderMaster(
			(GenderMaster)persistedModel);
	}

	@Override
	public BasePersistence<GenderMaster> getBasePersistence() {
		return genderMasterPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return genderMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<GenderMaster> getGenderMastersByUuidAndCompanyId(
		String uuid, long companyId) {

		return genderMasterPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<GenderMaster> getGenderMastersByUuidAndCompanyId(
		...
		return genderMasterPersistence.findByUuid_C(
	 ...
	 */
	@Override
	public GenderMaster getGenderMasterByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return genderMasterPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<GenderMaster> getGenderMasters(int start, int end) {
		return genderMasterPersistence.findAll(start, end);
	}
	...
	public int getGenderMastersCount() {
		return genderMasterPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GenderMaster updateGenderMaster(GenderMaster genderMaster) {
		return genderMasterPersistence.update(genderMaster);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			GenderMasterLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		genderMasterLocalService = (GenderMasterLocalService)aopProxy;

		_setLocalServiceUtilService(genderMasterLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return GenderMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = genderMasterPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = GenderMasterLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, genderMasterLocalService);
		}
	...
	protected GenderMasterLocalService genderMasterLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		GenderMasterLocalServiceBaseImpl.class);
