...
import gov.omsb.tms.service.ProcedureMasterService;
import gov.omsb.tms.service.ProcedureMasterServiceUtil;
...
/**
 * Provides the base implementation for the procedure master remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.ProcedureMasterServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.ProcedureMasterServiceImpl
 * @generated
 */
public abstract class ProcedureMasterServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, ProcedureMasterService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProcedureMasterService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProcedureMasterServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProcedureMasterService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		procedureMasterService = (ProcedureMasterService)aopProxy;

		_setServiceUtilService(procedureMasterService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProcedureMasterService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = procedureMasterPersistence.getDataSource();
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = ProcedureMasterServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, procedureMasterService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.ProcedureMasterLocalService
		procedureMasterLocalService;

	protected ProcedureMasterService procedureMasterService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProcedureMasterServiceBaseImpl.class);
