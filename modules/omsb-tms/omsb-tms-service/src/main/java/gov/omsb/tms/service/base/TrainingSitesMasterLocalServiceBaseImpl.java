...
/**
 * Provides the base implementation for the training sites master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.TrainingSitesMasterLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.TrainingSitesMasterLocalServiceImpl
 * @generated
 */
public abstract class TrainingSitesMasterLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TrainingSitesMasterLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TrainingSitesMasterLocalServiceUtil</code>.
	 */
	...
	public TrainingSitesMaster addTrainingSitesMaster(
		...
		return trainingSitesMasterPersistence.update(trainingSitesMaster);
	}
	...
	public TrainingSitesMaster createTrainingSitesMaster(
		...
		return trainingSitesMasterPersistence.create(trainingSiteMasterId);
	}
	...
	public TrainingSitesMaster deleteTrainingSitesMaster(
		...
		return trainingSitesMasterPersistence.remove(trainingSiteMasterId);
	}
	...
	public TrainingSitesMaster deleteTrainingSitesMaster(
		...
		return trainingSitesMasterPersistence.remove(trainingSitesMaster);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return trainingSitesMasterPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TrainingSitesMaster.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return trainingSitesMasterPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return trainingSitesMasterPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public TrainingSitesMaster fetchTrainingSitesMaster(
		...
		return trainingSitesMasterPersistence.fetchByPrimaryKey(
	...
	public TrainingSitesMaster fetchTrainingSitesMasterByUuidAndGroupId(
		...
		return trainingSitesMasterPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public TrainingSitesMaster getTrainingSitesMaster(long trainingSiteMasterId)
		...
		return trainingSitesMasterPersistence.findByPrimaryKey(
			trainingSiteMasterId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(TrainingSitesMaster.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, trainingSitesMaster);
				}
		...
		exportActionableDynamicQuery.setStagedModelType(
			new StagedModelType(
				PortalUtil.getClassNameId(
					TrainingSitesMaster.class.getName())));
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return trainingSitesMasterPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TrainingSitesMasterLocalServiceImpl#deleteTrainingSitesMaster(TrainingSitesMaster) to avoid orphaned data");
		}

		return trainingSitesMasterLocalService.deleteTrainingSitesMaster(
			(TrainingSitesMaster)persistedModel);
	}

	@Override
	public BasePersistence<TrainingSitesMaster> getBasePersistence() {
		return trainingSitesMasterPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return trainingSitesMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TrainingSitesMaster> getTrainingSitesMastersByUuidAndCompanyId(
		...
		return trainingSitesMasterPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<TrainingSitesMaster> getTrainingSitesMastersByUuidAndCompanyId(
		...
		return trainingSitesMasterPersistence.findByUuid_C(
	...
	public TrainingSitesMaster getTrainingSitesMasterByUuidAndGroupId(
		...
		return trainingSitesMasterPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<TrainingSitesMaster> getTrainingSitesMasters(
		...
		return trainingSitesMasterPersistence.findAll(start, end);
	}
	...
	public int getTrainingSitesMastersCount() {
		return trainingSitesMasterPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TrainingSitesMasterLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		trainingSitesMasterLocalService =
			(TrainingSitesMasterLocalService)aopProxy;

		_setLocalServiceUtilService(trainingSitesMasterLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TrainingSitesMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				trainingSitesMasterPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				TrainingSitesMasterLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, trainingSitesMasterLocalService);
		}
	...
	protected TrainingSitesMasterLocalService trainingSitesMasterLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TrainingSitesMasterLocalServiceBaseImpl.class);
