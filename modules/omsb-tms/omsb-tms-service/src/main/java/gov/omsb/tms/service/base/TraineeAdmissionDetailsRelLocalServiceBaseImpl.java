...
/**
 * Provides the base implementation for the trainee admission details rel local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.TraineeAdmissionDetailsRelLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.TraineeAdmissionDetailsRelLocalServiceImpl
 * @generated
 */
public abstract class TraineeAdmissionDetailsRelLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TraineeAdmissionDetailsRelLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TraineeAdmissionDetailsRelLocalServiceUtil</code>.
	 */
	...
	@Override
	public TraineeAdmissionDetailsRel addTraineeAdmissionDetailsRel(
		TraineeAdmissionDetailsRel traineeAdmissionDetailsRel) {

		traineeAdmissionDetailsRel.setNew(true);

		return traineeAdmissionDetailsRelPersistence.update(
	...
	public TraineeAdmissionDetailsRel createTraineeAdmissionDetailsRel(
		long traineeAdmissionDetailsRelId) {

		return traineeAdmissionDetailsRelPersistence.create(
	...
	@Override
	public TraineeAdmissionDetailsRel deleteTraineeAdmissionDetailsRel(
			long traineeAdmissionDetailsRelId)
		throws PortalException {

		return traineeAdmissionDetailsRelPersistence.remove(
			traineeAdmissionDetailsRelId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return traineeAdmissionDetailsRelPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TraineeAdmissionDetailsRel.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return traineeAdmissionDetailsRelPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return traineeAdmissionDetailsRelPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public TraineeAdmissionDetailsRel fetchTraineeAdmissionDetailsRel(
		long traineeAdmissionDetailsRelId) {

		return traineeAdmissionDetailsRelPersistence.fetchByPrimaryKey(
			traineeAdmissionDetailsRelId);
	}
	 ...
	 */
	@Override
	public TraineeAdmissionDetailsRel
		fetchTraineeAdmissionDetailsRelByUuidAndGroupId(
			String uuid, long groupId) {

		return traineeAdmissionDetailsRelPersistence.fetchByUUID_G(
			uuid, groupId);
	}
	 ...
	 */
	@Override
	public TraineeAdmissionDetailsRel getTraineeAdmissionDetailsRel(
			long traineeAdmissionDetailsRelId)
		throws PortalException {

		return traineeAdmissionDetailsRelPersistence.findByPrimaryKey(
			traineeAdmissionDetailsRelId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(TraineeAdmissionDetailsRel.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			TraineeAdmissionDetailsRel.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, traineeAdmissionDetailsRel);
				}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TraineeAdmissionDetailsRelLocalServiceImpl#deleteTraineeAdmissionDetailsRel(TraineeAdmissionDetailsRel) to avoid orphaned data");
		}

		return traineeAdmissionDetailsRelLocalService.
			deleteTraineeAdmissionDetailsRel(
				(TraineeAdmissionDetailsRel)persistedModel);
	}

	@Override
	public BasePersistence<TraineeAdmissionDetailsRel> getBasePersistence() {
		return traineeAdmissionDetailsRelPersistence;
	}
	 ...
	 */
	@Override
	public List<TraineeAdmissionDetailsRel>
		getTraineeAdmissionDetailsRelsByUuidAndCompanyId(
			String uuid, long companyId) {

		return traineeAdmissionDetailsRelPersistence.findByUuid_C(
			uuid, companyId);
	}
	...
	public TraineeAdmissionDetailsRel
		...
		return traineeAdmissionDetailsRelPersistence.findByUUID_G(
			uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<TraineeAdmissionDetailsRel> getTraineeAdmissionDetailsRels(
		int start, int end) {

		return traineeAdmissionDetailsRelPersistence.findAll(start, end);
	}
	...
	public int getTraineeAdmissionDetailsRelsCount() {
		return traineeAdmissionDetailsRelPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TraineeAdmissionDetailsRel updateTraineeAdmissionDetailsRel(
		TraineeAdmissionDetailsRel traineeAdmissionDetailsRel) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TraineeAdmissionDetailsRelLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		traineeAdmissionDetailsRelLocalService =
			(TraineeAdmissionDetailsRelLocalService)aopProxy;

		_setLocalServiceUtilService(traineeAdmissionDetailsRelLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TraineeAdmissionDetailsRelLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				traineeAdmissionDetailsRelPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				TraineeAdmissionDetailsRelLocalServiceUtil.class.
					getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, traineeAdmissionDetailsRelLocalService);
		}
	...
	protected TraineeAdmissionDetailsRelLocalService
		traineeAdmissionDetailsRelLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TraineeAdmissionDetailsRelLocalServiceBaseImpl.class);
