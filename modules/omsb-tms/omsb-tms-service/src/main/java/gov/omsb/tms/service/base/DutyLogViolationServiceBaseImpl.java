...
import gov.omsb.tms.service.DutyLogViolationService;
import gov.omsb.tms.service.DutyLogViolationServiceUtil;
...
/**
 * Provides the base implementation for the duty log violation remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.DutyLogViolationServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.DutyLogViolationServiceImpl
 * @generated
 */
public abstract class DutyLogViolationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DutyLogViolationService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DutyLogViolationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DutyLogViolationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DutyLogViolationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		dutyLogViolationService = (DutyLogViolationService)aopProxy;

		_setServiceUtilService(dutyLogViolationService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DutyLogViolationService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = DutyLogViolationServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, dutyLogViolationService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.DutyLogViolationLocalService
		dutyLogViolationLocalService;

	protected DutyLogViolationService dutyLogViolationService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DutyLogViolationServiceBaseImpl.class);
