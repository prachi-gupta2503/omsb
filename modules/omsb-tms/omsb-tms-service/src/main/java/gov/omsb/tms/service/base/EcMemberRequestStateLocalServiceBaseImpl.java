...
/**
 * Provides the base implementation for the ec member request state local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.EcMemberRequestStateLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.EcMemberRequestStateLocalServiceImpl
 * @generated
 */
public abstract class EcMemberRequestStateLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, EcMemberRequestStateLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EcMemberRequestStateLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>EcMemberRequestStateLocalServiceUtil</code>.
	 */
	...
	public EcMemberRequestState addEcMemberRequestState(
		...
		return ecMemberRequestStatePersistence.update(ecMemberRequestState);
	}
	...
	public EcMemberRequestState createEcMemberRequestState(
		...
		return ecMemberRequestStatePersistence.create(ecMemberRequestStateId);
	}
	...
	public EcMemberRequestState deleteEcMemberRequestState(
		...
		return ecMemberRequestStatePersistence.remove(ecMemberRequestStateId);
	}
	...
	public EcMemberRequestState deleteEcMemberRequestState(
		...
		return ecMemberRequestStatePersistence.remove(ecMemberRequestState);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return ecMemberRequestStatePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			EcMemberRequestState.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ecMemberRequestStatePersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ecMemberRequestStatePersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public EcMemberRequestState fetchEcMemberRequestState(
		...
		return ecMemberRequestStatePersistence.fetchByPrimaryKey(
	...
	public EcMemberRequestState fetchEcMemberRequestStateByUuidAndGroupId(
		...
		return ecMemberRequestStatePersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public EcMemberRequestState getEcMemberRequestState(
		...
		return ecMemberRequestStatePersistence.findByPrimaryKey(
			ecMemberRequestStateId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			ecMemberRequestStateLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(EcMemberRequestState.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, ecMemberRequestState);
				}
		...
		exportActionableDynamicQuery.setStagedModelType(
			new StagedModelType(
				PortalUtil.getClassNameId(
					EcMemberRequestState.class.getName())));
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return ecMemberRequestStatePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement EcMemberRequestStateLocalServiceImpl#deleteEcMemberRequestState(EcMemberRequestState) to avoid orphaned data");
		}

		return ecMemberRequestStateLocalService.deleteEcMemberRequestState(
			(EcMemberRequestState)persistedModel);
	}

	@Override
	public BasePersistence<EcMemberRequestState> getBasePersistence() {
		return ecMemberRequestStatePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return ecMemberRequestStatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<EcMemberRequestState>
		...
		return ecMemberRequestStatePersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<EcMemberRequestState>
		...
		return ecMemberRequestStatePersistence.findByUuid_C(
	...
	public EcMemberRequestState getEcMemberRequestStateByUuidAndGroupId(
		...
		return ecMemberRequestStatePersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<EcMemberRequestState> getEcMemberRequestStates(
		...
		return ecMemberRequestStatePersistence.findAll(start, end);
	}
	...
	public int getEcMemberRequestStatesCount() {
		return ecMemberRequestStatePersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EcMemberRequestStateLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		ecMemberRequestStateLocalService =
			(EcMemberRequestStateLocalService)aopProxy;

		_setLocalServiceUtilService(ecMemberRequestStateLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return EcMemberRequestStateLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				ecMemberRequestStatePersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				EcMemberRequestStateLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, ecMemberRequestStateLocalService);
		}
	...
	protected EcMemberRequestStateLocalService ecMemberRequestStateLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EcMemberRequestStateLocalServiceBaseImpl.class);
