...
import gov.omsb.tms.service.SharedRotationRequestDetailsLocalServiceUtil;
...
/**
 * Provides the base implementation for the shared rotation request details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.SharedRotationRequestDetailsLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.SharedRotationRequestDetailsLocalServiceImpl
 * @generated
 */
public abstract class SharedRotationRequestDetailsLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SharedRotationRequestDetailsLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SharedRotationRequestDetailsLocalServiceUtil</code>.
	 */
	...
	public SharedRotationRequestDetails addSharedRotationRequestDetails(
		...
		return sharedRotationRequestDetailsPersistence.update(
	...
	public SharedRotationRequestDetails createSharedRotationRequestDetails(
		...
		return sharedRotationRequestDetailsPersistence.create(
	...
	public SharedRotationRequestDetails deleteSharedRotationRequestDetails(
		...
		return sharedRotationRequestDetailsPersistence.remove(
			sharedRotationRequestDetailsId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return sharedRotationRequestDetailsPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SharedRotationRequestDetails.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return sharedRotationRequestDetailsPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return sharedRotationRequestDetailsPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public SharedRotationRequestDetails fetchSharedRotationRequestDetails(
		...
		return sharedRotationRequestDetailsPersistence.fetchByPrimaryKey(
			sharedRotationRequestDetailsId);
	}
	...
	public SharedRotationRequestDetails
		...
		return sharedRotationRequestDetailsPersistence.fetchByUUID_G(
			uuid, groupId);
	}
	...
	public SharedRotationRequestDetails getSharedRotationRequestDetails(
		...
		return sharedRotationRequestDetailsPersistence.findByPrimaryKey(
			sharedRotationRequestDetailsId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(
			SharedRotationRequestDetails.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, sharedRotationRequestDetails);
				}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement SharedRotationRequestDetailsLocalServiceImpl#deleteSharedRotationRequestDetails(SharedRotationRequestDetails) to avoid orphaned data");
		}

		return sharedRotationRequestDetailsLocalService.
			deleteSharedRotationRequestDetails(
				(SharedRotationRequestDetails)persistedModel);
	}

	@Override
	public BasePersistence<SharedRotationRequestDetails> getBasePersistence() {
		return sharedRotationRequestDetailsPersistence;
	}
	...
	public List<SharedRotationRequestDetails>
		...
		return sharedRotationRequestDetailsPersistence.findByUuid_C(
			uuid, companyId);
	}
	...
	public SharedRotationRequestDetails
		...
		return sharedRotationRequestDetailsPersistence.findByUUID_G(
			uuid, groupId);
	}
	...
	public List<SharedRotationRequestDetails> getSharedRotationRequestDetailses(
		...
		return sharedRotationRequestDetailsPersistence.findAll(start, end);
	}
	...
	public int getSharedRotationRequestDetailsesCount() {
		return sharedRotationRequestDetailsPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SharedRotationRequestDetailsLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		sharedRotationRequestDetailsLocalService =
			(SharedRotationRequestDetailsLocalService)aopProxy;

		_setLocalServiceUtilService(sharedRotationRequestDetailsLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SharedRotationRequestDetailsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				sharedRotationRequestDetailsPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				SharedRotationRequestDetailsLocalServiceUtil.class.
					getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, sharedRotationRequestDetailsLocalService);
		}
	...
	protected SharedRotationRequestDetailsLocalService
		sharedRotationRequestDetailsLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SharedRotationRequestDetailsLocalServiceBaseImpl.class);
