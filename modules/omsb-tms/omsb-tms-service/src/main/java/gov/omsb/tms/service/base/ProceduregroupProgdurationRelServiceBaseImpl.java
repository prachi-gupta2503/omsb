...
import gov.omsb.tms.service.ProceduregroupProgdurationRelService;
import gov.omsb.tms.service.ProceduregroupProgdurationRelServiceUtil;
...
/**
 * Provides the base implementation for the proceduregroup progduration rel remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.ProceduregroupProgdurationRelServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.ProceduregroupProgdurationRelServiceImpl
 * @generated
 */
public abstract class ProceduregroupProgdurationRelServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProceduregroupProgdurationRelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProceduregroupProgdurationRelServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProceduregroupProgdurationRelService.class,
	...
	public void setAopProxy(Object aopProxy) {
		proceduregroupProgdurationRelService =
			(ProceduregroupProgdurationRelService)aopProxy;

		_setServiceUtilService(proceduregroupProgdurationRelService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProceduregroupProgdurationRelService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				ProceduregroupProgdurationRelServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, proceduregroupProgdurationRelService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.ProceduregroupProgdurationRelLocalService
		proceduregroupProgdurationRelLocalService;

	protected ProceduregroupProgdurationRelService
		proceduregroupProgdurationRelService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProceduregroupProgdurationRelServiceBaseImpl.class);
