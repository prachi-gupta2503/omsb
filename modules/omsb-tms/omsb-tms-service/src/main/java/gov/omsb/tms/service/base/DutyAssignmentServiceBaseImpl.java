...
import gov.omsb.tms.service.DutyAssignmentService;
...
/**
 * Provides the base implementation for the duty assignment remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.DutyAssignmentServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.DutyAssignmentServiceImpl
 * @generated
 */
public abstract class DutyAssignmentServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DutyAssignmentService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DutyAssignmentService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DutyAssignmentServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DutyAssignmentService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		dutyAssignmentService = (DutyAssignmentService)aopProxy;

		_setServiceUtilService(dutyAssignmentService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DutyAssignmentService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = DutyAssignmentServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, dutyAssignmentService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.DutyAssignmentLocalService
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DutyAssignmentServiceBaseImpl.class);
