...
/**
 * Provides the base implementation for the duty log violation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.DutyLogViolationLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.DutyLogViolationLocalServiceImpl
 * @generated
 */
public abstract class DutyLogViolationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, DutyLogViolationLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DutyLogViolationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DutyLogViolationLocalServiceUtil</code>.
	 */
	...
	public DutyLogViolation addDutyLogViolation(
		...
		return dutyLogViolationPersistence.update(dutyLogViolation);
	}
	...
	public DutyLogViolation createDutyLogViolation(long ViolationId) {
		return dutyLogViolationPersistence.create(ViolationId);
	}
	...
	public DutyLogViolation deleteDutyLogViolation(long ViolationId)
		...
		return dutyLogViolationPersistence.remove(ViolationId);
	}
	...
	public DutyLogViolation deleteDutyLogViolation(
		...
		return dutyLogViolationPersistence.remove(dutyLogViolation);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return dutyLogViolationPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			DutyLogViolation.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return dutyLogViolationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return dutyLogViolationPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return dutyLogViolationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return dutyLogViolationPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public DutyLogViolation fetchDutyLogViolation(long ViolationId) {
		return dutyLogViolationPersistence.fetchByPrimaryKey(ViolationId);
	}
	...
	public DutyLogViolation fetchDutyLogViolationByUuidAndGroupId(
		...
		return dutyLogViolationPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public DutyLogViolation getDutyLogViolation(long ViolationId)
		...
		return dutyLogViolationPersistence.findByPrimaryKey(ViolationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			dutyLogViolationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DutyLogViolation.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("ViolationId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(DutyLogViolation.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<DutyLogViolation>() {

				@Override
				public void performAction(DutyLogViolation dutyLogViolation)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, dutyLogViolation);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return dutyLogViolationPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement DutyLogViolationLocalServiceImpl#deleteDutyLogViolation(DutyLogViolation) to avoid orphaned data");
		}

		return dutyLogViolationLocalService.deleteDutyLogViolation(
			(DutyLogViolation)persistedModel);
	}

	@Override
	public BasePersistence<DutyLogViolation> getBasePersistence() {
		return dutyLogViolationPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return dutyLogViolationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DutyLogViolation> getDutyLogViolationsByUuidAndCompanyId(
		...
		return dutyLogViolationPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<DutyLogViolation> getDutyLogViolationsByUuidAndCompanyId(
		...
		return dutyLogViolationPersistence.findByUuid_C(
	...
	public DutyLogViolation getDutyLogViolationByUuidAndGroupId(
		...
		return dutyLogViolationPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<DutyLogViolation> getDutyLogViolations(int start, int end) {
		return dutyLogViolationPersistence.findAll(start, end);
	}
	...
	public int getDutyLogViolationsCount() {
		return dutyLogViolationPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DutyLogViolationLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		dutyLogViolationLocalService = (DutyLogViolationLocalService)aopProxy;

		_setLocalServiceUtilService(dutyLogViolationLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DutyLogViolationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = dutyLogViolationPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				DutyLogViolationLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, dutyLogViolationLocalService);
		}
	...
	protected DutyLogViolationLocalService dutyLogViolationLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DutyLogViolationLocalServiceBaseImpl.class);
