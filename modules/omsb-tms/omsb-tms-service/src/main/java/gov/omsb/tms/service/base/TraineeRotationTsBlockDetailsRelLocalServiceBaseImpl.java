...
/**
 * Provides the base implementation for the trainee rotation ts block details rel local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.TraineeRotationTsBlockDetailsRelLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.TraineeRotationTsBlockDetailsRelLocalServiceImpl
 * @generated
 */
public abstract class TraineeRotationTsBlockDetailsRelLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TraineeRotationTsBlockDetailsRelLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TraineeRotationTsBlockDetailsRelLocalServiceUtil</code>.
	 */
	...
	public TraineeRotationTsBlockDetailsRel addTraineeRotationTsBlockDetailsRel(
		...
		return traineeRotationTsBlockDetailsRelPersistence.update(
	...
	public TraineeRotationTsBlockDetailsRel
		...
		return traineeRotationTsBlockDetailsRelPersistence.create(
	...
	public TraineeRotationTsBlockDetailsRel
		...
		return traineeRotationTsBlockDetailsRelPersistence.remove(
			traineeRotationTsBlockDetailsRelId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return traineeRotationTsBlockDetailsRelPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TraineeRotationTsBlockDetailsRel.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return traineeRotationTsBlockDetailsRelPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return traineeRotationTsBlockDetailsRelPersistence.
	...
	public TraineeRotationTsBlockDetailsRel
		...
		return traineeRotationTsBlockDetailsRelPersistence.fetchByPrimaryKey(
			traineeRotationTsBlockDetailsRelId);
	}
	...
	public TraineeRotationTsBlockDetailsRel
		...
		return traineeRotationTsBlockDetailsRelPersistence.fetchByUUID_G(
			uuid, groupId);
	}
	...
	public TraineeRotationTsBlockDetailsRel getTraineeRotationTsBlockDetailsRel(
		...
		return traineeRotationTsBlockDetailsRelPersistence.findByPrimaryKey(
			traineeRotationTsBlockDetailsRelId);
	}
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, traineeRotationTsBlockDetailsRel);
				}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TraineeRotationTsBlockDetailsRelLocalServiceImpl#deleteTraineeRotationTsBlockDetailsRel(TraineeRotationTsBlockDetailsRel) to avoid orphaned data");
		}

		return traineeRotationTsBlockDetailsRelLocalService.
			deleteTraineeRotationTsBlockDetailsRel(
				(TraineeRotationTsBlockDetailsRel)persistedModel);
	}

	@Override
	public BasePersistence<TraineeRotationTsBlockDetailsRel>
		getBasePersistence() {
	...
	public List<TraineeRotationTsBlockDetailsRel>
		...
		return traineeRotationTsBlockDetailsRelPersistence.findByUuid_C(
			uuid, companyId);
	}
	...
	public TraineeRotationTsBlockDetailsRel
		...
		return traineeRotationTsBlockDetailsRelPersistence.findByUUID_G(
			uuid, groupId);
	}
	...
	public List<TraineeRotationTsBlockDetailsRel>
		...
		return traineeRotationTsBlockDetailsRelPersistence.findAll(start, end);
	}
	...
	public int getTraineeRotationTsBlockDetailsRelsCount() {
		return traineeRotationTsBlockDetailsRelPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TraineeRotationTsBlockDetailsRelLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		traineeRotationTsBlockDetailsRelLocalService =
			(TraineeRotationTsBlockDetailsRelLocalService)aopProxy;
	...
	public String getOSGiServiceIdentifier() {
		return TraineeRotationTsBlockDetailsRelLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				traineeRotationTsBlockDetailsRelPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				TraineeRotationTsBlockDetailsRelLocalServiceUtil.class.
					getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, traineeRotationTsBlockDetailsRelLocalService);
		}
	...
	protected TraineeRotationTsBlockDetailsRelLocalService
		traineeRotationTsBlockDetailsRelLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TraineeRotationTsBlockDetailsRelLocalServiceBaseImpl.class);
