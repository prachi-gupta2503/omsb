...
import gov.omsb.tms.service.EcMemberRequestStatusService;
import gov.omsb.tms.service.EcMemberRequestStatusServiceUtil;
...
/**
 * Provides the base implementation for the ec member request status remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.EcMemberRequestStatusServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.EcMemberRequestStatusServiceImpl
 * @generated
 */
public abstract class EcMemberRequestStatusServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, EcMemberRequestStatusService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EcMemberRequestStatusService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>EcMemberRequestStatusServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			EcMemberRequestStatusService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		ecMemberRequestStatusService = (EcMemberRequestStatusService)aopProxy;

		_setServiceUtilService(ecMemberRequestStatusService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return EcMemberRequestStatusService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				EcMemberRequestStatusServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, ecMemberRequestStatusService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.EcMemberRequestStatusLocalService
		ecMemberRequestStatusLocalService;

	protected EcMemberRequestStatusService ecMemberRequestStatusService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		EcMemberRequestStatusServiceBaseImpl.class);
