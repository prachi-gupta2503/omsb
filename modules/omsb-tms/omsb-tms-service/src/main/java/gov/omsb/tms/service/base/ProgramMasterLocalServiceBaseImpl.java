...
/**
 * Provides the base implementation for the program master local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.ProgramMasterLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.ProgramMasterLocalServiceImpl
 * @generated
 */
public abstract class ProgramMasterLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, ProgramMasterLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProgramMasterLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProgramMasterLocalServiceUtil</code>.
	 */
	...
	public ProgramMaster addProgramMaster(ProgramMaster programMaster) {
		...
		return programMasterPersistence.update(programMaster);
	}
	...
	public ProgramMaster createProgramMaster(long programMasterId) {
		return programMasterPersistence.create(programMasterId);
	}
	...
	public ProgramMaster deleteProgramMaster(long programMasterId)
		...
		return programMasterPersistence.remove(programMasterId);
	}
	...
	public ProgramMaster deleteProgramMaster(ProgramMaster programMaster) {
		return programMasterPersistence.remove(programMaster);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return programMasterPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ProgramMaster.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return programMasterPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return programMasterPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return programMasterPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return programMasterPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public ProgramMaster fetchProgramMaster(long programMasterId) {
		return programMasterPersistence.fetchByPrimaryKey(programMasterId);
	}
	...
	public ProgramMaster fetchProgramMasterByUuidAndGroupId(
		...
		return programMasterPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public ProgramMaster getProgramMaster(long programMasterId)
		...
		return programMasterPersistence.findByPrimaryKey(programMasterId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(programMasterLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ProgramMaster.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("programMasterId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			programMasterLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ProgramMaster.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<ProgramMaster>() {

				@Override
				public void performAction(ProgramMaster programMaster)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, programMaster);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return programMasterPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ProgramMasterLocalServiceImpl#deleteProgramMaster(ProgramMaster) to avoid orphaned data");
		}

		return programMasterLocalService.deleteProgramMaster(
			(ProgramMaster)persistedModel);
	}

	@Override
	public BasePersistence<ProgramMaster> getBasePersistence() {
		return programMasterPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return programMasterPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ProgramMaster> getProgramMastersByUuidAndCompanyId(
		...
		return programMasterPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<ProgramMaster> getProgramMastersByUuidAndCompanyId(
		...
		return programMasterPersistence.findByUuid_C(
	...
	public ProgramMaster getProgramMasterByUuidAndGroupId(
		...
		return programMasterPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<ProgramMaster> getProgramMasters(int start, int end) {
		return programMasterPersistence.findAll(start, end);
	}
	...
	public int getProgramMastersCount() {
		return programMasterPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProgramMasterLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		programMasterLocalService = (ProgramMasterLocalService)aopProxy;

		_setLocalServiceUtilService(programMasterLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProgramMasterLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = programMasterPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = ProgramMasterLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, programMasterLocalService);
		}
	...
	protected ProgramMasterLocalService programMasterLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProgramMasterLocalServiceBaseImpl.class);
