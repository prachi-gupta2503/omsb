...
import gov.omsb.tms.service.BankDetailsService;
import gov.omsb.tms.service.BankDetailsServiceUtil;
...
/**
 * Provides the base implementation for the bank details remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.BankDetailsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.BankDetailsServiceImpl
 * @generated
 */
public abstract class BankDetailsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, BankDetailsService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BankDetailsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>BankDetailsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BankDetailsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		bankDetailsService = (BankDetailsService)aopProxy;

		_setServiceUtilService(bankDetailsService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return BankDetailsService.class.getName();
	}
	...
	private void _setServiceUtilService(BankDetailsService bankDetailsService) {
		try {
			Field field = BankDetailsServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, bankDetailsService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.BankDetailsLocalService
	...
	private static final Log _log = LogFactoryUtil.getLog(
		BankDetailsServiceBaseImpl.class);
