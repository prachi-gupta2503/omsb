...
import gov.omsb.tms.service.ViolationUpdateStatusService;
import gov.omsb.tms.service.ViolationUpdateStatusServiceUtil;
...
/**
 * Provides the base implementation for the violation update status remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.ViolationUpdateStatusServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.ViolationUpdateStatusServiceImpl
 * @generated
 */
public abstract class ViolationUpdateStatusServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ViolationUpdateStatusService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ViolationUpdateStatusServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ViolationUpdateStatusService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		violationUpdateStatusService = (ViolationUpdateStatusService)aopProxy;

		_setServiceUtilService(violationUpdateStatusService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ViolationUpdateStatusService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				ViolationUpdateStatusServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, violationUpdateStatusService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.ViolationUpdateStatusLocalService
		violationUpdateStatusLocalService;

	protected ViolationUpdateStatusService violationUpdateStatusService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ViolationUpdateStatusServiceBaseImpl.class);
