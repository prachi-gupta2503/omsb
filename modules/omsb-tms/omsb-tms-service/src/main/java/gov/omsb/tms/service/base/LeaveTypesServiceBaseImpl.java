...
import gov.omsb.tms.service.LeaveTypesService;
import gov.omsb.tms.service.LeaveTypesServiceUtil;
...
/**
 * Provides the base implementation for the leave types remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.LeaveTypesServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.LeaveTypesServiceImpl
 * @generated
 */
public abstract class LeaveTypesServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, LeaveTypesService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LeaveTypesService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>LeaveTypesServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LeaveTypesService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		leaveTypesService = (LeaveTypesService)aopProxy;

		_setServiceUtilService(leaveTypesService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return LeaveTypesService.class.getName();
	}
	...
	private void _setServiceUtilService(LeaveTypesService leaveTypesService) {
		try {
			Field field = LeaveTypesServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, leaveTypesService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.LeaveTypesLocalService
		leaveTypesLocalService;

	protected LeaveTypesService leaveTypesService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LeaveTypesServiceBaseImpl.class);
