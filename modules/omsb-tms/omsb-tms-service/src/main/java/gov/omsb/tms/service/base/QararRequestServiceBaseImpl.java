...
import gov.omsb.tms.service.QararRequestService;
import gov.omsb.tms.service.QararRequestServiceUtil;
...
/**
 * Provides the base implementation for the qarar request remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.QararRequestServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.QararRequestServiceImpl
 * @generated
 */
public abstract class QararRequestServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, QararRequestService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QararRequestService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>QararRequestServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QararRequestService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		qararRequestService = (QararRequestService)aopProxy;

		_setServiceUtilService(qararRequestService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return QararRequestService.class.getName();
	}
	...
	private void _setServiceUtilService(
		QararRequestService qararRequestService) {

		try {
			Field field = QararRequestServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, qararRequestService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.QararRequestLocalService
		qararRequestLocalService;

	protected QararRequestService qararRequestService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		QararRequestServiceBaseImpl.class);
