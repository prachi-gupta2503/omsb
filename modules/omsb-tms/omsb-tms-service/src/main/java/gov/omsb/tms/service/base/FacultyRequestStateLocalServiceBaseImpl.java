...
/**
 * Provides the base implementation for the faculty request state local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.FacultyRequestStateLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.FacultyRequestStateLocalServiceImpl
 * @generated
 */
public abstract class FacultyRequestStateLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, FacultyRequestStateLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FacultyRequestStateLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>FacultyRequestStateLocalServiceUtil</code>.
	 */
	...
	public FacultyRequestState addFacultyRequestState(
		...
		return facultyRequestStatePersistence.update(facultyRequestState);
	}
	...
	public FacultyRequestState createFacultyRequestState(
		...
		return facultyRequestStatePersistence.create(facultyRequestStateId);
	}
	...
	public FacultyRequestState deleteFacultyRequestState(
		...
		return facultyRequestStatePersistence.remove(facultyRequestStateId);
	}
	...
	public FacultyRequestState deleteFacultyRequestState(
		...
		return facultyRequestStatePersistence.remove(facultyRequestState);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return facultyRequestStatePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			FacultyRequestState.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return facultyRequestStatePersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return facultyRequestStatePersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public FacultyRequestState fetchFacultyRequestState(
		...
		return facultyRequestStatePersistence.fetchByPrimaryKey(
	...
	public FacultyRequestState fetchFacultyRequestStateByUuidAndGroupId(
		...
		return facultyRequestStatePersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public FacultyRequestState getFacultyRequestState(
		...
		return facultyRequestStatePersistence.findByPrimaryKey(
			facultyRequestStateId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			facultyRequestStateLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(FacultyRequestState.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, facultyRequestState);
				}
		...
		exportActionableDynamicQuery.setStagedModelType(
			new StagedModelType(
				PortalUtil.getClassNameId(
					FacultyRequestState.class.getName())));
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return facultyRequestStatePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement FacultyRequestStateLocalServiceImpl#deleteFacultyRequestState(FacultyRequestState) to avoid orphaned data");
		}

		return facultyRequestStateLocalService.deleteFacultyRequestState(
			(FacultyRequestState)persistedModel);
	}

	@Override
	public BasePersistence<FacultyRequestState> getBasePersistence() {
		return facultyRequestStatePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return facultyRequestStatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<FacultyRequestState> getFacultyRequestStatesByUuidAndCompanyId(
		...
		return facultyRequestStatePersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<FacultyRequestState> getFacultyRequestStatesByUuidAndCompanyId(
		...
		return facultyRequestStatePersistence.findByUuid_C(
	...
	public FacultyRequestState getFacultyRequestStateByUuidAndGroupId(
		...
		return facultyRequestStatePersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<FacultyRequestState> getFacultyRequestStates(
		...
		return facultyRequestStatePersistence.findAll(start, end);
	}
	...
	public int getFacultyRequestStatesCount() {
		return facultyRequestStatePersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FacultyRequestStateLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		facultyRequestStateLocalService =
			(FacultyRequestStateLocalService)aopProxy;

		_setLocalServiceUtilService(facultyRequestStateLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return FacultyRequestStateLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				facultyRequestStatePersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				FacultyRequestStateLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, facultyRequestStateLocalService);
		}
	...
	protected FacultyRequestStateLocalService facultyRequestStateLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FacultyRequestStateLocalServiceBaseImpl.class);
