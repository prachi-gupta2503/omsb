...
import gov.omsb.tms.service.ProgramEligibilityDegreeRelLocalService;
...
/**
 * Provides the base implementation for the program eligibility degree rel local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.ProgramEligibilityDegreeRelLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.ProgramEligibilityDegreeRelLocalServiceImpl
 * @generated
 */
public abstract class ProgramEligibilityDegreeRelLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProgramEligibilityDegreeRelLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProgramEligibilityDegreeRelLocalServiceUtil</code>.
	 */
	...
	public ProgramEligibilityDegreeRel addProgramEligibilityDegreeRel(
		...
		return programEligibilityDegreeRelPersistence.update(
	...
	public ProgramEligibilityDegreeRel createProgramEligibilityDegreeRel(
		...
		return programEligibilityDegreeRelPersistence.create(programEdId);
	}
	...
	public ProgramEligibilityDegreeRel deleteProgramEligibilityDegreeRel(
		...
		return programEligibilityDegreeRelPersistence.remove(programEdId);
	}
	...
	public ProgramEligibilityDegreeRel deleteProgramEligibilityDegreeRel(
		...
		return programEligibilityDegreeRelPersistence.remove(
			programEligibilityDegreeRel);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return programEligibilityDegreeRelPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ProgramEligibilityDegreeRel.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return programEligibilityDegreeRelPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return programEligibilityDegreeRelPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public ProgramEligibilityDegreeRel fetchProgramEligibilityDegreeRel(
		...
		return programEligibilityDegreeRelPersistence.fetchByPrimaryKey(
			programEdId);
	}
	...
	public ProgramEligibilityDegreeRel
		...
		return programEligibilityDegreeRelPersistence.fetchByUUID_G(
			uuid, groupId);
	}
	...
	public ProgramEligibilityDegreeRel getProgramEligibilityDegreeRel(
		...
		return programEligibilityDegreeRelPersistence.findByPrimaryKey(
			programEdId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(ProgramEligibilityDegreeRel.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("programEdId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			ProgramEligibilityDegreeRel.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, programEligibilityDegreeRel);
				}
		...
		exportActionableDynamicQuery.setStagedModelType(
			new StagedModelType(
				PortalUtil.getClassNameId(
					ProgramEligibilityDegreeRel.class.getName())));
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return programEligibilityDegreeRelPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement ProgramEligibilityDegreeRelLocalServiceImpl#deleteProgramEligibilityDegreeRel(ProgramEligibilityDegreeRel) to avoid orphaned data");
		}

		return programEligibilityDegreeRelLocalService.
			deleteProgramEligibilityDegreeRel(
				(ProgramEligibilityDegreeRel)persistedModel);
	}

	@Override
	public BasePersistence<ProgramEligibilityDegreeRel> getBasePersistence() {
		return programEligibilityDegreeRelPersistence;
	}
	...
	public List<ProgramEligibilityDegreeRel>
		...
		return programEligibilityDegreeRelPersistence.findByUuid_C(
			uuid, companyId);
	}
	...
	public ProgramEligibilityDegreeRel
		...
		return programEligibilityDegreeRelPersistence.findByUUID_G(
			uuid, groupId);
	}
	...
	public List<ProgramEligibilityDegreeRel> getProgramEligibilityDegreeRels(
		...
		return programEligibilityDegreeRelPersistence.findAll(start, end);
	}
	...
	public int getProgramEligibilityDegreeRelsCount() {
		return programEligibilityDegreeRelPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProgramEligibilityDegreeRelLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		programEligibilityDegreeRelLocalService =
			(ProgramEligibilityDegreeRelLocalService)aopProxy;

		_setLocalServiceUtilService(programEligibilityDegreeRelLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProgramEligibilityDegreeRelLocalService.class.getName();
	}

	protected Class<?> getModelClass() {
		return ProgramEligibilityDegreeRel.class;
	}

	protected String getModelClassName() {
		return ProgramEligibilityDegreeRel.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				programEligibilityDegreeRelPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				ProgramEligibilityDegreeRelLocalServiceUtil.class.
					getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, programEligibilityDegreeRelLocalService);
		}
	...
	protected ProgramEligibilityDegreeRelLocalService
		programEligibilityDegreeRelLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProgramEligibilityDegreeRelLocalServiceBaseImpl.class);
