...
import gov.omsb.tms.service.ProgramMasterService;
import gov.omsb.tms.service.ProgramMasterServiceUtil;
...
/**
 * Provides the base implementation for the program master remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.ProgramMasterServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.ProgramMasterServiceImpl
 * @generated
 */
public abstract class ProgramMasterServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, ProgramMasterService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProgramMasterService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProgramMasterServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProgramMasterService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		programMasterService = (ProgramMasterService)aopProxy;

		_setServiceUtilService(programMasterService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProgramMasterService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = ProgramMasterServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, programMasterService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.ProgramMasterLocalService
		programMasterLocalService;

	protected ProgramMasterService programMasterService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ProgramMasterServiceBaseImpl.class);
