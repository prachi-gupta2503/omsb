...
import gov.omsb.tms.service.FacultyIncentiveService;
import gov.omsb.tms.service.FacultyIncentiveServiceUtil;
...
/**
 * Provides the base implementation for the faculty incentive remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.FacultyIncentiveServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.FacultyIncentiveServiceImpl
 * @generated
 */
public abstract class FacultyIncentiveServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FacultyIncentiveService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FacultyIncentiveService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>FacultyIncentiveServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FacultyIncentiveService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		facultyIncentiveService = (FacultyIncentiveService)aopProxy;

		_setServiceUtilService(facultyIncentiveService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return FacultyIncentiveService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = facultyIncentivePersistence.getDataSource();
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = FacultyIncentiveServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, facultyIncentiveService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.FacultyIncentiveLocalService
		facultyIncentiveLocalService;

	protected FacultyIncentiveService facultyIncentiveService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FacultyIncentiveServiceBaseImpl.class);
