...
import gov.omsb.tms.service.ParticipationTypeMasterService;
import gov.omsb.tms.service.ParticipationTypeMasterServiceUtil;
...
/**
 * Provides the base implementation for the participation type master remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.ParticipationTypeMasterServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.ParticipationTypeMasterServiceImpl
 * @generated
 */
public abstract class ParticipationTypeMasterServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   ParticipationTypeMasterService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ParticipationTypeMasterService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ParticipationTypeMasterServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ParticipationTypeMasterService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		participationTypeMasterService =
			(ParticipationTypeMasterService)aopProxy;

		_setServiceUtilService(participationTypeMasterService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ParticipationTypeMasterService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				ParticipationTypeMasterServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, participationTypeMasterService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.ParticipationTypeMasterLocalService
		participationTypeMasterLocalService;

	protected ParticipationTypeMasterService participationTypeMasterService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ParticipationTypeMasterServiceBaseImpl.class);
