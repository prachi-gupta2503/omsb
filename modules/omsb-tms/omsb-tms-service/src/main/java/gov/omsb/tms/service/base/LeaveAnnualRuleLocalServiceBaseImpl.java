...
/**
 * Provides the base implementation for the leave annual rule local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.LeaveAnnualRuleLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.LeaveAnnualRuleLocalServiceImpl
 * @generated
 */
public abstract class LeaveAnnualRuleLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   LeaveAnnualRuleLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>LeaveAnnualRuleLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>LeaveAnnualRuleLocalServiceUtil</code>.
	 */
	...
	@Override
	public LeaveAnnualRule addLeaveAnnualRule(LeaveAnnualRule leaveAnnualRule) {
		leaveAnnualRule.setNew(true);

		return leaveAnnualRulePersistence.update(leaveAnnualRule);
	}
	...
	public LeaveAnnualRule createLeaveAnnualRule(long leaveAnnualRuleId) {
		return leaveAnnualRulePersistence.create(leaveAnnualRuleId);
	}
	...
	@Override
	public LeaveAnnualRule deleteLeaveAnnualRule(long leaveAnnualRuleId)
		throws PortalException {

		return leaveAnnualRulePersistence.remove(leaveAnnualRuleId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public LeaveAnnualRule deleteLeaveAnnualRule(
		LeaveAnnualRule leaveAnnualRule) {

		return leaveAnnualRulePersistence.remove(leaveAnnualRule);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return leaveAnnualRulePersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			LeaveAnnualRule.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return leaveAnnualRulePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return leaveAnnualRulePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return leaveAnnualRulePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return leaveAnnualRulePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public LeaveAnnualRule fetchLeaveAnnualRule(long leaveAnnualRuleId) {
		return leaveAnnualRulePersistence.fetchByPrimaryKey(leaveAnnualRuleId);
	}
	 ...
	 */
	@Override
	public LeaveAnnualRule fetchLeaveAnnualRuleByUuidAndGroupId(
		String uuid, long groupId) {

		return leaveAnnualRulePersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public LeaveAnnualRule getLeaveAnnualRule(long leaveAnnualRuleId)
		throws PortalException {

		return leaveAnnualRulePersistence.findByPrimaryKey(leaveAnnualRuleId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(leaveAnnualRuleLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(LeaveAnnualRule.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("leaveAnnualRuleId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(LeaveAnnualRule.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<LeaveAnnualRule>() {

				@Override
				public void performAction(LeaveAnnualRule leaveAnnualRule)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, leaveAnnualRule);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return leaveAnnualRulePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement LeaveAnnualRuleLocalServiceImpl#deleteLeaveAnnualRule(LeaveAnnualRule) to avoid orphaned data");
		}

		return leaveAnnualRuleLocalService.deleteLeaveAnnualRule(
			(LeaveAnnualRule)persistedModel);
	}

	@Override
	public BasePersistence<LeaveAnnualRule> getBasePersistence() {
		return leaveAnnualRulePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return leaveAnnualRulePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<LeaveAnnualRule> getLeaveAnnualRulesByUuidAndCompanyId(
		String uuid, long companyId) {

		return leaveAnnualRulePersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<LeaveAnnualRule> getLeaveAnnualRulesByUuidAndCompanyId(
		...
		return leaveAnnualRulePersistence.findByUuid_C(
	 ...
	 */
	@Override
	public LeaveAnnualRule getLeaveAnnualRuleByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return leaveAnnualRulePersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<LeaveAnnualRule> getLeaveAnnualRules(int start, int end) {
		return leaveAnnualRulePersistence.findAll(start, end);
	}
	...
	public int getLeaveAnnualRulesCount() {
		return leaveAnnualRulePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public LeaveAnnualRule updateLeaveAnnualRule(
		LeaveAnnualRule leaveAnnualRule) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			LeaveAnnualRuleLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		leaveAnnualRuleLocalService = (LeaveAnnualRuleLocalService)aopProxy;

		_setLocalServiceUtilService(leaveAnnualRuleLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return LeaveAnnualRuleLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = leaveAnnualRulePersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				LeaveAnnualRuleLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, leaveAnnualRuleLocalService);
		}
	...
	protected LeaveAnnualRuleLocalService leaveAnnualRuleLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		LeaveAnnualRuleLocalServiceBaseImpl.class);
