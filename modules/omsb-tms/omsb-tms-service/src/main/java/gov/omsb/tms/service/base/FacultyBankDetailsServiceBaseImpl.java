...
import gov.omsb.tms.service.FacultyBankDetailsService;
import gov.omsb.tms.service.FacultyBankDetailsServiceUtil;
...
/**
 * Provides the base implementation for the faculty bank details remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.FacultyBankDetailsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.FacultyBankDetailsServiceImpl
 * @generated
 */
public abstract class FacultyBankDetailsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FacultyBankDetailsService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FacultyBankDetailsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>FacultyBankDetailsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FacultyBankDetailsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		facultyBankDetailsService = (FacultyBankDetailsService)aopProxy;

		_setServiceUtilService(facultyBankDetailsService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return FacultyBankDetailsService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = FacultyBankDetailsServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, facultyBankDetailsService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.FacultyBankDetailsLocalService
		facultyBankDetailsLocalService;

	protected FacultyBankDetailsService facultyBankDetailsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		FacultyBankDetailsServiceBaseImpl.class);
