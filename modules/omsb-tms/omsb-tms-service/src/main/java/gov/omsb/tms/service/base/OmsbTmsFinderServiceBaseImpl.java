...
import gov.omsb.tms.service.OmsbTmsFinderService;
import gov.omsb.tms.service.OmsbTmsFinderServiceUtil;
...
/**
 * Provides the base implementation for the omsb tms finder remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.OmsbTmsFinderServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.OmsbTmsFinderServiceImpl
 * @generated
 */
public abstract class OmsbTmsFinderServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, OmsbTmsFinderService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>OmsbTmsFinderService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>OmsbTmsFinderServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			OmsbTmsFinderService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		omsbTmsFinderService = (OmsbTmsFinderService)aopProxy;

		_setServiceUtilService(omsbTmsFinderService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return OmsbTmsFinderService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = OmsbTmsFinderServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, omsbTmsFinderService);
		}
	...
	@Reference
	protected gov.omsb.tms.service.OmsbTmsFinderLocalService
		omsbTmsFinderLocalService;

	protected OmsbTmsFinderService omsbTmsFinderService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		OmsbTmsFinderServiceBaseImpl.class);
