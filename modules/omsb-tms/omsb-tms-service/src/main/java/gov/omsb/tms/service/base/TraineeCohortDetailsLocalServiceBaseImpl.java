...
/**
 * Provides the base implementation for the trainee cohort details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link gov.omsb.tms.service.impl.TraineeCohortDetailsLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see gov.omsb.tms.service.impl.TraineeCohortDetailsLocalServiceImpl
 * @generated
 */
public abstract class TraineeCohortDetailsLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TraineeCohortDetailsLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TraineeCohortDetailsLocalServiceUtil</code>.
	 */
	...
	@Override
	public TraineeCohortDetails addTraineeCohortDetails(
		TraineeCohortDetails traineeCohortDetails) {

		traineeCohortDetails.setNew(true);

		return traineeCohortDetailsPersistence.update(traineeCohortDetails);
	}
	...
	public TraineeCohortDetails createTraineeCohortDetails(
		long traineeCohortDetailsId) {

		return traineeCohortDetailsPersistence.create(traineeCohortDetailsId);
	}
	...
	@Override
	public TraineeCohortDetails deleteTraineeCohortDetails(
			long traineeCohortDetailsId)
		throws PortalException {

		return traineeCohortDetailsPersistence.remove(traineeCohortDetailsId);
	}
	...
	public TraineeCohortDetails deleteTraineeCohortDetails(
		...
		return traineeCohortDetailsPersistence.remove(traineeCohortDetails);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return traineeCohortDetailsPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TraineeCohortDetails.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return traineeCohortDetailsPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return traineeCohortDetailsPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public TraineeCohortDetails fetchTraineeCohortDetails(
		long traineeCohortDetailsId) {

		return traineeCohortDetailsPersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public TraineeCohortDetails fetchTraineeCohortDetailsByUuidAndGroupId(
		String uuid, long groupId) {

		return traineeCohortDetailsPersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public TraineeCohortDetails getTraineeCohortDetails(
			long traineeCohortDetailsId)
		throws PortalException {

		return traineeCohortDetailsPersistence.findByPrimaryKey(
			traineeCohortDetailsId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(TraineeCohortDetails.class);
			...
			new ActionableDynamicQuery.PerformActionMethod
				...
				public void performAction(
					...
					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, traineeCohortDetails);
				}
		...
		exportActionableDynamicQuery.setStagedModelType(
			new StagedModelType(
				PortalUtil.getClassNameId(
					TraineeCohortDetails.class.getName())));
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return traineeCohortDetailsPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement TraineeCohortDetailsLocalServiceImpl#deleteTraineeCohortDetails(TraineeCohortDetails) to avoid orphaned data");
		}

		return traineeCohortDetailsLocalService.deleteTraineeCohortDetails(
			(TraineeCohortDetails)persistedModel);
	}

	@Override
	public BasePersistence<TraineeCohortDetails> getBasePersistence() {
		return traineeCohortDetailsPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return traineeCohortDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TraineeCohortDetails>
		...
		return traineeCohortDetailsPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<TraineeCohortDetails>
		...
		return traineeCohortDetailsPersistence.findByUuid_C(
	 ...
	 */
	@Override
	public TraineeCohortDetails getTraineeCohortDetailsByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException {

		return traineeCohortDetailsPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<TraineeCohortDetails> getTraineeCohortDetailses(
		int start, int end) {

		return traineeCohortDetailsPersistence.findAll(start, end);
	}
	...
	public int getTraineeCohortDetailsesCount() {
		return traineeCohortDetailsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TraineeCohortDetails updateTraineeCohortDetails(
		TraineeCohortDetails traineeCohortDetails) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TraineeCohortDetailsLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		traineeCohortDetailsLocalService =
			(TraineeCohortDetailsLocalService)aopProxy;

		_setLocalServiceUtilService(traineeCohortDetailsLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TraineeCohortDetailsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				traineeCohortDetailsPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				TraineeCohortDetailsLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, traineeCohortDetailsLocalService);
		}
	...
	protected TraineeCohortDetailsLocalService traineeCohortDetailsLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TraineeCohortDetailsLocalServiceBaseImpl.class);
