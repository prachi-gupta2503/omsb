						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<aui:input type="hidden"
									...
									value="<%=Boolean.TRUE%>" />
								<aui:input type="hidden"
									name="<%=OmsbSetupProceduresWebPortletKeys.PROGRAM_DURATION_FOR_ROLE%>"
									value="" />
								<aui:input localized="true" label="role-type-name" type="text"
									name="roleTypeName" placeholder="enter-role-type-name"
