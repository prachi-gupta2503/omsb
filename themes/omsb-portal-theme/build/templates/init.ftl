...
<#assign
	...
	server_url = themeDisplay.getPortalURL()
    site_name = themeDisplay.getScopeGroup().getName()
...
<#if !request.isRequestedSessionIdFromCookie()>
	<#assign 
	company_url = portalUtil.getURLWithSessionId(company_url, request.getSession().getId()) 
	/>
</#if>
